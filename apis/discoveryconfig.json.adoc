...
== Overview
This documentation is for the DiscoveryConfig resource for {product-title}. DiscoveryConfig resource has four possible requests: create, query, delete and update.
...
....
POST /app.k8s.io/v1beta1/namespaces/{namespace}/DiscoveryConfigs
....
