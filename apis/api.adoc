...
You can also access all APIs from the integrated console. From the _Fleet management_ view, navigate to *Home* > *API Explorer* to explore API groups.

+
*Note:* For {ocp} versions earlier than version 4.20, select *All Clusters* from the cluster switcher.
