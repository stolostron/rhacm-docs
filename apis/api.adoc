...
* xref:../apis/discoveryconfig.json.adoc#discovery-config-api[Discovery Config API]
* xref:../apis/discoveredcluster.json.adoc#discovered-clusters-api[Discovered Cluster API]
