...
|**apiVersion** +
__required__|The versioned schema of Placement. |string
|**kind** +
__required__|String value that represents the REST resource. |string
|**metadata** +
__required__|The metadata of Placement. |object
|**spec** +
__required__|The specification of Placement. |<<_rhacm-docs_apis_placement_jsonplacement_spec,spec>>
|===
...
|Name|Description|Schema
|**ClusterSets** +
__optional__|A slice of ManagedClusterSets from which the ManagedClusters are selected. If it is empty, ManagedClusters will be selected from the ManagedClusterSets bound to the placement namespace; otherwise ManagedClusters will be selected from the intersection of this slice and the ManagedClusterSets bound to the placement namespace. |< string > array
|**numberOfClusters** +
__optional__|The desired number of ManagedClusters to be selected. |integer (int32)
|**predicates** +
__optional__|A slice of cluster predicates to select ManagedClusters. They are ORed. |< <<_rhacm-docs_apis_placement_jsonplacement_clusterpredicate,clusterPredicate>> > array
|===
...
|Name|Description|Schema
|**requiredClusterSelector** +
__optional__|A cluster selector to select ManagedClusters with label and claim. |<<_rhacm-docs_apis_placement_jsonplacement_clusterselector,clusterSelector>>
|===
...
|Name|Description|Schema
|**matchExpressions** +
__optional__|A slice of cluster claim selector requirements. They are ANDed. |< object > array
|===
