...
....
POST /apis/observability.open-cluster-management.io/v1alpha1/multiclusterobservabilities
....
...
....
GET /apis/observability.open-cluster-management.io/v1alpha1/multiclusterobservabilities
....
...
....
GET /apis/observability.open-cluster-management.io/v1alpha1/multiclusterobservabilities/{multiclusterobservability_name}
....
...
....
DELETE /apis/observability.open-cluster-management.io/v1alpha1/multiclusterobservabilities/{multiclusterobservability_name}
....
