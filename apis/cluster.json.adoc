...
|**metadata** +
__required__|The meta data of the ManagedCluster.|object
|**spec** +
...
|Name|Description|Schema
|**hubAcceptsClient** +
__required__|Represents that hub accepts the joining of Klusterlet agent on
...
|**managedClusterClientConfigs** +
__optional__|A list of the apiserver addresses of the managed cluster.| <<_rhacm-docs_apis_cluster_jsoncluster_managedClusterClientConfigs,managedClusterClientConfigs>> array
|**leaseDurationSeconds** +
__optional__|Coordinate the lease update time of Klusterlet agents on the managed cluster.
the Klusterlet agent will update its lease every 60 seconds by default.|integer (int32)
|**taints** +
__optional__|A property of managed cluster that allows the cluster to be repelled when scheduling.|<<_rhacm-docs_apis_cluster_jsoncluster_taint,taint>> array
|===
...
|Name|Description|Schema
|**key** +
__required__|The taint key applied to a cluster|string
|**value** +
__optional__|The taint value corresponding to the taint key.|string
|**effect** +
__optional__|Effect of the taint on placements that do not tolerate the taint. Valid effects are NoSelect, PreferNoSelect and NoSelectIfNew.|string
|===
