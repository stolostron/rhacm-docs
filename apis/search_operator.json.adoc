...
|*spec* +
__required__|<<_rhacm-docs_apis_searchoperator_jsonpolicy_spec,spec>>
|===
...
[[_rhacm-docs_apis_searchoperator_jsonpolicy_policytemplates]]
*policy-templates*
...
|<<_rhacm-docs_apis_searchoperator_jsonpolicy_selector,*clusterConditions*>> +
__optional__| Section to define labels.|string
|<<_rhacm-docs_apis_searchoperator_jsonpolicy_rules,*rules*>> +
__optional__| |string
|===

[[_rhacm-docs_apis_searchoperator_jsonpolicy_selector]]
*clusterConditions*
