...
If the `cpuArchitecture` parameter is not defined for your nodes, the value in the `ClusterInstance` specification. The default value for the `ClusterInstance` specification is `x86_64`.|string
|*installerArgs* +
