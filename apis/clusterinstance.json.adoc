...
|*cpuArchitecture* +
_optional_|Specify the type of software architecture to use for nodes that do not have an architecture defined. The following software architectures are supported: `multi`, `x86_64`, and `aarch64`.
