...
* search.open-cluster-management.io/v1beta1 : Create and manage persistence volumes
...
=== Create a policy
....
POST /search.open-cluster-management.io/v1beta1/v1alpha1/namespaces/{namespace}/policies/{policy_name}
....
...
----
{
  "apiVersion": "search.open-cluster-management.io/v1beta1",
  ...
  "spec": {
    ...
    "apiVersion": "search.open-cluster-management.io/v1beta1alpha1",
...
=== Query all policies
....
GET /search.open-cluster-management.io/v1beta1/v1alpha1/namespaces/{namespace}/policies/{policy_name}
....
...
=== Delete a policy
....
DELETE /search.open-cluster-management.io/v1beta1/v1alpha1/namespaces/{namespace}/policies/{policy_name}
....
