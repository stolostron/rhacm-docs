...
This is an API endpoint used to record compliance events and is only supported on {product-title-short}. If you need to record policy compliance events externally from {product-title-short} policies, contact Red Hat support.
