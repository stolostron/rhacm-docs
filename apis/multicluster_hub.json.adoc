...
|Name|Description|Schema
|**group** +
__required__| The group for the multicluster hub. The default value is `operator.open-cluster-management`. |string
|**names** +
__required__| Reference names for the multicluster hub resource. |<<_rhacm-docs_apis_mch_jsonoperator_names,names>>
|**scope** +
__required__| The scope for the resource. The default value is `Namespaced`.|string
|**versions** +
__required__| Define multiple versions with the properties of the multicluster hub.| <<_rhacm-docs_apis_mch_jsonoperator_versions,versions>>
|**status** +
__optional__| Defines the observed state of the MultiClusterHub resource. |<<_rhacm-docs_apis_mch_jsonoperator_status,status>>
|===

[[_rhacm-docs_apis_mch_jsonoperator_names]]
**names**
...
|Name|Description|Schema
|**kind** +
__required__|The reosurce type. |string
|**listKind** +
__optional__|The name of the resource list. | array
|**plural** +
__optional__| The plural name of the resource. | string
|**shortNames** + 
__optional__| Alias names for the MultiClusterHub resource. | string
|**singular** +
__optional__|The singular name for the MultiClusterHub resource.| string
|===

[[_rhacm-docs_apis_mch_jsonoperator_versions]]
**versions**
...
|Name|Description|Schema
|**additionalPrinterColumns** +
__optional__| The overall status of the multicluster hub. |string
|**name** +
__optional__| The verison name. The default value is `v1`.|string
|**schema** +
__required__| Defines the outline configuration for the multicluster hub. |<<_rhacm-docs_apis_mch_jsonoperator_openAPIV3,openAPIV3Schema>>
|===

[[_rhacm-docs_apis_mch_jsonoperator_openAPIV3]]
**openAPIV3Schema**

[options="header", cols=".^2a,.^3a,.^4a"]
|===
|**apiVersion** +
__required__| Defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and might reject unrecognized values. More information, see https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources[Kubernetes Resources]. |string
|**kind** +
__required__|Represents the REST resource for this object.| string
|**metadata** +
__required__|Defines the desired state of the MultiClusterHub resource. |object
|**availabilityConfig** +
__required__|Specifies deployment replication for improved availability. The default value is `High`. |string
|**customCAConfigmap** +
...
|**nodeSelector** +
__required__|Set the nodeselectors. |string
|**overrides** +
__optional__|Developer configurations which overrides current configuration settings. |string 
|**separateCertificateManagement** +
...
|**additionalProperties** +
__optional__| The configuration for the component status condition. |object
|**lastTransitionTime** +
__optional__| The last time the condition changed from one status to another. |string
|**message** +
__optional__| A human-readable message indicationg details about the last status change. |string
|**reason** +
__optional__| A brief message that explains the reason for last status change of the condition. |string
|**status** +
__optional__| Status of the condition. |string
|**type** +
__optional__| The type of cluster condition. |string
|**currentVersion** +
__optional__| Indicates the desired version. |string
|**desiredVersion** +
__optional__| Indicates the desired version. |string
|**phase** +
__optional__| Represents the active phase of the MultiClusterHub resource. |string
|===
