...
== Overview
This documentation is for the MultiClusterHub resource for {acm}. MultiClusterHub resource has four possible requests: create, query, delete and update.
        ...
        "properties": {
            ...
            "spec": {
                ...
                "customCAConfigmap": {
                  ...
                  to Red Hat Advanced Cluster Management.",
                  }
                    "type": "string"
                },
...
|*customCAConfigmap* +
__optional__|Provide the customized OpenShift default ingress CA certificate to {acm-short}. |string
|*disableHubSelfManagement* +
