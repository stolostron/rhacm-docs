...
|**apiVersion** +
__required__|The versioned schema of the ManagedClusterSetBinding.|string
|**kind** +
__required__|String value that represents the REST resource.|string
|**metadata** +
__required__|The meta data of the ManagedClusterSetBinding.|object
|**spec** +
__required__|The specification of the ManagedClusterSetBinding.|<<_rhacm-docs_apis_clustersetbinding_jsonclustersetbinding_spec,spec>>
|===
...
|Name|Description|Schema
|**clusterSet** +
__required__|Name of the ManagedClusterSet to bind. It must match the instance name of the ManagedClusterSetBinding and cannot change once created.|string
|===
