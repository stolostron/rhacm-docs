...
__required__| string
|**selector** +
__optional__|<<_rhacm-docs_apis_policy_jsonpolicy_selector,selector>> string
|**rules** +
__optional__|<<_rhacm-docs_apis_policy_jsonpolicy_rules,rules>> string
|===
...
__required__| string
|**PolicyRule** +
__required__|<<_rhacm-docs_apis_policy_jsonpolicy_policyrule,rules>> object
|===
