...
| **metadataComplianceType** | Provides a way for users to process labels and annotations of an object differently than the other fields. This field can be set to `musthave` or `mustonlyhave`. | string
