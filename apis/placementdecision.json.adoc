...
== Overview
This documentation is for the PlacementDecision resource for {product-title}. PlacementDecision resource has four possible requests: create, query, delete and update. PlacementDecision indicates a decision from a placement. PlacementDecision should has a label `cluster.open-cluster-management.io/placement={placement name}` to reference a certain placement.
...
|**status** +
__optional__|The current status of the PlacementDecision. |<<_rhacm-docs_apis_placementdecision_jsonplacementdecision_status,PlacementStatus>>
|===
...
|Name|Description|Schema
|**Decisions** +
__required__|a slice of decisions according to a placement|<<_rhacm-docs_apis_placementdecision_jsonplacementdecision_decision,ClusterDecision>> array
|===
...
|Name|Description|Schema
|**clusterName** +
__required__|the name of the ManagedCluster|string
|**reason** +
__required__|the reason why the ManagedCluster is selected|string
|===