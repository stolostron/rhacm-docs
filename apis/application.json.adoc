...
....
POST /app.k8s.io/v1beta2/namespaces/{namespace}/applications
....
...
....
GET /app.k8s.io/v1beta2/namespaces/{namespace}/applications
....
...
....
GET /app.k8s.io/v1beta2/namespaces/{namespace}/applications/{application_name}
....
...
....
DELETE /app.k8s.io/v1beta2/namespaces/{namespace}/applications/{application_name}
....
