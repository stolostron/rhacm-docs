...
*Important:* You must configure your route to secure your environment. See link:https://docs.redhat.com/documentation/en-us/openshift_container_platform/4.17/html-single/networking/index#route-configuration[Route configuration] in the {ocp-short} documentation for more details.
