...
*Important:* You must configure your route to secure your environment. See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.17/html-single/ingress_and_load_balancing/index#configuring-routes[Configuring Routes] in the {ocp-short} documentation for more details.
