...
///does this need to change if we are saying what is in the next line?

You can set the lease duration to _____, but if you want the cluster to be detected as offline in less than 30 minutes, you should set it to ____.
