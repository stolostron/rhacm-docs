...
. If you create your own storageClass for a Bare Metal cluster, see link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.19/html-single/storage/index#persistent-storage-using-nfs[Persistent storage using NFS].
