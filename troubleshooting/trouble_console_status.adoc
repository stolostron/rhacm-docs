...
After creating a new cluster by using the {acm} console, the cluster does not progress beyond the status of _Pending_ or displays _Failed_ status.
...
See link:../clusters/cluster_lifecycle/create_intro.adoc#create-intro[Creating clusters] for more information about creating a cluster.
