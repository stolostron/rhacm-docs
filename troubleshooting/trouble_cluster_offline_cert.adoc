...
After you complete the procedure for updating a certificate secret, one or more of your clusters that were online displayed `offline` status in the console.
