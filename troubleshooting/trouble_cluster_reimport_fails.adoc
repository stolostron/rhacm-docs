[#troubleshooting-cluster-reimport]
= Reimporting cluster fails on Red Hat Advanced Cluster Management with unknown authority error

If you experience a problem when reimporting a managed cluster to your :product-title-short: hub cluister, follow the procedure to troubleshoot the problem.
