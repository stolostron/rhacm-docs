...
- xref:../troubleshooting/trouble_cluster_proxy_addon_ignoring_addon_toleration.adoc#troubleshooting-cluster-proxy-addon-ignoring-addon-toleration[Troubleshooting the cluster proxy add-on ignoring the add-on toleration]
