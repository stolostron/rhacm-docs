...
Additionally, check your role-based access. See link:../risk_compliance/rbac.adoc#role-based-access-control[Role-based access control] for details.
...
** xref:../troubleshooting/trouble_obs_mco.adoc#current-data-on-the-grafana-dashboard-disappears[Current data on the Grafana dashboard disappears]