...
- xref:../troubleshooting/trouble_cluster_ignoring_addon_toleration.adoc#troubleshooting-cluster-ignoring-addon-toleration[Troubleshooting the cluster proxy add-on ignoring the add-on toleration]
