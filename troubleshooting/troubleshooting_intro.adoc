...
+
For more information about the `must-gather` command, see the link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.20/html/support/gathering-cluster-data[Gathering data about your cluster] in the {ocp-short} documentation.
...
To view the main documentation for the installing tasks, see link:../get_started/get_started_acm.adoc#get-started-acm[Get started with {acm-short}].
