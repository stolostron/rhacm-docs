 ...
 ** xref:../troubleshooting/trouble_unistall_detach.adoc#troubleshooting-failed-unistallation-because-resources-exist[Troubleshooting failed uninstallation because resources exist]
