...
- xref:../troubleshooting/trouble_global_hub_must_gather.adoc#troubleshooting-global-hub-must-gather[Troubleshooting with the _must-gather_ command]
...
- xref:../troubleshooting/trouble_gitops_addon.adoc#troubleshooting-gitops-addon[Troubleshooting GitOps add-on]

- xref:../troubleshooting/trouble_gitops_operator.adoc#troubleshooting-gitops-operator[Troubleshooting {gitops} operator]

- xref:../troubleshooting/trouble_gitops_instance.adoc#troubleshooting-gitops-instance[Troubleshooting {gitops} instance]
