 ...
 ** xref:../troubleshooting/trouble_cluster_reimport_fails.adoc#troubleshooting-a-managed-cluster-import-failure[Reimporting cluster fails with unknown authority error]
