 ...
 ** xref:../troubleshooting/trouble_obs_label.adoc#undesired-label-value-in-managedcluster-resource[Troubleshooting managedcluster resource]
...
** xref:../troubleshooting/trouble_ocp_monitor.adoc#openshift-monitoring-service-is-not-ready[Troubleshooting OpenShift monitoring services]
