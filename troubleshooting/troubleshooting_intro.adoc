...
Console observability includes _Search_, along with header and navigation function. To view the Observability guide, see link:../console/console.adoc#observability-in-the-console[Observability in the console].
