 ...
 ** xref:../troubleshooting/trouble_restore_status.adoc#troubleshooting-restore-finishedwitherrorss[Troubleshooting {product-title} restore status shows _FinishedWithErrors_]
