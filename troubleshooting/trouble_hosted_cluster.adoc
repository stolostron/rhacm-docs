...
* For more information about troubleshooting hosted control planes, see link:https://docs.redhat.com/documentation/en-us/openshift_container_platform/4.14/html/hosted_control_planes/troubleshooting-hosted-control-planes[Troubleshooting hosted control planes] in the {ocp-short} documentation.
