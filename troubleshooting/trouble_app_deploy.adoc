...
kind "Deployment" in version "extensions/v1beta2"
----
...
For example, if the error displays for _Deployment_ kind in the subscription YAML file, you need to update the `apiVersion` from `extensions/v1beta2` to `apps/v1`.
