...
Ensure that your VMware vCenter required account privileges are correct. See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.19/html/installing_on_vmware_vsphere/installer-provisioned-infrastructure[Installer-provisioned infrastructure] for more information. 
