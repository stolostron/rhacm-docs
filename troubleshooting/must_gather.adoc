...
. Run the following commands to collect all of the information, replacing `x` with the supported version:
+
----
REGISTRY=<internal.repo.address:port>
IMAGE1=$REGISTRY/rhacm2/acm-must-gather-rhel8:v2.x
IMAGE2=$REGISTRY/multicluster-engine/must-gather-rhel8:v2.x
