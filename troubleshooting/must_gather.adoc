...
. Run the following commands to collect all the information:

----
REGISTRY=<internal.repo.address:port>
IMAGE1=$REGISTRY/rhacm2/acm-must-gather-rhel8:v2.5
IMAGE2=$REGISTRY/multicluster-engine/must-gather-rhel8:v2.0
