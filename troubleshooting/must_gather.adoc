...
----
+
*Note:* To receive a complete data set, the following `must-gather` command must be ran for the multicluster engine, as well:
+
----
...
. Log in to your cluster. For the usual use-case, you should run the `must-gather` while you are logged into your hub cluster. 
