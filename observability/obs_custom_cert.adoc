...
- For information about updating the certificate for the Alertmanager route, see link:../secure_clusters/cert_manage.adoc#replacing-cert-alertmanager[Replacing certificates for Alertmanager].
