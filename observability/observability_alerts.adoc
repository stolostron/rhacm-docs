...
- *Observatorium/Thanos:* Uploads the data it ingests to object storage. Some of its components do store data in PVs, but this data is usually automatically regenerated on startup, and thus can be lost without harm. 
