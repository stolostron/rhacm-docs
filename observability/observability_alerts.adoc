...
- If you no longer want an alert to be silenced, expire the silenced alert by running the following command:
+
----
amtool silence expire --alertmanager.url="http://localhost:9093" "d839aca9-ed46-40be-84c4-dca8773671da"
----
+
- To expire the silencing of all alerts, run the following command:
+
----
