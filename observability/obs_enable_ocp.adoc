...
[#enable-obs-ocp-console]
= Enabling observability from the {ocp} console

[role="_abstract"]
Optionally, you can enable observability from the {ocp} console. Create a project that is named `open-cluster-management-observability`.
