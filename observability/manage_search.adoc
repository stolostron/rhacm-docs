...
*Note:* You can discover all resources defined in your managed cluster by using the API Explorer in the console. Alterantively, you can discover all resources by running the following command: `oc api-resources`_
