...
. Create a secret object storage for your cloud provider. Your secret must contain the credentials to your storage solution. For example, run the following command:
...
.. If you are using Amazon S3 or S3 compatible, create a secret resembling the following file:
...
.. If you are using Google Cloud Platform, create a secret resembling the following file:
...
.. If you are using Azure, create a secret resembling the following file:
...
.. If you are using Red Hat OpenShift Data Foundation, create a secret resembling the following file:
...
.. If you are using Red Hat OpenShift on IBM (ROKS), create a secret resembling the following file:
