...
- When you import an {ocp-short} managed cluster onto the hub cluster, {product-title-short} removes all the configuration settings from the `cluster-monitoring-config` config map of the {ocp-short} managed cluster. When the configuration settings are removed, {product-title-short} replaces it with the settings from the hub cluster.  
