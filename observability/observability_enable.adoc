...
= Enabling observability service
//i need to either rename the title or rename the Enabling observability section on line 9; will also not handle modular changes in this PR | MJ | 06/28/23
...
- Direct network access to the hub cluster is required. Network access to load balancers and proxies are not supported. For more information, see link:https://access.redhat.com/documentation/en-us/red_hat_advanced_cluster_management_for_kubernetes/2.8/html-single/install/index#network-configuration[Network configuration] in the _Installation_ chapter.
