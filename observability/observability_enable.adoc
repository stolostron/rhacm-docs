...
spec:
  ...
  enableDownSampling: true # The default value is true. This is not recommended as querying long-time ranges without non-downsampled data is not efficient and useful.
