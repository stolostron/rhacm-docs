...
* You must create a storage class in the `MultiClusterObservability` CR. The observability controller, uses either the configured storage class in MCO CR or the default one.
