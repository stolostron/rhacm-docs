...
----
+
<1> For HTTPS, enter the hostname without the fully qualified domain name (FQDN). Enter the URL for your Amazon S3 endpoint that might resemble the following URL: `example.redhat.com:443`.
+
...
----
+
<1> For HTTPS, enter the hostname without the fully qualified domain name (FQDN). Enter the URL for your Red Hat OpenShift Data Foundation endpoint that might resemble the following URL: `example.redhat.com:443`.
+
