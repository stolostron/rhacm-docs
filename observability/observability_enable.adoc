...
----
+
For more information, see link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.20/html-single/machine_management/index#creating-infrastructure-machinesets[Creating infrastructure machine sets].
...
[role="_abstract"]
You can disable observability, which stops data collection on the {acm-short} hub cluster. Disable observability by removing observability components on all managed clusters.
