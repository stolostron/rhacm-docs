...
When you enable the observability component, you can use metrics and configure dashboards to make cluster resource information visible, help you save cost, and prevent unnecessary events.
