...
. Validate that the observability service is enabled and that data is populated by launching the Grafana dashboards; make sure the data is populated. Click the **Grafana link** that is near the console header, from either the console _Overview_ page or the _Clusters_ page.
+
