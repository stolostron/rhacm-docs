...
----
+
<1> For HTTPS, enter the URL for your Amazon S3 endpoint. Your `endpoint` parameter value might resemble the following URL: `example.redhat.com:443`.
+
...
----
+
<1> Enter the URL for your Red Hat OpenShift Data Foundation endpoint. Your `endpoint` parameter value might resemble the following URL: `example.redhat.com:443`.
+
...
----
+
<1> For HTTPS, enter the URL for your Red Hat OpenShift Data Foundation endpoint. Your `endpoint` parameter value might resemble the following URL: `example.redhat.com:443`.
+
...
----
//need to verify that the endpoint value is valid^
