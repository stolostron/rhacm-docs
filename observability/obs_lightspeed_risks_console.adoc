...
[#obs-lightspeed-risks-pred]
= Viewing Red Hat Lightspeed updated risk predictions from the console

[role="_abstract"]
View Red Hat Lightspeed updated risk predictions from the console by using the cluster overview page.
...
* xref:../observability/obs_lightspeed.adoc[Using observability with Red Hat Lightspeed]