...
----
* `managedclusters` represents the parameter values for the managed clusters. 
* `resourceNames` represents the list of managed clusters.
* `verbs` represents the namespace of the managed clusters.
