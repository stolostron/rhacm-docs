...
= Viewing {lightspeed-short} updated risk predictions from the console 

[role="_abstract"]
View {rh-lightspeed} updated risk predictions from the cluster _Overview_ page in the console.
...
* xref:../observability/obs_insights.adoc[Using observability with {lightspeed-short}]
