...
When you create or import a cluster, data from your managed cluster is automatically sent to Red Hat Insights. Each vulnerability report has its own custom resource (CR) that is created on the hub cluster.
