...
When you create or import a OpenShift cluster, data from your managed cluster is automatically sent to Red Hat. Each vulnerability report has its own custom resource (CR) that is created on the hub cluster.
