...
. By default, the out of the box alert rules are defined in the `thanos-rule-default-rules` ConfigMap in the `open-cluster-management-observability` namespace. You can create multple rules in the configuration.
