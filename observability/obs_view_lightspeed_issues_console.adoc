...
* xref:../observability/obs_lightspeed_risks_console.adoc#obs-lightspeed-risks-pred[Viewing Red Hat Insights updated risk predictions]
* xref:../observability/obs_lightspeed.adoc#obs-lightspeed[Using observability with Red Hat Insights]
