...
//would like to change this to Search from the console since this is mainly a concept doc; if updated, there are 11 instances that i need to update in other folders. This can be tech debt | MJ | 07/03
