[#federate-uw]
= Federating user workloads

Federate your user workloads to scale your metrics for the multicluster observability add-on. By default, user workload metrics are federated from the `MultiClusterObservability` resource. You can also federate user workloads from the Red Hat OpenShift Cluster Observability Operator on your managed clusters.
