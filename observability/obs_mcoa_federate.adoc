...
[role="_abstract"]
Configure the observability service to federate user workload metrics from the Red Hat OpenShift Cluster Observability Operator on your managed clusters. By default, user workload metrics are federated from the Prometheus user-workload on your {ocp-short} cluster.
