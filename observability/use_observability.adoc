...
- See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.20/html/authentication_and_authorization/managing-oauth-access-tokens[Managing user-owned OAuth access tokens].
