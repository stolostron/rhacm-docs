...
- <<external-metric-query,Querying external metrics>>
...
//need to improve the flow here; should these steps be in a separate section? How is this related to querying external queries?
