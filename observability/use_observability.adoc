...
. If you want to configure custom certificates for the `rbac-query-proxy` route, see link:../secure_cluster/cert_byo.adoc#replace-cert-rbac[Replacing certificates for _rbac-query-proxy_ route].
