...
. To access an endpoint of the default CA certificate from your hub cluster through mutual TLS, which verifies the identities of both parties in a network connection, create the `proxy-byo-ca` TLS secret with the following command:
