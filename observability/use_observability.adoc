...
For example, to explore the _cluster_infrastructure_provider_ alert from a single node cluster, use the following query expression: `cluster_infrastructure_provider{clusterType="SNO"}`
