...
. If you want to configure custom certificates for the `rbac-query-proxy` route, see link:../secure_cluster/cert_manage.adoc#replacing-certificates-for-rbac-query-proxy-route[Replacing certificates for rbac-query-proxy route].
