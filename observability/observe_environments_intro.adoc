...
* xref:../observability/observability_enable.adoc#enabling-observability[Enabling observability service]
...
* xref:../observability/insights_observability.adoc#rh-insights[Using observability with Red Hat Insights]
