...
//Starting on modular changes and improvements
//I noticed that multicluster observability operator is capital in the comments, is that how the operator name is displayed from the console?
