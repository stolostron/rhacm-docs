...
// consider adding substep to explain how to apply the service to specific managed clusters with clusterLabels.
...
*Important*: Your object storage is not effected after you remove the observability service.
