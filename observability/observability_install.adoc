...
+
----
oc get secret pull-secret -n openshift-config --export -o yaml | sed 's/name:\ pull-secret/name: multiclusterhub-operator-pull-secret/' | kubectl apply --namespace=open-cluster-management-observability -f -
----
