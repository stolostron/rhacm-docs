...
After you install observability, all of the pods in your `open-cluster-management-observability` namespace for your object storage, Grafana, and AlertManager are automatically installed. All managed clusters that are connected to {product-title-short} can send metrics to the cluster.
