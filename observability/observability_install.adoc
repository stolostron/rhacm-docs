...
+
.. To deploy on infrastructure nodes, you must set a label for your infrastructure node. Next, update the `_nodeSelector_` the infrastructure YAML. For more information, see link:https://access.redhat.com/solutions/5034771[Infrastructure Nodes in OpenShift 4].
