...
To disable the observability service, uninstall the `observability` resource. See steps 1 and 2 of link:../install/#removing-a-multiclusterhub-instance-by-using-commands[Removing a MultiClusterHub instance by using commands].

To learn more about how to customize the observability service, see xref:../observability/manage_observe.adoc#customizing-observability[Customizing observability].
