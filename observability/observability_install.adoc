...
+
.. To deploy on infrastructure machine sets, you must set a label for your set. Next, update the `_nodeSelector_` the infrastructure machine set YAML. For more information, see link:https://docs.openshift.com/container-platform/4.6/machine_management/creating-infrastructure-machinesets.html[Creating infrastructure machine sets].
