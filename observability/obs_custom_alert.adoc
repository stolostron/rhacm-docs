...
[role="_abstract"]
You can customize the Observatorium API and Alertmanager URLs that the managed cluster uses to communicate with the hub cluster to maintain all {acm-short} functions when you use a load balancer or reserve proxy. 
