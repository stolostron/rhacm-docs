...
. Design your Grafana dashboard by creating a `grafana-dev` instance. Be sure to use the most current `grafana-dev` instance.
...
* xref:../observability/design_grafana.adoc#using-grafana-dashboards[Using Grafana dashboard]
