...
- Amazon S3 (or other S3 compatible object stores like Minio and Ceph)
- Google Cloud Storage
- Azure storage
- {ocp-short}
+
*Important*: When you configure your object store, ensure that you meet the encryption requirements necessary when sensitive data is persisted. The object store interface in Thanos support APIs that are AWS S3 restful API compatible. For a complete list of the supported object stores, see https://thanos.io/tip/thanos/storage.md/#object-storage[Thanos documentation].
