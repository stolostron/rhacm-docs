...
- Read link:../governance/policy_ctrl_adv_config.adoc#gov-metric[Governance metric] for more details about how to view trends and analyze any policy failures by using metrics.
