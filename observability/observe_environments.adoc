...
//confirmed that this should not be here 
...
- For more information about enabling observability, read xref:../observability/observability_enable.adoc#managing-observability-service[Enabling the observability service].
