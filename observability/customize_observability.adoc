...
+
----
need a small snippet of the YAML file 
----

For descriptions of the parameters that can added into the `advanced` configuration, see link:../apis/observability.json.adoc[Observability API].
