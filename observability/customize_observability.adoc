...
When you query historical data, you can set your query parameter options manually. Complete the following steps:
...
. Navigate to the Query front-end data source in Grafana. 

. Click the _Query_ tab and seclect `$datasource`. 
