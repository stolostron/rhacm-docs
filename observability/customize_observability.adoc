...
Customize the obseravbility configuration to the specific needs of your environment how you want to manage and view cluster fleet data.
...
//add reference link to the governance topic Replacing certificates for alertmanager route
