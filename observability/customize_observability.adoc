...
You can access the object store when you customize certificates, which give you more options to configure the observability service. Complete the following steps:

. Create the secret with the `ca.crt` certificate. View the following example:
