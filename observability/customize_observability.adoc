...
Read the following sections to learn more about how you want to manage and view cluster fleet data that the observability service collects:
...
Recording rules give you the ability to precalculate expensive expressions as needed. The results are saved as a new set of time series. Alerting rules give you the ability to specify the alert conditions based on how you want to send an alert to an external service.
