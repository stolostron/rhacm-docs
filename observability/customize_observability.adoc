...
. To verify that you can access the object store, check that the pods are deployed.
//what command can the user run to confirm that the pods are deployed | MJ | 08/08
