...
** <<updating-the-multiclusterobservability-cr,Updating the multiclusterobservability custom resource>>
...
- <<updating-replicas,Updating the multiclusterobservability custom resource replicas from the console>>
