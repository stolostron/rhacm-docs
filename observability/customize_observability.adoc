...
- You can perform additional queries for other downsampling levels where data is missing by adding a URL query parameter. Verify that the following parameter is set in the Thanos Query front-end data source: `max_source_resolution=auto`.
