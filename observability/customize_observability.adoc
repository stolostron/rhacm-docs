...
== Adding custom metrics
//I mention managed clusters here, should this be changed to hub clusters? Mentioning "managed cluster" here and in the note seem repetitive | MJ | 07/11 
...
+
*Note:* The metrics collector also collects the allowlist from your managed cluster. You can create the same YAML directly on your managed cluster to customize the metrics.
