...
If you want to use the configuration for a single cluster, use the following example and on your managed cluster in the `open-cluster-management-addon-monitoring` namespace:
