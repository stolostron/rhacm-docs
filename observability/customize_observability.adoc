...
** Recording rules allow you to pre-calculate frequently needed or computationally expensive expressions and save their result as a new set of time series.
** Alerting rules allow you to specify the alert conditions, based on that an alert should be fired to an external service.
