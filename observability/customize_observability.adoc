...
//for retention
//potentially adding more tasks|MJ|09/29/23
...
- For more information about recording rules and alerting rules, refer to the link:https://prometheus.io/docs/prometheus/latest/configuration/recording_rules/[recording rules] and link:https://prometheus.io/docs/prometheus/latest/configuration/alerting_rules/[alerting rules] to the observability resource.
