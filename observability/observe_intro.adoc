...
Use {product-title} to visualize and monitor metrics from your clusters and cloud providers. You can view metric data about your cluster from the following pages: _Observe environments Overview_ and _Topology_. 
...
For more information, see link:../observability_install.adoc[Install observability service].
