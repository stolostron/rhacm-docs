...
- You must install the latest version of the OADP Operator. The OADP Operator  See the link:https://github.com/openshift/oadp-operator/blob/master/docs/install_olm.md[Install OADP Operator using OperatorHub] documentation.
