...
*Note:* You can also access all APIs from the integrated console. Select the *Administrator* perspective, then navigate to *Home* > *API Explorer* to explore API groups.
