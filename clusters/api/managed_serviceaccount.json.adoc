[#serviceaccount-api]
= ManagedServiceAccount API (v1beta1)
...
....
POST /apis/multicluster.openshift.io/v1beta1/ManagedServiceAccounts
....
...
....
GET /cluster.open-cluster-management.io/v1beta1/namespaces/{namespace}/managedserviceaccounts/{managedserviceaccount_name}
....
...
....
DELETE /cluster.open-cluster-management.io/v1beta1/namespaces/{namespace}/managedserviceaccounts/{managedserviceaccount_name}
....
