...
= Importing an existing cluster with the console
//we should be able to remove most of this content and merge the section (if needed) into one import topic -- most of this is UI --bcs
...
+
See xref:../clusters/supported_providers.adoc#supported-providers[Supported providers] to learn how to configure your `kubectl` command line interface. 
...
+
See xref:../clusters/supported_providers.adoc#supported-providers[Supported providers] to learn how to configure your `kubectl`.
