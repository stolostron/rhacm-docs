...
To import a cluster, complete the steps in the console after you select *Infrastructure* > *Clusters*. Select the _Managed clusters_ tab, and click *Import cluster*.
...
The available options for _import mode_ identify the cluster that you are importing from the following options:
