...
+
See xref:../clusters/supported_providers.adoc#supported-clouds[Supported clouds] to learn how to configure your `kubectl` command line interface. 
...
+
See xref:../clusters/supported_providers.adoc#supported-clouds[Supported clouds] to learn how to configure your `kubectl`.
