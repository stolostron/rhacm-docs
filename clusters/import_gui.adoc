...
* Run import commands manually: Run the provided command on the target cluster to import the cluster.
...
After specifying your import mode, you can specify a Red Hat Ansible Automation Platform template to run when the cluster is imported or upgraded. You must have the Red Hat Ansible Automation Platform Resource Operator installed from OperatorHub to create and run an Ansible Automation Platform job. 

After you review and submit the content, continue with one of the following sets of instructions based on which import mode you specified:

* link:../clusters/import_gui.adoc#run-import-commands-manually[Additional steps for running the import commands manually]

* link:../clusters/import_gui.adoc#import-server-url-and-api-token[Enter your server URL and API token for the existing cluster]

* link:../clusters/import_gui.adoc#import-kubeconfig[Kubeconfig file]
...
[#import-server-url-and-api-token]
=== Enter your server URL and API token for the existing cluster

Provide the server URL and API token of the cluster that you are importing.
...
Copy and paste the content of the `kubeconfig` file of the cluster that you are importing. 
