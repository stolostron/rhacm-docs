...
After reviewing and submitting the content, the cluster import starts. You can view the progress on the _Cluster details_ page for the cluster as it is imported. 
