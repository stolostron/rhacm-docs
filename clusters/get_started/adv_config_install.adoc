...
+
To define a set of node selectors for the {acm} hub cluster, see link:../../get_started/adv_config_install.adoc#node-selector[nodeSelector] in the {acm-short} documentation.
...
+
To define a list of tolerations for the {acm} hub cluster,, see link:../../get_started/adv_config_install.adoc#tolerations[tolerations] in the {acm-short} documentation.
