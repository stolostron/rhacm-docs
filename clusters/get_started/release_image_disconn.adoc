...
. When you are on a connected system, go to the link:https://github.com/stolostron/acm-hive-openshift-releases/tree/backplane-2.17[acm-hive-openshift-releases GitHub repository] to access the available cluster image sets.
