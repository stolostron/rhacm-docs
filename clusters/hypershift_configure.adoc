...
*Note:* If you want your {product-title-short} hub cluster to be your hosted control planes hosting service cluster, you can configure `local-cluster` as your hosting service cluster.
