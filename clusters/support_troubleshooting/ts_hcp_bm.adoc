...
. To fix this issue, follow the instructions in xref:../cluster_lifecycle/create_cluster_on_prem.adoc#on-prem-creating-your-cluster-with-the-cli-pull-secret[Add the pull secret to the namespace].