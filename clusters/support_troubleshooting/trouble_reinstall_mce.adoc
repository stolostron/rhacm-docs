...
. Run the uninstallation process to remove the current components by following the steps in xref:../get_started/uninstall.adoc#uninstalling-mce[Uninstalling].
...
. Run the installation. See xref:../get_started/install_connected.adoc#installing-while-connected-online-mce[Installing while connected online].
