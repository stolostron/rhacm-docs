...
. Run the uninstallation process to remove the current components by following the steps in xref:../install_update/uninstall.adoc#uninstalling-mce[Uninstalling].
...
. Run the installation. See xref:../install_update/install_connected.adoc#installing-while-connected-online-mce[Installing while connected online].
