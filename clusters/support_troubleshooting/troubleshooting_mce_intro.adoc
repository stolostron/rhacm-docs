 ...
 * xref:../support_troubleshooting/trouble_cluster_cert_update.adoc#ca-update-hive-assisted-installer-clusters[Troubleshooting certificate authority update on Hive and Assisted Installer clusters]
