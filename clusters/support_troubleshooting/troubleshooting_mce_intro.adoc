...
To view the main documentation for the installing tasks, see xref:../get_started_mce/install_intro.adoc#mce-install-intro[Installing and upgrading {mce-short}].
...
* xref:../support_troubleshooting/trouble_cluster_remove_namespace_mce.adoc#trouble-cluster-remove-namespace-mce[Troubleshooting namespace that remains after deleting a cluster]
 ...
 * xref:../support_troubleshooting/trouble_unknown_status_rosa_hcp.adoc#trouble-unknown-status-rosa-hcp[Troubleshooting managed clusters _Unknown_ on {rosa} with hosted control planes cluster]
 * xref:../support_troubleshooting/trouble_missing_version_upgrade.adoc#upgrade-managed-missing-ocp[Troubleshooting an attempt to upgrade managed cluster with missing {ocp-short} version]
 * xref:../support_troubleshooting/trouble_cluster_cert_update.adoc#ca-update-error-hive-ai[Troubleshooting certificate authority update error on Hive and Assisted Installer clusters]
* xref:../support_troubleshooting/trouble_miss_ns.adoc#trouble-miss-namespace[Troubleshooting: Missing `open-cluster-management-global-set` namespace]
//* xref:../support_troubleshooting/trouble_capz_create.adoc#trouble-aro-hcp-capz-create[Troubleshooting issues when creating Microsoft Azure Red Hat OpenShift {hcp} clusters by using Cluster API Provider for Azure]
//* xref:../support_troubleshooting/trouble_capz_stuck.adoc#trouble-aro-hcp-capz-stuck[Troubleshooting Microsoft Azure Red Hat OpenShift {hcp} cluster with Cluster API Provider for Azure becomes stuck during provisioning]
