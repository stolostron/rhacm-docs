...
* xref:../support_troubleshooting/trouble_missing_version_upgrade.adoc#upgrade-managed-missing-ocp[Troubleshooting upgraded managed cluster with missing {ocp-short} version]
