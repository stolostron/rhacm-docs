 ...
 * xref:../support_troubleshooting/trouble_network_config_bm.adoc#troubleshooting-network-config-failTroubleshooting adding day-two nodes to an existing cluster fails with pending user action]
