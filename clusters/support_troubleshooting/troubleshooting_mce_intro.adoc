 ...
 * xref:../support_troubleshooting/trouble_network_config_bm.adoc#troubleshooting-network-config-bm[Troubleshooting network configuration for bare metal clusters]
