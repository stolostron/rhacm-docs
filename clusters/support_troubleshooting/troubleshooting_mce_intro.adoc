...
To view the main documentation for the installing tasks, see xref:../install_update/install_intro.adoc#mce-install-intro[Installing and updating {mce-short}].
 ...
 * xref:../support_troubleshooting/trouble_missing_version_update.adoc#update-managed-missing-ocp[Troubleshooting an attempt to update managed cluster with missing {ocp-short} version]
