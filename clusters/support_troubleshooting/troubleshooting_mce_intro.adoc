 ...
 * xref:../support_troubleshooting/trouble_cluster_cert_update.adoc#troubleshooting-ca-update-on-hive-and-assisted-installer-clusters[Troubleshooting CA update on Hive and Assisted Installer clusters]
