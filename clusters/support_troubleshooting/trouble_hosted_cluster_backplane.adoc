...
* For more information about troubleshooting hosted control planes, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/{ocp-version}/html/hosted_control_planes/hcp-troubleshooting[Troubleshooting hosted control planes] in the {ocp-short} documentation.
