[#troubleshooting-cluster-in-console-with-pending-or-failed-status-mce]
...
See xref:../cluster_lifecycle/create_intro.adoc#create-intro[Cluster creation introduction] for more information about creating a cluster.
