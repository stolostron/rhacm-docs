...
IMAGE=$REGISTRY/multicluster-engine/must-gather-rhel8@:ff9f37eb400dc1f7d07a9b6f2da9064992934b69847d17f59e385783c071b9d8

oc adm must-gather --image=$IMAGE --dest-dir=./data
----
//credentials in this command? (line 65)

You can open a bug for the product team link:https://bugzilla.redhat.com/[here].
//shouldn't this be JIRA?
