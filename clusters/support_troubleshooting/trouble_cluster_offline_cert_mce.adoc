...
If your managed cluster is the `local-cluster` or your managed cluster was created by using {mce-short}, you must wait 10 minutes or longer to reimport your managed cluster.
