...
If the discovery of bare metal hosts fails when on Dell hardware, the Integrated Dell Remote Access Controller (iDRAC) is likely configured not to allow certificates from unknown certificate authorities.   
