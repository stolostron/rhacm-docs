...
Ensure that your VMware vCenter required account privileges are correct. See link:https://docs.redhat.com/documentation/en-us/openshift_container_platform/4.12/html/installing/installing-on-vsphere#installing-vsphere-installer-provisioned[Image registry removed during information] for more information. 
