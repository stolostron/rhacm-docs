...
You must have an {ocm} credential. See link:../credentials/credential_intro.adoc#credentials[Managing credentials overview] if you need to create a credential.
