...
Configure Discovery in the console to find clusters. You can configure Discovery multiple times with separate credentials. 

See the following procedure if you are using Discover for the first time:
...
. *Optional:* Change discovery settings by clicking the *Configure discovery settings*.
