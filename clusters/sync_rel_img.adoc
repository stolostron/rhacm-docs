...
The release images are available in the https://github.com/stolostron/acm-hive-openshift-releases/tree/release-2.3[acm-hive-openshift-releases] GitHub repository for version 2.3.
...
. Clone the https://github.com/stolostron/acm-hive-openshift-releases/tree/release-2.3[acm-hive-openshift-releases] GitHub repository for version 2.3.
