...
* A temporary external KVM host that serves as a bootstrap virtual machine for the Hive cluster creation. See link:../credentials/credential_bare.adoc#bare-set-up-provisioner[Preparing a provisioner host] for more information. 
