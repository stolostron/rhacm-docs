...
* Removes the {ocp} 4.19 image from the default setting when you deploy the `infrastructure-operator`. (link:https://issues.redhat.com/browse/ACM-19146[ACM-19146])