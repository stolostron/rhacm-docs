...
- You can now access the managed cluster `kube-apiserver` by using a hub cluster user token. To learn more, see xref:../cluster_proxy_addon_use#use-cluster-proxy-addon[Using cluster proxy add-ons]
