...
* You can now specify if you want to create a minimal ISO or full ISO when generating the Discovery ISO. To learn more, see xref:../assisted_installer/ai_add_host.adoc#add-host-steps-console[Adding hosts by using the console].