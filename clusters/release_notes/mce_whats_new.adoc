...
* <<acm-integration,{acm-short} integration>>
...
* You can now connect to {ocm} with Service Account credentials. See link:../clusters/credentials/credential_ocm.adoc#creating-a-credential-for-openshift-cluster-manager[Creating a credential for Red Hat {ocm}].
