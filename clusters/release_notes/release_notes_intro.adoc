...
For full support information, see the link:https://access.redhat.com/articles/7056007[Support matrix]. For lifecycle information, see link:https://access.redhat.com/support/policy/updates/openshift[{ocp} Life Cycle policy].