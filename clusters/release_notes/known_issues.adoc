...
The `selectorType: LaberSelector` setting is not supported when using the link:../../apis/managedclusterset.json.adoc#managedclusterset-api[ManagedClusterSet API].
