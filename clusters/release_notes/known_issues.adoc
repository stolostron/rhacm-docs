...
Deploying a managed cluster might fail if the Assisted Installer agent starts slowly. You can work around the issue by disabling converged flow. Complete the following steps:
