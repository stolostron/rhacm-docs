...
The `selectorType: LaberSelector` setting is not supported when using the link:../../apis/managedclusterset.json.adoc#clustersets-api[Clustersets API]. The `selectorType: ExclusiveClusterSetLabel` setting is supported.
