...
=== The _ClusterCurator_ does not support {ocp-short} Dedicated clusters
//2.10:ACM-10154

When you upgrade an {ocp-short} Dedicated cluster by using the `ClusterCurator`, the upgrade fails because the `ClusterCurator` does not support {ocp-short} Dedicated clusters.
