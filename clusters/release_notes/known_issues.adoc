...
When you upgrade from {mce-short} to MCE 2.4.1, you might find a `StorageVersionMigration` error in the log of the `cluster-manager` pods that run in the namespace of {mce-short}. See the following sample of the error message: 
...
These error messages have no impact on {mce-short} and {product-title-short}. Therefore, you do not need to take any action to resolve these errors. 
