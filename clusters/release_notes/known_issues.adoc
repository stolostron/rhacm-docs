...
The `managed-serviceaccount` add-on  does not support running on {ocp-short} 3.11. If you run `managed-serviceaccount` add-on on {ocp-short} 3.11, the `managed-serviceaccount` add-on crashes. 
