...
{product-title} does not support the `selectorType: LaberSelector` setting when using the link:../../apis/managedclusterset.json.adoc#managedclusterset-api[ManagedeClusterSet API].
