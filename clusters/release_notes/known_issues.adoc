...
When you upgrade from {mce-short} to MCE 2.4.1, you might find a `StorageVersionMigration` error in the log of the cluster-manager pods under the namespace of {mce-short}. See the following sample of the error message: 
