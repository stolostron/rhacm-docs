...
*Deprecated:* Documentation for {mce-short} 2.7 and earlier versions is no longer supported. The documentation might remain available, but without any Errata or other updates.
