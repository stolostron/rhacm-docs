...
*Deprecated:* The 2.2 and earlier versions of {mce-short} are no longer supported. The documentation might remain available, but without any Errata or other updates available.
