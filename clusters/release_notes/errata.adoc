...
* Fixes an issue that caused single-node OpenShift managed clusters to show an `unknown` status after upgrading to {product-title-short} version 2.10.3. (link:https://issues.redhat.com/browse/ACM-12584[ACM-12584])
