...
== Errata 2.3.5
//descriptions from developers have not been provided yet --this is just my attempt after looking at the bugs 
* Fixes an issue where the name of the `ManagedKubeConfig` secret was incorrect.  (link:https://issues.redhat.com/browse/ACM-8798[ACM-8798])
