...
* xref:../release_notes/mce_new.adoc#new-features-mce[New features and enhancements for Cluster lifecycle with {mce-short}]
* xref:../release_notes/mce_fixed_issues.adoc#errata-updates-mce[Fixed issues for Cluster lifecycle with {mce-short}]
...
* For full support information, see the link:https://access.redhat.com/articles/7133096[{mce-short} Support Matrix]. For lifecycle information, see link:https://access.redhat.com/support/policy/updates/openshift[{ocp} Life Cycle policy].
