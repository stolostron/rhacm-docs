...
//2.9:ACM-21686
//still editing
During an {mce-short} upgrade or modification to the `ClusterPool` custom resource definition, Hive might delete and recreate all unclaimed clusters. This is expected behavior and ensures that unclaimed clusters reflect the latest configuration defined in the updated `ClusterPool` resource specification.
