...
After you upgrade from {mce} version 2.10 or 2.10.1 to version 2.11, the automatic generation of certificates for the Cluster API Provider Metal3 webhooks fail. As a result, webhooks do not validate.
