...
* You can now automate the import of {rosa} clusters by using {product-title-short} policy enforcement with {mce-short} for faster cluster management. Learn more at link:../../clusters/acm_integration/acm_integration_import_rosa.adoc#import-discover-rosa[Automating import for discovered {rosa} clusters].
