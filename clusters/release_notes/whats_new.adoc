...
If you have {product-title-short} installed and Observability enabled, you can now view your hosted control planes cluster capacity estimate and resource utilizations.