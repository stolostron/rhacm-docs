...
Use the integrated console to create a credential and cluster that runs in the Nutanix environment. See xref:../credentials/credential_intro.adoc#credentials[Managing credentials] and xref:../cluster_lifecycle/create_intro.adoc#create-intro[Cluster creation introduction] for more information. 
