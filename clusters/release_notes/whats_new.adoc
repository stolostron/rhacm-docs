...
** Amazon Web Services: For more information, see xref:../hosted_control_planes/config_hosted_aws.adoc#hosting-service-cluster-configure-aws[Configuring the hosting cluster on AWS (Technology Preview)].
** IBM Z: For more information, see xref:../hosted_control_planes/config_hosted_bm_ibmz.adoc#configuring-hosting-service-cluster-ibmz[Configuring the hosting cluster on `x86` bare metal for IBM Z compute nodes (Technology Preview)].
