...
- You can use the Central Infrastructure Management (CIM) feature to create a bare metal {ocp-short} cluster on Nutanix. See xref:../cluster_lifecycle/create_cluster_on_prem.adoc#on-prem-creating-your-cluster-with-the-cli[Creating your cluster with the command line].
