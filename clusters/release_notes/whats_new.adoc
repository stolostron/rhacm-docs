...
- You can use two control plane types: hosted and standalone. _Hosted_ is the console wizard feature, which provides to guidance so you can create the cluster from your CLI.
