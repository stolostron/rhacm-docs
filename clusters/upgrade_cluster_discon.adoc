...
. From the {product-title-short} console, select *Risk and compliance* > *Create policy*.
...
. In the {product-title-short} console menu, select *Risk and compliance* > *Create policy*.
. Set the `YAML` switch to _On_ to view the YAML version of the policy.
. Delete all of the content in the `YAML` code. 
. Paste the following `YAML` content into the window to create a custom policy:
. Paste the following `YAML` content into the window to create a custom policy:
...
. In the hub cluster {product-title-short} console menu, select *Risk and compliance* > *Create a policy*.
. Set the `YAML` switch to _On_ to view the YAML version of the policy.
. Delete all of the content in the `YAML` code. 
. Paste the following `YAML` content into the window to create a custom policy:
+
