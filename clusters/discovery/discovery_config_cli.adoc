...
. Enter the versions of {ocp-short} clusters to discover as a list of strings. *Note:* Every entry in the `openshiftVersions` list specifies the {ocp-short} major and minor version. For example, specifying `"4.17"` includes all Errata releases, for example `4.17.1`, `4.17.2`.
