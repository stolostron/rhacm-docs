...
. Enter the versions of {ocp-short} clusters to discover as a list of strings. *Note:* Every entry in the `openshiftVersions` list specifies a major and minor version. For example, specifying `"4.x"` includes all Errata releases for the {ocp-short} version `4.x`, for example `4.x.1`, `4.x.2`.
...
spec:
  ...
  console: https://console-{ocp-short}-console.apps.qe1-vmware-pkt.dev02.red-chesterfield.com
