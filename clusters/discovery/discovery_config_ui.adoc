...
. You can view the Region from the command line tool with the following command:
//We need to confirm this and link to CLI doc for that process, then edit CLI doc.
