...
See xref:../clusters/prov_conn_azure.adoc#creating-a-provider-connection-for-microsoft-azure[Creating a provider connection for Microsoft Azure] for more information.
...
If you do not have one configured, or want to configure a new one, select *Add connection*. See xref:../clusters/prov_conn_azure.adoc#creating-a-provider-connection-for-microsoft-azure[Creating a provider connection for Microsoft Azure] for more information about creating a provider connection.
...
+
Enter the base DNS information that you configured for your Azure account. If there is already a base DNS associated with the selected provider connection, that value is populated in that field. You can change the value by overwriting it.
