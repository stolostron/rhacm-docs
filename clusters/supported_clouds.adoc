...
* See https://docs.openshift.com/container-platform/4.7/installing/installing_ibm_power/installing-ibm-power.html[Red Hat {ocp} on IBM Power Systems (Technology preview)]
...
* See https://docs.openshift.com/container-platform/4.7/installing/installing_ibm_power/installing-ibm-power.html[Red Hat {ocp} 4.6.1, and later, on IBM Power Systems]
