...
* A supported version of {ocp-short} must be deployed in your environment, and you must be logged into with the {ocp-short} CLI. See the following install documentation:
  ...
  - link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html/installation_overview/index[Installation overview] in the {ocp-short} documentation.
