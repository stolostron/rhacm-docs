...
* If you plan to create managed clusters by using the Assisted Installer that is provided with {ocp}, see link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.13/html/assisted_installer_for_openshift_container_platform/preparing-to-install-with-ai[Preparing to install with the Assisted Installer] topic in the OpenShift Container Platform documentation for the requirements. 
