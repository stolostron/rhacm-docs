...
* {ocp-short} 4.13 or later, must be deployed in your environment, and you must be logged into with the {ocp-short} CLI. See the following install documentation for {ocp-short}:

  - link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.13/html/installation_overview/index/[Installation overview] in the {ocp-short} documentation.
