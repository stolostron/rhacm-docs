...
- link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.14/html/installation_overview/index/[Installation overview] in the {ocp-short} documentation.
