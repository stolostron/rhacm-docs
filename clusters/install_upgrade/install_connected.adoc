...
* You must have a supported version of {ocp-short} deployed in your environment, and you must log in from the {ocp-short} command-line interface. For help with logging into the {ocp-short} command-line interface, see the link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html/installation_overview/index[Installation overview] in the {ocp-short} documentation.
