...
+
To define a set of node selectors for the {acm} hub cluster, see link:../../install/adv_config_mce.adoc#node-selector[nodeSelector] in the {acm-short} documentation.
