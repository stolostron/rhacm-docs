...
To define a set of node selectors for the {acm} hub cluster, see link:../install/adv_config_install.adoc#node-selector[nodeSelector] in the product documentation.
...
To define a list of tolerations for the {acm} hub cluster, see link:../install/adv_config_install.adoc#tolerations[tolerations] in the product documentation.
