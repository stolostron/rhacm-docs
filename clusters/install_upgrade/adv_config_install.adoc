...
To define a set of node selectors for the {acm-short} hub cluster, see link:../../install/adv_config_install.adoc#node-selector[nodeSelector] in the product documentation.
