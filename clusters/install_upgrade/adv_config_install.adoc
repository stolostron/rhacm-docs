...
To define a list of tolerations for the {acm-short} hub cluster, see link:../../install/adv_config_install.adoc#tolerations[tolerations] in the product documentation.
