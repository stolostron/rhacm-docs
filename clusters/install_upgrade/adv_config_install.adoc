...
| cluster-api-provider-openshift-assisted-preview | Provides Kubernetes-style APIs for cluster creation, configuration, and management leveraging Assisted Installer | False
| cluster-api-provider-metal3-preview | Provides Kubernetes-style APIs for cluster creation, configuration, and management ocn bare-metal infrastructure | False
