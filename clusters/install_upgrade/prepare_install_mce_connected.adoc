...
* Confirm that a supported version of {ocp-short} is deployed in your environment, and you must be logged into with the {ocp-short} CLI. See the following install documentation:
