...
* {ocp} version {ocp-latest} or later must be deployed in your environment, and you must be logged in with the command line interface (CLI). 
...
+
*Note:* For managing bare metal clusters, you must have {ocp-short} version {ocp-latest} or later.
+
See the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/{ocp-version}/html/installing/index[{ocp-short} version {ocp-latest}].

* Your {ocp} CLI must be version {ocp-latest} or later, and configured to run `oc` commands.
...
* You must have a supported {ocp-short} version, including the registry and storage services, installed and working in your cluster. For information about {ocp-short} version {ocp-latest}, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/{ocp-version}/[{ocp-short} documentation].
