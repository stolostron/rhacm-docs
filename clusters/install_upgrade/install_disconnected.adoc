...
+
See the link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.15/html/installation_overview/index[Installation overview] in the {ocp-short} documentation.
