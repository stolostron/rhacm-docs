...
. Configure the disconnected {olm} for the Red Hat Operator catalog. Follow the steps in the link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.19/html/operators/administrator-tasks#olm-restricted-networks[Using Operator Lifecycle Manager on restricted networks] documentation.
