...
+
See the link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html/installation_overview/index[Installation overview] in the {ocp-short} documentation.
...
* You must have a supported {ocp-short} version, including the registry and storage services, installed and working in your cluster. For information about {ocp-short}, see link:https://docs.redhat.com/documentation/en-us/openshift_container_platform/4.16/[{ocp-short} documentation].
...
+
. *Optional:* You can specify multiple SSH public keys, which allow you to access the hosts after installing. See the following example:
+
[source,yaml]
----
sshKey: |
