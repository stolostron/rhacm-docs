...
Alterantively, you can also use the `infraenv.agent-install.openshift.io/ironic-agent-image-override` InfraEnv annotation to override the ironic agent image.
