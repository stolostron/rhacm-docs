...
<<<<<<< Updated upstream
* link:../../acm_mce_integration/acm_integrate_intro.adocmce_acm_integration[{mce-short} with {acm-short} integration]
=======
* link:../../acm_mce_integration/mce_acm_intro.adocmce_acm_integration[{acm-short} integration]
>>>>>>> Stashed changes
