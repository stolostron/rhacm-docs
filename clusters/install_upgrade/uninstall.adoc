...
+
For more information about detaching clusters, see the _Removing a cluster from management_ section by selecting the information for your provider in xref:../cluster_lifecycle/create_intro.adoc#create_intro[Cluster creation introduction].
