...
. Enter the following commands to delete the multicluster-engine `ClusterServiceVersion` in the namespace where it is installed and the version replacing the `v2.x.0` variables:
