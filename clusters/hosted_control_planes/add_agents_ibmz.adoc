...
== Adding IBM Z with KVM as Agents
...
[#hosted-bare-metal-adding-agents-ibmz-lpar]
== Adding IBM Z in an LPAR as Agents

{ocp-short} 4.16 allows you to add a Logical Partition (LPAR) on IBM Z or IBM LinuxONE as a **Compute node** in a hosted control plane.
