...
After you meet the prerequisites, take the following steps to configure hosted control planes on bare metal:
...
. xref:../hosted_control_planes/managing_hosted_aws.adoc#hosting-service-cluster-access-aws[Accessing the hosted cluster]
