...
To continue with the configuration of hosted control planes on bare metal, take the following steps:
...
. xref:../hosted_control_planes/hosted_bare_metal_agents.adoc#hosted-bare-metal-adding-agents[Add agents to hosted control planes on bare metal]
. xref:../hosted_control_planes/hosted_bare_metal_verifying_cluster.adoc#verifying-cluster-creation-bm[Verify hosted cluster creation on bare metal]
. xref:../hosted_control_planes/hosted_bare_metal_access_cluster.adoc#access-hosted-cluster-bm[Access the hosted cluster on bare metal]
