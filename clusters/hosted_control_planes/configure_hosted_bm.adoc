...
. xref:../cluster_lifcycle/create_infra_env.adoc#creating-your-infra-env-with-the-console[Create an InfraEnv resource for hosted control planes on bare metal]
