...
* For information about how the Agent platform works with {mce-short} to enable hosted control planes in disconnected environments, see xref:../hosted_control_planes/mce_and_agent.adoc#mce-and-agent[Disconnected environment architecture].
