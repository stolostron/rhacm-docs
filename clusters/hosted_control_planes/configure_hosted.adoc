...
The Central Infrastructure Management service is included as part of {product-title}.  To enable the service see xref:../cluster_lifecycle/create_infra_env.adoc#enble-cim[Enabling the Central Infrastructure Management service] for the procedure. 
