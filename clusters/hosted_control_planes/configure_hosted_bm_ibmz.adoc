...
* You need to install the hosted control plane command line interface. See xref:../hosted_control_planes/hosted_install_cli.adoc[Installing the hosted control plane command line interface].
