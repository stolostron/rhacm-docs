...
* If you are working in a virtual environment, after you configure mirroring, ensure that you meet the xref:../hosted_control_planes/managing_hosted_kubevirt.adoc#prerequisites[prerequisites for hosted control planes on OpenShift Virtualization].
