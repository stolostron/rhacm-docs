...
For an output example, see the link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.14/html/installing_on_ibm_power/installing-ibm-power#installation-operators-config_installing-ibm-power[Initial Operator configuration] section in the {ocp-short} documentation.
