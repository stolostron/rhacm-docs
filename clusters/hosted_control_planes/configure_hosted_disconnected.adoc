...
*Note:* You can deploy hosted control planes in a disconnected environment on bare-metal platforms. On a virtual platform, hosted control planes in a disconnected environment is available as a Technology Preview feature. 
