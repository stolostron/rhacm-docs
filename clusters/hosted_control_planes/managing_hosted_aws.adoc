...
//lahinson - should we specify which CLI we're referring to in the latter sentence?
...
//lahinson - update hypershift cli command here
----
REGION=us-east-1
...
//lahinson - update hypershift cli command above
...
//lahinson - check reference to cli
...
//lahinson - check reference to hypershift cli
...
//lahinson - check reference to cli here
...
//lahinson - check reference to cli in the following step
