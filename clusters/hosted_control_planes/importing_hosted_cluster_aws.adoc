...
Hosted clusters are automatically imported into {mce-short} after the hosted control plane becomes available. The following steps describe how to import hosted clusters manually.
