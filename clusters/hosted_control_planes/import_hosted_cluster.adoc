...
. Create your `KlusterletAddonConfig` resource by using the following sample YAML file. This only applies to {acm-short}. If you have installed {mce-short} only, skip this step:
