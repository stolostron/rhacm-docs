...
+
<1> All of the nodes included in this `NodePool` are based on the following {ocp-short} version: `4.14.0-0.nightly-2023-08-29-102237`. Replace the `dns.base.domain.name` value with your DNS base domain name.
