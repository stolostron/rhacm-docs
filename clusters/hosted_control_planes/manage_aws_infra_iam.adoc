...
You can create your infrastructure, for example, by using GitOps.

After creating your infrastructure, the following resources are created:
...
See the following example configuration for the hosted cluster namespace:
...
----
hcp create iam aws --infra-id INFRA_ID \ <1>
