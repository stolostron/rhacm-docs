...
metadata:
  ...
  name: jparrill-hosted2-pull-secret
  namespace: clusters
---
apiVersion: v1
data:
...
metadata:
  ...
  labels:
    hypershift.openshift.io/safe-to-delete-with-cluster: "true"
  name: jparrill-hosted2-etcd-encryption-key
  namespace: clusters
type: Opaque
---
apiVersion: v1
...
spec:
  ...
  dns:
    baseDomain: jpdev.hypershift.devcluster.openshift.com
  ...
  fips: false
  infraID: jparrill-hosted2-hqn46
  issuerURL: https://jparrill-hosted-us-west-1.s3.us-west-1.amazonaws.com/jparrill-hosted2-hqn46
  networking:
    clusterNetwork:
    - cidr: 10.132.0.0/14
    machineNetwork:
  ...
  platform:
    aws:
      ...
      region: us-west-1
      rolesRef:
        controlPlaneOperatorARN: arn:aws:iam::820196288204:role/jparrill-hosted2-hqn46-control-plane-operator
        imageRegistryARN: arn:aws:iam::820196288204:role/jparrill-hosted2-hqn46-openshift-image-registry
        ingressARN: arn:aws:iam::820196288204:role/jparrill-hosted2-hqn46-openshift-ingress
        kubeCloudControllerARN: arn:aws:iam::820196288204:role/jparrill-hosted2-hqn46-cloud-controller
        networkARN: arn:aws:iam::820196288204:role/jparrill-hosted2-hqn46-cloud-network-config-controller
        nodePoolManagementARN: arn:aws:iam::820196288204:role/jparrill-hosted2-hqn46-node-pool
        storageARN: arn:aws:iam::820196288204:role/jparrill-hosted2-hqn46-aws-ebs-csi-driver-controller
    type: AWS
  pullSecret:
    name: jparrill-hosted2-pull-secret
  release:
...
metadata:
  creationTimestamp: null
  name: jparrill-hosted2-us-west-1b
  namespace: clusters
spec:
  arch: amd64
  clusterName: jparrill-hosted2
  management:
    autoRepair: true
    upgradeType: Replace
  nodeDrainTimeout: 0s
  platform:
    aws:
      instanceProfile: jparrill-hosted2-hqn46-worker
