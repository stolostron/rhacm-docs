...
To create the AWS infrastructure, use your favorite infrastructure automation and provisioning tool to create a VPC for your cluster. You can also use the AWS console. 
