...
To create the AWS infrastructure, use your favorite infrastructure automation and provisioning tool to create a YAML file. Ensure that the file includes the following fields:
...
<8> Replace `<subnet_xxx>` with your subnet ID.
