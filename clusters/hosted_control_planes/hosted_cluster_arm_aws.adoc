...
+
For example, through the hosted control planes (`hcp`) command line interface, enter the following commands, and replace the bucket name, AWS credentials, and region with your information:
