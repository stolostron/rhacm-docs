...
clusteroperator.config.openshift.io/csi-snapshot-controller                    4.x.0-multi       True        False         False      25m
clusteroperator.config.openshift.io/dns                                        4.x.0-multi       True        False         False      23m
clusteroperator.config.openshift.io/image-registry                             4.x.0-multi       True        False         False      23m
