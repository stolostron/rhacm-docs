...
The {mce-short} plays a crucial role in deploying clusters across providers.  

//lahinson - sept 2023 - In the upstream docs, this page currently points to several pages in the stolostron repo. I asked japarrill whether it would be sufficient for me to link to the MCE installation topics in the official docs from this page.
