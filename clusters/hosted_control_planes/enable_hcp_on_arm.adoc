...
You can also create node pools of different architecture types for the same hosted cluster. The following table shows compatible combinations of node pools and hosted clusters.
