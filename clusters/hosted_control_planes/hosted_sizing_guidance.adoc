...
//the following content is left over--do we need?
...
* xref:../hosted_control_planes/manage-metrics.adoc#override-resource-utilization-measurements[Overriding resource utilization measurements]#hosted-sizing-guidance]
= Hosted control plane sizing guidance
