...
* To troubleshoot hosted clusters on {ocp-virt}, see xref:../troubleshooting/trouble_hosted_cluster_kubevirt.adoc#troubleshooting-hosted-cluster-kubevirt[Troubleshooting hosted clusters on {ocp-virt}].