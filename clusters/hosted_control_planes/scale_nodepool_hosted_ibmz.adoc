...
For an output example, see the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/{ocp-version}/html/installing/installing-on-ibm-z-and-ibm-linuxone#installation-operators-config_installing-ibm-z[Initial Operator configuration] section in the {ocp-short} documentation.
