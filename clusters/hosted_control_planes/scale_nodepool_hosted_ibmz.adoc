...
For an output example, see the link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.14/html/installing_on_ibm_z_and_ibm_linuxone/installing-ibm-z#installation-operators-config_installing-ibm-z[Initial Operator configuration] section in the {ocp-short} documentation.
