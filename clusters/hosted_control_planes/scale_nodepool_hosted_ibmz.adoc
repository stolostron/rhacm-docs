...
For each component of your cluster, the output shows: VERSION, AVAILABLE, PROGRESSING, DEGRADED, SINCE, and MESSAGE. For an output example, see the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html/installing/installing-on-ibm-z-and-ibm-linuxone#installation-operators-config_installing-ibm-z[Initial Operator configuration] section in the {ocp-short} documentation.