...
Next, you can access the hosted cluster by following the steps in xref:../hosted_control_planes/hosting_service_cluster_access.adoc#hosting-service-cluster-access[Accessing a hosted cluster].