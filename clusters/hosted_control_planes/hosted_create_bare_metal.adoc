...
* To import a hosted cluster, see xref:../hosted_control_planes/importing_hosted_cluster_aws.adoc##importing-hosted-cluster-aws[Importing a hosted control plane cluster].
