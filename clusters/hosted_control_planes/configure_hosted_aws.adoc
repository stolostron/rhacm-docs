...
* xref:../hosted_control_planes/configure_hosted_disconnected_aws.adoc#configure-hosted-disconnected-aws[Configuring hosted control planes on AWS in a disconnected environment]
