...
* You must have enabled the `hypershift` feature. In the {ocp-short} console, the download for the `hcp` command line interface is visible only if you enabled that feature.
