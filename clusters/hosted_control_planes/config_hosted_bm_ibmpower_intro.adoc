[#configuring-hosting-service-cluster-configure-ibmpower]
...
//asking IBM doc to reduce this title for conciseness 
...
//IBM doc to reduce title here: Creating an InfraEnv resource for hosted control planes on 64-bit x86 bare metal for IBM Power compute nodes