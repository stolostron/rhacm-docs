...
To enable private hosted clusters for AWS, you must first enable AWS PrivateLink. For more information, see xref:../../clusters/hosted_control_planes/config_hosted_aws.adoc#hosted-enable-private-link[Enabling AWS PrivateLink].
...
For more information about deploying a public hosted cluster on AWS, see xref:../hosted_control_planes/manage_hosted_aws.adoc#hosted-deploy-cluster-aws[Deploying a hosted cluster on AWS].
