...
The NodePool object is created when creating a hosted cluster. By scaling the NodePool object, you can add more compute nodes to the Hosted Control Plane.
