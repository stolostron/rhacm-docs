...
* <<azure_cred,Deleting your credential>>
...
You can create a cluster that uses this credential by completing the steps in xref:../clusters/create_azure.adoc#creating-a-cluster-on-microsoft-azure[Creating a cluster on Microsoft Azure].
