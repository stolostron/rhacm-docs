...
* Upgrade {product-title-short} version 2.3 to {product-title-short} 2.4 with Assisted Installer static IP addressing: Use the Assisted Installer to upgrade your remote clusters to {product-title-short} version 2.4.
