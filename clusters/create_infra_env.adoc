...
+
Replace `iso_url` with the ISO url, for example, `https://mirror.openshift.com/pub/openshift-v4/dependencies/rhcos/4.10/4.9.0/rhcos-4.10.0-x86_64-live.x86_64.iso`.
+
Replace `root_fs_url` with the root FS image URL, for example, `https://mirror.openshift.com/pub/openshift-v4/dependencies/rhcos/4.10/4.10.0/rhcos-live-rootfs.x86_64.img`. 
