...
If you are running your hub on Amazon Web Services and want to enable the CIM service, complete the following additional steps after  <<enable-cim,Enabling CIM>>:
...
----
+
*Tip:* The default namespace is where you installed the multicluster engine.
