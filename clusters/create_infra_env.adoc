...
Creating the Provisioning CR enables the hub cluster components that support automated provisioning (the `BaremetalHost` resource). Manually create a `Provisioning` CR enable services for automated provisioning. 
