...
* xref:../clusters/supported_providers.adoc#supported-clouds[Supported clouds]
* xref:../clusters/scale.adoc#resizing-a-cluster[Scaling a managed cluster]
//tech preview since 2.4 but not in the TOC, where is the other scale stuff?/Create this and replace
