...
//Chris, please work with PM to revisist this fro accuracy. This is the only file in what was the RHACM cluster book. 
...
To continue adding and managing clusters, see the link:../cluster_lifecycle/#cluster_overview[The multicluster engine operator cluster lifecycle overview].