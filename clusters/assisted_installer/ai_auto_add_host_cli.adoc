...
- To learn about root device hints, see link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.20/html/postinstallation_configuration/post-install-configuration-overview[Postinstallation configuration overview] in the {ocp-short} documentation.

- To learn more about BMC format addressing, see link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.20/html-single/installing_on_bare_metal/index[BMC addressing] in the {ocp-short} documentation.
