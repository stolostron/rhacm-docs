...
If you are using {mce-short}, you can use {cim} features, such as deploying managed clusters. If you need additional features, such as {sco} or policy-based governance, you need {acm}.
