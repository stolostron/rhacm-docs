...
If you are using standalone {mce-short}, you can use {cim} features, such as deploying managed clusters. If you need additional features, such as {sco} or policy-based governance, you need to link:../../get_started_acm/preparing_acm_install.adoc#prepare-install-acm[install {acm}], which automatically installs the {mce-short}.
