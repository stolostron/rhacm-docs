...
When you install a {ocp-short} cluster version 4.15 and earlier that is in FIPS mode, you must specify that the installers run Red Hat Enterprise Linux (RHEL) version 8 in the `AgentServiceConfig` resource. When you install a {ocp-short} cluster version 4.16 and later that is in FIPS mode, you must not specify any RHEL version for the installers.
...
Complete the following steps to update the `AgentServiceConfig` resource if you install a {ocp-short} cluster version 4.15 and earlier:
...
Complete the following steps to update the `AgentServiceConfig` resource if you install a {ocp-short} cluster version 4.16 and later:
