...
When you install a {ocp-short} cluster that is version 4.15 and earlier and is in FIPS mode, you must specify that the installers run Red Hat Enterprise Linux version 8 in the `AgentServiceConfig` resource. When you install a {ocp-short} clusterthat is version 4.16 and later and is in FIPS mode, do not specify any Red Hat Enterprise Linux version for the installers.
