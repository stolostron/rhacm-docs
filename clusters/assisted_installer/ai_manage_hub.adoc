...
Importing and managing a hub cluster by using {cim} can simplify your cluster management by providing a single point of control. You can also configure additional options, such as the hub cluster Kube API server verification strategy.
