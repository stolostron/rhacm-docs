...
- To learn more about scaling compute machines, see link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.20/html-single/machine_management/index#manually-scaling-machineset[Manually scaling a compute machine set] in the {ocp-short} documentation.
