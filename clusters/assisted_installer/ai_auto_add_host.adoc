...
- To learn about root device hints, see link:https://docs.redhat.com/documentation/en-us/openshift_container_platform/4.17/html/postinstallation_configuration/post-install-bare-metal-configuration#post-install-bare-metal-configuration[Bare metal configuration] in the {ocp-short} documentation.
