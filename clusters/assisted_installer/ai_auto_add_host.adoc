...
See the link:https://docs.openshift.com/container-platform/4.17/nodes/nodes/nodes-nodes-working.html#deleting-nodes[Deleting nodes] instructions in the {ocp-short} documentation.
...
- To learn more about scaling compute machines, see link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.17/html-single/machine_management/index#manually-scaling-machineset[Manually scaling a compute machine set] in the {ocp-short} documentation.
