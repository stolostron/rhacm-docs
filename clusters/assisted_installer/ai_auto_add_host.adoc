...
* If you set the annotation and use a string value that follows `<cluster-namespace>/<cluster-name>`, the host binds to the cluster that your `ClusterDeployment` custom resource represents.
