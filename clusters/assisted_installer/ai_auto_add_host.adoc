...
- To learn more about BMC format addressing, see link:https://docs.openshift.com/container-platform/4.16/installing/installing_bare_metal_ipi/ipi-install-installation-workflow.html#bmc-addressing_ipi-install-installation-workflow[BMC addressing] in the {ocp-short} documentation.
