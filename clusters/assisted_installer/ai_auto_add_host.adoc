...
See the link:https://docs.openshift.com/container-platform/4.16/nodes/nodes/nodes-nodes-working.html#deleting-nodes[Deleting nodes] instructions in the {ocp-short} documentation.
