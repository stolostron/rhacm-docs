...
The bare metal host annotation controls the connection to your {ocp-short} cluster, and determines if the host is bound or unbound to a specific cluster.
 
You can use the `{}bmac.agent-install.openshift.io/cluster-reference` in one of the following 3 ways:
