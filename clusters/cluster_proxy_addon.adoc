...
. Enable the cluster proxy add-on on {product-title} hub cluster. See xref:../install/adv_config_install.adoc#clusterproxyaddon-technology-preview[Advanced configuration] to learn more.
