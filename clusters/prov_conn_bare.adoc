...
* <<bare_prov_conn_prerequisites,Prerequisites>>
* <<bare_provider_conn,Creating a provider connection by using the console>>
* <<bare_delete_provider_conn,Deleting your provider connection>>
...
You can create a cluster that uses this provider connection by completing the steps in xref:../clusters/create_bare.adoc#creating-a-cluster-on-bare-metal[Creating a cluster on bare metal].
