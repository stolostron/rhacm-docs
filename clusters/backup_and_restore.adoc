...
- Use the created secret when you create a `DataProtectionApplication` resource. Your `DataProtectionApplication` resource might resemble the following YAML file:
