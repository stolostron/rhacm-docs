...
You must install the 0.4.2 version of the OADP Operator from _beta_ channel. See link:https://github.com/openshift/oadp-operator/blob/master/docs/install_olm.md[Install OADP Operator using OperatorHub]. 
