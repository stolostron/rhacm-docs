...
Be sure to complete the steps to link:https://github.com/openshift/oadp-operator/blob/oadp-0.4.2/docs/install_olm.md#create-credentials-secret[Create credentials secret] for the cloud storage where the backups are saved. 

Use the created secret when you link:https://github.com/openshift/oadp-operator/blob/oadp-0.4.2/docs/install_olm.md#create-the-velero-custom-resource[Create the Velero Custom Resource].
