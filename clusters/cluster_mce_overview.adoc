...
//this is broken, not sure why bc i updated the conref. After we published, that was my first time noticing the conref. i think we should use the absolute URL instead of conref
//https://access.redhat.com/articles/7073030
...
//we might need to add an extra directory app ../ or change to link: I encourage us to change this to link:
//apis and troubleshooting-mce| MJ|07/23
