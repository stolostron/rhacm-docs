...
. Create a namespace role binding to the cluster role `admin`. This role has read and write access to the resources in the namespace of the managed cluster. Run the following command:
...
. Create a cluster role binding for the `open-cluster-management:view:<cluster-name>` cluster role to view a managed cluster named `cluster-name`. This role has read access to the cluster-scoped `managedcluster` resource. This is needed because the `managedcluster` is a cluster-scoped resource. Run the following command:
...
. View a list of the managed clusters that you can access. This command is used by administrators and users without cluster administrator privileges. Run the following command:
...
. View a list of the managed cluster sets that you can access. This command is used by administrators and users without cluster administrator privileges. Run the following command:
