...
*Note:* With the plug-ins enabled, you can access {acm-short} within the {ocp-short} console from the cluster switcher by selecting *Fleet Management* from the drop-down menu. For previous versions, the *All Clusters* perspective is available.
