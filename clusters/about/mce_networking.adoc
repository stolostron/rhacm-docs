...
| TCP
| 6180, 6183, 6385
| Communication between the Ironic Python Agent and the Ironic service on the hub cluster. The Baseboard Management Controller (BMC) accesses port 6180 and 6183 for virtual media.
