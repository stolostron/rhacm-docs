...
See https://access.redhat.com/articles/6978985[The multicluster engine for Kubernetes operator 2.2 support matrix] for support information, as well as the following documentation:
