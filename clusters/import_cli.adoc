...
To use automatic importing, you must create a secret that contains either a reference to the `kubeconfig` file  of the managed cluster, or server and token pair of the cluster to import. 
...
+
Alternatively, you can create your secret manually. Use this method if you are using a server and token. Complete the following steps:
+
