...
The images are referenced by the files in the https://github.com/stolostron/acm-hive-openshift-releases/tree/release-2.3[acm-hive-openshift-releases GitHub repository] for version 2.3.
