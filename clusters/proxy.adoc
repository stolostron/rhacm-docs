...
*Important:* Global proxy settings do not impact alert forwarding. To set up alert forwarding for {product-title-short} hub clusters with a cluser-wide proxy, see link:../observability/customize-observability.adoc#forward-alerts[Forwarding alerts] for more details.