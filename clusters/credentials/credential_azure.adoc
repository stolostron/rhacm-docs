...
- See link:https://docs.openshift.com/container-platform/{ocp-version}/installing/installing_azure/installing-azure-account.html[Configuring an Azure account].
...
- See link:https://docs.openshift.com/container-platform/{ocp-version}/installing/installing_azure/installing-azure-default.html#ssh-agent-using_installing-azure-default[Generating an SSH private key and adding it to the agent] for more information about how to generate a key.
