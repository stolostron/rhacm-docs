...
- See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.15/html/installing/installing-on-azure#installing-azure-account[Configuring an Azure account].
...
- See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.15/html/installing/installing-on-azure#ssh-agent-using_installing-azure-default[Generating a key pair for cluster node SSH access] for more information about how to generate a key.
