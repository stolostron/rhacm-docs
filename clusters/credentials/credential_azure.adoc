...
- See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.15/html/installing_on_azure/installing-azure-account[Configuring an Azure account].
