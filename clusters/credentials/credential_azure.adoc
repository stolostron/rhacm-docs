...
- See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.17/html/installing_on_azure/installing-azure-account[Configuring an Azure account].
...
- See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.17/html/installing_on_azure/installing-azure-default#ssh-agent-using_installing-azure-default[Generating a key pair for cluster node SSH access] for more information about how to generate a key.
