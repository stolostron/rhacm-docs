...
- See link:https://docs.openshift.com/container-platform/{ocp-version}/installing/installing_gcp/installing-gcp-account.html[Configuring a GCP project].
...
- See link:https://docs.openshift.com/container-platform/{ocp-version}/installing/installing_gcp/installing-gcp-default.html#ssh-agent-using_installing-gcp-default[Generating an SSH private key and adding it to the agent] for more information about how to generate a key.
