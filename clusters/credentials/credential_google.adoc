...
- See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.15/html/installing/installing-on-gcp#installing-gcp-account[Configuring a GCP project].
