...
- See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.14/html/installing/installing-on-gcp#installing-gcp-account[Configuring a GCP project].
