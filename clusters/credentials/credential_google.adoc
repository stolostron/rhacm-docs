...
- See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.17/html/installing_on_google_cloud/installing-gcp-account[Configuring a Google Cloud project].
