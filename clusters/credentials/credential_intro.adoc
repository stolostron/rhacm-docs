...
* xref:../credentials/credential_aws_ui.adoc#creating-a-credential-for-amazon-web-services[Creating a credential for Amazon Web Services in the console]
* xref:../credentials/credential_aws_api.adoc#creating-a-credential-for-amazon-web-services[Creating a credential for Amazon Web Services with the API]
* xref:../credentials/credential_azure_ui.adoc#creating-a-credential-for-microsoft-azure[Creating a credential for Microsoft Azure in the console]
* xref:../credentials/credential_azure_api.adoc#creating-a-credential-for-microsoft-azure[Creating a credential for Microsoft Azure with the API]
