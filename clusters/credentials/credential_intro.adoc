...
* xref:../credentials/credential_google.adoc#creating-gcp-credential-ui[Creating a credential for Google Cloud Platform in the console]
* xref:../credentials/credential_google.adoc#creating-gcp-credential-api[Creating a credential for Google Cloud Platform with the API]
