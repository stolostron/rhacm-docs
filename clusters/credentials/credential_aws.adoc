...
- See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.14/html/installing/installing-on-aws#installing-aws-account[Configuring an AWS account].
...
- See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.14/html/installing/installing-on-aws#ssh-agent-using_installing-aws-localzone[Generating a key pair for cluster node SSH access] for more information about how to generate a key.
