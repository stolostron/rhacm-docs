...
[source,bash]
----
oc label secret hypershift-operator-oidc-provider-s3-credentials -n <your-local-cluster> "cluster.open-cluster-management.io/type=awss3"
oc label secret hypershift-operator-oidc-provider-s3-credentials -n <your-local-cluster> "cluster.open-cluster-management.io/credentials=credentials="
----
...
- See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html/installing_on_aws/index[Installing on AWS].
...
- See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html-single/installing_on_aws/index#installation-config-parameters-aws[Installation configuration parameters for AWS] for more information about how to generate a key.
