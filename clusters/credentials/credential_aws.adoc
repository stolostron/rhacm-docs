...
- See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/installing_on_aws/index[Installing on AWS].
...
- See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html-single/installing_on_aws/index#installation-config-parameters-aws[Installation configuration parameters for AWS] for more information about how to generate a key.
