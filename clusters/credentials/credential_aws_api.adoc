...
[role="_abstract"]
You need a credential to use {mce-short} console to deploy and manage an {ocp} cluster on Amazon Web Services (AWS). The credential is a prerequisite for creating a cluster with {mce-short}.
