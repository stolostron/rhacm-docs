...
//see GitHub issue #23648 about inaccuracy and possible removal, this topic and the issue is very confusing.
...
See https://docs.openshift.com/container-platform/4.9/openshift_images/managing_images/using-image-pull-secrets.html[Using image pull secrets].
