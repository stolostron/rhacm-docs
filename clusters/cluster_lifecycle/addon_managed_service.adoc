...
. Enable the `ManagedServiceAccount` add-on on hub cluster. See _ManagedServiceAccount add-on_ in xref:../install_upgrade/adv_config_install.adoc#advanced-config-mce[Advanced configuration {mce-short}] to learn more.
