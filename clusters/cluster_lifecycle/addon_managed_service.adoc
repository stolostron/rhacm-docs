...
. Enable the `ManagedServiceAccount` add-on on hub cluster. See *ManagedServiceAccount add-on* in xref:../get_started/adv_config_install.adoc#advanced-config-engine[Advanced configuration] to learn more.
