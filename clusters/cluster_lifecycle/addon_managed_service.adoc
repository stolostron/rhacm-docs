...
. Enable the `ManagedServiceAccount` add-on on hub cluster. See link:../clusters/install_upgrade/adv_config_mce.adoc#advanced-config-mce[Advanced configuration {mce-short}] to learn more.
