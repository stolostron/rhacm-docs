...
* You need your {ocp-short} image pull secret. See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.19/html/images/managing-images#using-image-pull-secrets[Using image pull secrets].
