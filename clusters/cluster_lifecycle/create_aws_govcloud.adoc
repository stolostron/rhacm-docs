...
* You need an AWS credential. See xref:../credentials/credential_aws_ui.adoc#creating-credential-aws-ui[Creating a credential for Amazon Web Services in the console] for more information.
