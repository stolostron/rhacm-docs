...
`quay.io/openshift-release-dev/ocp-release:{ocp-latest}.1-x86_64`
...
{ocp-short} {ocp-latest} and later supports multiple architectures by default. You can use the following `clusterImageSet` to provision a cluster. Replace `4.x.0` with the current version:
