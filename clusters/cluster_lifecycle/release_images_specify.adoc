...
When you create a cluster on a provider by using {mce}, you must specify a release image to use for the new cluster. See the following topics to learn how to specify a release image.
