...
* xref:../cluster_lifecycle/placement_filter.adoc#placement-labelselector-claimSelector[Filtering `ManagedClusters` from `ManagedCusterSets`]
* xref:../cluster_lifecycle/placement_decision.adoc#placement-decision[Checking selected `ManagedClusters` by using `PlacementDecisions`]
