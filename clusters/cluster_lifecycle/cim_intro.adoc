...
If no `AgentClusterInstall` is found, the infrastructure operator automatically creates a production environment custom resource for importing the hub cluster.
