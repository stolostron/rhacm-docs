...
You can create a host inventory (infrastructure environment) to discover physical or virtual machines that form your {ocp-short} clusters. Use the command line interface instead of the console for automated deployment or for the following advanced configuration options:
