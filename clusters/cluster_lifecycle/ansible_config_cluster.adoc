...
To save time, you can also run only the failed Ansible posthooks again that are part of cluster automation templates. Complete the following steps to run only the posthooks again, without retrying the entire upgrade:
