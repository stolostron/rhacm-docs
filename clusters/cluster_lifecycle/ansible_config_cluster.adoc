...
You might want to upgrade your {ocp-short} cluster to a specific newer version to test new features quickly.

*Note:* Upgrading to a newer {ocp-short} cluster version can reduce stability.

To upgrade to a newer to {ocp-short} cluster version, add the following annotation:
...
<3> Add the {ocp-short} cluster version that you want to upgrade to.
