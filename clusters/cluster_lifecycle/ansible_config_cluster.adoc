...
* <<upgrade-ocp-cluster-curator,Upgrading {ocp-short} clusters by using the _ClusterCurator_>>
...
[#upgrade-ocp-cluster-curator]
== Upgrading {ocp-short} clusters by using the _ClusterCurator_
