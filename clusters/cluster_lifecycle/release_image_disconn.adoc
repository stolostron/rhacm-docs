...
+
To learn more about the image tag and digest, see link:https://docs.redhat.com/documentation/en-us/openshift_container_platform/4.15/html/images/managing-images#images-referencing-images-imagestreams_tagging-images[Referencing images in imagestreams].
