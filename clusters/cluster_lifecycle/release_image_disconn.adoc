...
. While you are on a connected system, navigate to the link:https://github.com/stolostron/acm-hive-openshift-releases/tree/backplane-2.7[acm-hive-openshift-releases GitHub repository] to access the cluster image sets that are available.
