...
+
*Important:* If you are creating a hosted cluster for {ocp-virt}, the `spec.releaseImage` name must end with `-release` to make the {ocp-short} version appear in the *Release images* drop-down list in the console.
