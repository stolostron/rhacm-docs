...
After installing {mce-short}, the following are automatically created on the hub cluster to ease management. Managed clusters that you create belong to the `global` `ManagedClusterSet` by default:
