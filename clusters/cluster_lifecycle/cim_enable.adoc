...
. If you want to use HTTPS `osImages`, make sure that you have a CA certificate that you can add to the `image-service-additional-ca` `ConfigMap`. You can run the following command to create a certificate:
+
----
