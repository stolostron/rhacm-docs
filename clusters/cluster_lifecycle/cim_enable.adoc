...
- You need a storage class configured as `default`.
...
Run the following command to modify the `Provisioning` resource to allow the Bare Metal Operator to watch all namespaces:
