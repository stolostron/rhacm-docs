...
*Note:* After deploying your cluster, any new changes you make to `install-config` YAML do not apply. To update the configuration after deployment, you must policies. See link:../governance/pod_policy.adoc#pod-policy[Pod policy] for more information.
