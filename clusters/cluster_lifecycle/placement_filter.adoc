...
You can select which `ManagedClusters` to filter by using `labelSelector`, `claimSelector`, or `celSelector`. See the following examples to learn how to the filters:
