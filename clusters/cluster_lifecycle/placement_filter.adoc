...
- The following example shows five different ways of how you can use the `celSelector` field with Common Expression Language. You can use one or several expressions to filter your `ManagedCluster` objects:
