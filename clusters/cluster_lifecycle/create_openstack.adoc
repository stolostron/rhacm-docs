...
* You must have a Red Hat OpenStack Platform credential. See xref:../credentials/credential_openstack_ui.adoc#creating-a-credential-for-openstack[Creating a credential for Red Hat OpenStack Platform in the console] for more information.
