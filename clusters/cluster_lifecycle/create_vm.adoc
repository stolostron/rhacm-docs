...
* You must have a hub cluster that is deployed on {ocp-short} version 4.13 or later.
...
* You need an {ocp-short} image pull secret. See link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.13/html/images/managing-images#using-image-pull-secrets[Using image pull secrets].
...
*Note:* Release images for {ocp-short} versions 4.13 and later are supported.
