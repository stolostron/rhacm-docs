...
- See link:https://docs.redhat.com/documentation/en-us/openshift_container_platform/4.15/html/images/managing-images#using-image-pull-secrets[Using image pull secrets]
