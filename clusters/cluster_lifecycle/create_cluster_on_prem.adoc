...
spec:
  releaseImage: quay.io/openshift-release-dev/ocp-release:4.16.0-rc.0-x86_64
----
...
- See link:https://docs.redhat.com/documentation/en-us/openshift_container_platform/4.16/html/images/managing-images#using-image-pull-secrets[Using image pull secrets]
