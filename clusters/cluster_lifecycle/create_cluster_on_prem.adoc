...
<4> Possible values are `1` and `3`. If you are using {ocp-short} version 4.18 or newer, your platform is bare metal, and your CPU architecture is `x86_64`, you can also use `4` and `5`.
