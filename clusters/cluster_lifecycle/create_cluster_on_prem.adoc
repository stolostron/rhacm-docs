...
* You must create a base domain name that meets the following requirements:
** There is no wildcard, such as `*.<cluster_name>.<base_domain>`, or the installation does not continue.
