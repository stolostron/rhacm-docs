...
<2> Leave empty to disable the Cloud Controller Manager during installation. If set to `External`, you must add custom manifests to enable the Cloud Controller Manager.
