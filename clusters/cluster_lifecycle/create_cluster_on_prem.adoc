...
- For additional information about zero touch provisioning, see https://access.redhat.com/documentation/en-us/openshift_container_platform/4.12/html/scalability_and_performance/ztp-deploying-disconnected[Clusters at the network far edge] in the {ocp-short} documentation.

- See https://access.redhat.com/documentation/en-us/openshift_container_platform/4.12/html/images/managing-images#using-image-pull-secrets[Using image pull secrets].
