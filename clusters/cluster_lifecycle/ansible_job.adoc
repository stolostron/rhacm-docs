...
. Create or import your cluster by following the instructions in xref:../cluster_lifecycle/create_intro.adoc#create_intro[Cluster creation introduction] or xref:../cluster_lifecycle/import_intro.adoc#import-intro[Cluster import introduction], respectively.
+
