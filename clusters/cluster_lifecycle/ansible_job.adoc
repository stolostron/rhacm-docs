...
. Create or import your cluster by following the instructions in xref:../cluster_lifecycle/create_intro.adoc#creating-a-cluster[Creating a cluster] or xref:../cluster_lifecycle/import_intro.adoc#import-intro[Cluster import introduction], respectively.
+
