...
* For more information about the hosted control plane command line interface, `hcp`, see link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.19/html/hosted_control_planes/preparing-to-deploy-hosted-control-planes#installing-the-hosted-control-plane-command-line-interface[Installing the hosted control planes command-line interface]. 

* For more information about hosted clusters, including supported versions, see link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.19/html/hosted_control_planes/hosted-control-planes-overview#hosted-control-planes-overview_hcp-overview[Introduction to hosted control planes]. 
