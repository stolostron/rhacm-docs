...
* You need an Azure credential. See xref:../credentials/credential_azure_ui.adoc#creating-credential-azure-ui[Creating a credential for Microsoft Azure in the console] for more information.
