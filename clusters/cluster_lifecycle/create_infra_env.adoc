...
= Creating an infrastructure environment
//iniline links need to be reduced in this file, need to add Additional resources section| MJ | 07/27/23
...
//noticed the hyphen for zero touch is not used in OCP docs does not use the hyphen.
