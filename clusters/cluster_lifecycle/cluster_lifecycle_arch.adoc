...
To continue adding and managing clusters, see the xref:../clusters/cluster_lifecycle/cluster_lifecycle_intro.adoc#cluster-overview[The {mce-short} cluster lifecycle overview].
