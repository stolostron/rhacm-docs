...
If you are using {cim}, you can customize your {ocp-short} clusters by adding additional production environment nodes.

*Required access:* Administrator

* <<add-nodes-cim-ocp-prereqs,Prerequisites>>
...
. If the agent registration is successful, an agent is listed. Approve the agent for installation. This can take a few minutes.
