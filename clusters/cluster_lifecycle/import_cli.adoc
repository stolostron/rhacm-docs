...
Implement the `KlusterletAddonConfig` klusterlet add-on to enable other add-ons on your managed clusters. Create and apply the configuration file by completing the following steps:
