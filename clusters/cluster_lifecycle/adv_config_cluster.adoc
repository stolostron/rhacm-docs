...
//these two examples need some kind of header or intro because a nonsighted user does not have any idea what is coming after the colon. Example one displays... Example two displays.
...
//can we check on this and remove comment?
