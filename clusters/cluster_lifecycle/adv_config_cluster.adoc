...
The default automatic import strategy is `ImportOnly`. To change the import strategy, use a `ConfigMap` named `import-controller-config` in the {mce-short} install namespace. Complete the following steps:
