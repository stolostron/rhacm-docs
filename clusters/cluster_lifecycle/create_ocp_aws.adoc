...
* You need a configured domain in AWS. See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html/installing_on_aws/index[Installing on AWS] for instructions on how to configure a domain.
...
* See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html/installing_on_aws/index[Installing on AWS] for more information.
