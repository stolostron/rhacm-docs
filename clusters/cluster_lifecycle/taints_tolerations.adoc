...
* To learn how to use `oc patch`, see link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/cli_tools/openshift-cli-oc#oc-observe[oc patch] the {ocp-short} documentation
