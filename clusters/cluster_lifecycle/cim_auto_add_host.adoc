...
- To learn about root device hints, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.12/html/post-installation_configuration/post-install-bare-metal-configuration#the-baremetalhost-spec[The BareMetalHost spec] in the {ocp-short} documentation.
