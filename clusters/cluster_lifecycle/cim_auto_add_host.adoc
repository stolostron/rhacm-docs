...
. Create a Baseboard Management Controller (BMC) secret by applying the following YAML content and replacing values where needed:
+
[source,YAML]
----
apiVersion: v1
