...
- Before you create a cluster, you must clone the link:https://github.com/stolostron/acm-hive-openshift-releases/tree/backplane-2.7/clusterImageSets/fast[clusterImageSets] repository and apply it to your hub cluster. Complete the following steps:

+
. Run the following command to clone, but replace `2.x` with with your version of {mce-short}:
...
- Select the {ocp-short} release images when you create a cluster.
+
