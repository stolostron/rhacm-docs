...
- Before creating a cluster, you must clone the link:https://github.com/stolostron/acm-hive-openshift-releases/tree/backplane-2.8/clusterImageSets/fast[clusterImageSets] repository and apply it to your hub cluster. Complete the following steps:
