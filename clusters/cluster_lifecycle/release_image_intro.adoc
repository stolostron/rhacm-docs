...
The release image specifies the version of {ocp} to use for building the cluster. By default, {ocp-short} uses the `clusterImageSets` resources to get the list of supported release images.
