...
*Important:* The `cluster-proxy-addon` does not work when another proxy configuration is on your hub cluster or managed clusters. The following scenarios causes this:
