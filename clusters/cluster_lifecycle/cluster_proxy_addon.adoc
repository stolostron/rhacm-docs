...
*Important:* The `cluster-proxy-addon` does not work when a hub cluster or managed cluster has a link:https://docs.openshift.com/container-platform/4.13/networking/enable-cluster-wide-proxy.html[cluster-wide-proxy] configuration.
