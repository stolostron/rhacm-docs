...
See link:../cluster_lifecycle/import_agent.adoc#importing-managed-cluster-agent[Importing a managed cluster by using the agent registration endpoint] to learn more.
