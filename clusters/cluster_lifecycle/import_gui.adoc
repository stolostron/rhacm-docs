...
.. Log in to the {ocp-short} console that you want to import.
...
.. Make sure that your `kubectl` command line is available on the cluster that you want to import by entering the following command:
+
----
