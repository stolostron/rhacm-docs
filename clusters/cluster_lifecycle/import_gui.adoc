...
- See xref:../install_upgrade/adv_config_install.adoc#advanced-config-hub[_MultiClusterHub_ advanced configuration] for more information about how to define a custom image pull secret.
[]
