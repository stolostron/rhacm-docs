...
. Add the `agent.open-cluster-management.io/klusterlet-config: `<klusterletconfig_name>` annotation to the managed cluster, replacing `<klusterletconfig_name>` with the name of your `KlusterletConfig`
