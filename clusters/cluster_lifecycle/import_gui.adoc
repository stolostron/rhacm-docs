...
.. Complete the information in the form, leaving the *Import mode* selection set to `Run import commands manually`. After you click *Generate command*, the cluster overview page is displayed. Click *Copy command* to copy the generated command to the clipboard.
