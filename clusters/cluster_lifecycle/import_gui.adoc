...
After you install {mce-short}, you are ready to import a cluster to manage. You can import from either the console or the CLI.
...
* **Note:** If you are importing a cluster that was not created by {ocp-short}, you need a `multiclusterhub.spec.imagePullSecret` defined. This secret might have been created when {mce-short} was installed. 
+
