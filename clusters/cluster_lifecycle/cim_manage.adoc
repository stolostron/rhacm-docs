...
You can manage your host inventory and edit existing hosts by using the console, or by using the command line interface to edit the `Agent` resource. See the following topcis to learn more:
