...
You need a credential to use {product-title} console to deploy and manage a {ocp} cluster on Red Hat OpenStack Platform. Only {ocp-short} versions 4.5.x, and later, are supported.
