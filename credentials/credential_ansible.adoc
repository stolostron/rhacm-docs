...
Starting with {product-title-short} version 2.3, the information that you provide when you update your Ansible secret in the Ansible credential is automatically updated in your managed clusters that use that credential. The update applies to all managed clusters that use the credential for cluster lifecycle, governance, and application management automations.
