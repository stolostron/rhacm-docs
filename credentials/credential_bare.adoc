...
. Configure networking if you are using an optional provisioning network:
+
* _IPv4 address_
+
----
...
+
The IPv4 address can be any address as long as it is not routable using the bare metal network.
+
* _IPv6 address_
+
----
