...
* xref:../credentials/credential_infra_env.adoc#creating-a-credential-for-an-infrastructure-environment[Creating a credential for an infrastructure environment]