...
//confused about "directly or through" Rephrased it, "manually" and "directly" were near the wrong nouns to modify

The following is a high-level overview of the process:
//-a list of steps but no procedure or link is odd to me - rephrased to avoid imperatives
