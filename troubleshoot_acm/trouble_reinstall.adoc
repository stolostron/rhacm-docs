...
----
Replace <namespace> in the script with the namespace with the name of the namespace where Red Hat Advanced Cluster Manager was installed. Ensure that you specify the correct namespace, as the namespace is cleaned out and deleted. 
