...
* xref:../add-ons/modify_endpoint.adoc#modify-klusterlet-add-ons[Modifying the klusterlet add-ons settings of your cluster]
* xref:../add-ons/resource_requests.adoc#add-ons-resource-requests[Resource requests for managed cluster add-ons]
