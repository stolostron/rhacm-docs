...
The `ClusterAdmin` role can enable Globalnet for a cluster set by selecting the option to *Enable Globalnet* in the console when enabling the Submariner add-on to clusters in the cluster set.  
