...
//This is a dangling modifier. The table doesn't go to describe something after the understood "you" adds a utility. The subject doesn't agree here, so it is a dangling modifier. Keep the action on the subject after you insert the comma to avoid these. --bcs
