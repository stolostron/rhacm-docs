...
See the link:https://access.redhat.com/articles/6968787[{product-title-short} Support Matrix] for more details about which infrastructure providers are supported by xref:../submariner/deploy_subm_console.adoc#deploying-submariner-console[automated console deployments] and which infrastructure providers require xref:../submariner/deploy_subm_manually.adoc#deploying-submariner-manually[manual deployment].
...
* xref:../submariner/deploy_subm_console.adoc#deplying-submariner-console[Deploying Submariner by using the console]
* xref:../submariner/deploy_subm_manually.adoc#deplying-submariner-manually[[Deploying Submariner manually]
