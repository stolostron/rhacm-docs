...
See the link:https://access.redhat.com/articles/6968787[{product-title-short} Support Matrix] for more details about which infrastructure providers are supported by xref:../submariner/submariner_deploy_console.adoc#deploying-submariner-console[automated console deployments] and which infrastructure providers require xref:../submariner/submariner_deploy_manual.adoc#deploying-submariner-manually[manual deployment].
...
* xref:../submariner/subm_subctl.adoc#installing-subctl-command-utility[Installing the subctl command utility]
