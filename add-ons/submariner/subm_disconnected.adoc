...
Make sure to mirror the `Submariner Operator bundle` images in the local registry before deploying Submariner on disconnected clusters.

*Note:* If you are using {product-title-short} 2.7.2 or older, you must also mirror the `nettest-rhel8` images.
