...
If your cluster does not support automatic deployment, see the following topics to prepare your selected hosting environment manually for deployment on Submariner. Each host has unique steps for preparation, so make sure to select the correct host.
