...
*Important:* VolSync only supports replicatin persistent volume claims with the volume mode of Filesystem. If you do not select the volume mode, it defaults to Filesystem.
