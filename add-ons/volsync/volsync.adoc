...
*Important:* VolSync only supports replicating persistent volume claims with the volume mode of Filesystem. If you do not select the volume mode, it defaults to Filesystem.
