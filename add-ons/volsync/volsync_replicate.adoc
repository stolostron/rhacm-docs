...
*Optional:* If you want to create your own secret, complete the following steps:
...
.. Run the following command to copy the name of the secret and the contents of the secret that are provided as the value of `.status.rsyncTLS.keySecret`. If you created your own secret, make sure that the secret exists on both the source and destination clusters.
+
----
