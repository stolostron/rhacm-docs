...
+
Replace the value for `schedule` with how often to run the backup. This example has the schedule for every 30 minutes. 
+
...
[#additional-resources-restic]
=== Additional resources

* See xref:../volsync/volsync_schedule.adoc#volsync-schedule[Scheduling your synchronization] for more information about setting up your schedule. 
