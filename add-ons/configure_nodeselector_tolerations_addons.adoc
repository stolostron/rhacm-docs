...
.  Use the `AddonDeploymentConfig` API to create a configuration to specify the `nodeSelector` and `tolerations` on the namespace that you used for your {product-title-short} installation. 
