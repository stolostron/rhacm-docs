...
See the following image of the _Welcome page_ from the {product-title} console. The header displays the _Applications_ icon to return to {ocp-short}, access to the Visual Web Terminal, and more. The tiles describe the main functions of the product and link to important console pages.
