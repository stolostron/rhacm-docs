...
The _Welcome page_ from the {acm} console has a header that displays the _Applications_ switcher to return to {ocp} and more. The tiles describe the main functions of the product and link to important console pages.
...
* link:../console/console.adoc#console-overview[Console overview]
* link:https://kubernetes.io/docs/home/[Kubernetes documentation]
* xref:architecture.adoc#multicluster-architecture[Multicluster architecture]
* xref:glossary_terms.adoc#glossary-of-terms[Glossary of terms]
