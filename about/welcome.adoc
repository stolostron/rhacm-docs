...
The _Welcome page_ from the {acm} console has a header that displays the _Applications_ switcher to return to {ocp} and more. The tiles describe the main functions of the product and link to important console pages. For more information, see the link:../console/console_intro.adoc#web-console[Web console].
...
See the following documentation for more information about the product:
