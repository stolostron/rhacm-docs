...
Red Hat Advanced Cluster Management for Kubernetes provides end-to-end management visibility and control to manage your cluster and application lifecycle, along with security and compliance of your entire Kubernetes domain across data centers and hybrid cloud environments. Clusters and applications are all visible and managed from a single console, with built-in security policies. Deploy highly available and Container Storage Interface (CSI)-compliant applications that span clusters. Move the applications automatically across public and private domains based on policy control. Run your operations from anywhere that Red Hat OpenShift runs, and manage any Kubernetes cluster in your fleet.
