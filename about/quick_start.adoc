...
. You also need to ensure that your hub cluster is sized appropriately. See recommendations at link:../install/cluster_size.adoc#sizing-your-cluster[Sizing your cluster].
