...
If you experience problems, see the link:../troubleshooting/troubleshooting.adoc[Troubleshooting guide] to learn about the `mustgather` command and see documented troubleshooting tasks that might help resolve issues.
