...
Review the xref:../about/components.adoc#components[Components] topics to learn more about what is installed with Red Hat Advanced Cluster Management for Kubernetes.

After you learn about the hub cluster and managed cluster architecture, learn more about the link:../manage_cluster/supported_clouds.adoc#supported-clouds[Supported clouds], which lists the cloud provider cluster options.
...
After installation, review the link:../console/console.adoc[Web console] guide to learn how to access your console and what features are available in the console.
...
. Learn more about the resources and how to create and manage them at link:../manage_applications/manage_apps.adoc[Managing applications].
