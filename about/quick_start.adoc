...
After you learn about the hub cluster and managed cluster architecture, learn about the xref:../clusters/supported_clouds.adoc#supported-clouds[Supported clouds], which lists the cloud provider cluster options.
