...
After you learn about the hub cluster and managed cluster architecture, learn about the link:../clusters/supported_clouds.adoc#supported-clouds_supported_clouds[Supported clouds], which lists the cloud provider cluster options.
