...
After you learn about the hub cluster and managed cluster architecture, learn about the link:../clusters/supported_providers.adoc#supported-providers[Supported providers] in the _Clusters_ documentation, which lists the cloud provider cluster options.
...
. You also need to ensure that your hub cluster has the appropriate capacity. See recommendations at link:../install/cluster_size.adoc#sizing-your-cluster[Sizing your cluster].
To prepare your hub cluster, see link:../install/cluster_size.adocsizing-your-cluster[Sizing your cluster].
