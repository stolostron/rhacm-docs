...
. If you have a cluster that you want to import manually, you can view _link:../clusters_mce/cluster_lifecycle/import.adoc#importing-a-target-managed-cluster-to-the-hub-cluster[Importing a target managed cluster to the hub cluster] to learn how to import a managed cluster.
