...
After you learn about the hub cluster and managed cluster architecture, learn about the link:../clusters/supported_providers.adoc#supported-providers[Supported clouds] in the _Clusters_ documentation, which lists the cloud provider cluster options.
