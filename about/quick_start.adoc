...
The hub cluster is a {ocp} cluster version 4.6 or later, and can run on any https://docs.openshift.com/container-platform/4.7/architecture/architecture-installation.html[supported {ocp} infrastructure].
