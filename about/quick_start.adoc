...
After you learn about the hub cluster and managed cluster architecture, learn about the xref:../about/supported_providers.adoc#supported-providers[Supported providers] in the _Clusters_ documentation, which lists the cloud provider cluster options.
