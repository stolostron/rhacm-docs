...
After you learn about the hub cluster and managed cluster architecture, learn more about the xref:../manage_cluster/supported_clouds.adoc[Supported clouds], which lists the cloud provider cluster options.
...
To prepare your hub cluster, see xref:../install/prep.adoc[Preparing your hub cluster for installation].
. With a supported version of OpenShift Container Platform installed and running on your hub cluster, you can proceed with xref:../install/install_connected.adoc[Installing while connected online].

After installation, review the xref:../console/console.adoc[Web console] guide to learn how to access your console and what features are available in the console.
...
. If you have a cluster that you want to import manually, you can view xref:../manage_cluster/import.adoc[Importing a cluster] to learn how to import a managed cluster.
...
. Learn more about the resources and how to create and manage them at xref:../manage_applications/manage_apps.adoc[Managing applications].
