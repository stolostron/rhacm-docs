...
After you learn about the hub cluster and managed cluster architecture, learn more about the link:../manage_cluster/supported_clouds.md.adoc[Supported clouds], which lists the cloud provider cluster options.
...
To prepare your hub cluster, see link:../install/prep.md.adoc[Preparing your hub cluster for installation].
. With a supported version of OpenShift Container Platform installed and running on your hub cluster, you can proceed with link:../install/install_connected.md.adoc[Installing while connected online].

After installation, review the link:../console/console.md.adoc[Web console] guide to learn how to access your console and what features are available in the console.
...
. If you have a cluster that you want to import manually, you can view link:../manage_cluster/import.md.adoc[Importing a cluster] to learn how to import a managed cluster.
...
. Learn more about the resources and how to create and manage them at link:../manage_applications/manage_apps.md.adoc[Managing applications].
