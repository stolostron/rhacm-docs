...
For more information, learn about access requirements from the link:../secure_cluster/rbac.adoc#role-based-access-control[Role-based access control] documentation.
