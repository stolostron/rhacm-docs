...
For more information, learn about access requirements from the link:../securing_cluster/rbac.adoc#role-based-access-control[Role-based access control] documentation.
