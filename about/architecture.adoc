...
For more information about governance, see the link:../governance/security_intro.adoc#security[Governance] introduction. Additionally, learn about access requirements from the link:../access_control/rbac.adoc#role-based-access-control[Role-based access control] documentation.
