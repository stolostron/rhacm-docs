...
See link:../manage_cluster#managing-your-clusters-with-red-hat-advanced-cluster-management-for-kubernetes[Managing your clusters] to learn about managing clusters, which is part of _Cluster lifecycle_.
...
See the product link:../install[Installing] section to prepare your cluster and get configuration information.
See the link:../about[Components] topic to learn more about what is installed with the product.
