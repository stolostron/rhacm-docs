...
From the hub cluster, you can use the console to search resources across clusters, and run commands with the Visual Web Terminal. Additionally, you can enable _observability_ to monitor metrics from your managed clusters and cloud providers.
