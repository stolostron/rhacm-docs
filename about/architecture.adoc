...
For more information about Observability, see link:../observing_environmnets/observe_environments_intro.adoc#observing-environments-intro[Observing environments introduction].
