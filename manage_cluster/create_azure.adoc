...
See xref:prov_conn_azure.adoc[Creating a provider connection for Microsoft Azure] for more information.
...
If you do not have one configured, or want to configure a new one, select *Add connection* . See xref:prov_conn_azure.adoc[Creating a provider connection for Microsoft Azure] for more information about creating a provider connection.
