...
. Complete the prerequisites that are listed in the xref:../manage_cluster/submariner.adoc#preparing-aws[Preparing Amazon Web Services to deploy Submariner].
...
. Complete the prerequisites in xref:../manage_cluster/submariner.adoc#preparing-gcp[Preparing Google Cloud Platform to deploy Submariner].
