...
. Select the _Option_ menu for the cluster that you want to remove from management.
...
. Continue with xref:../manage_cluster/remove_managed_cluster.adoc#removing-a-cluster-from-management-in-special-cases[Remove remaining resources after removing a cluster].
