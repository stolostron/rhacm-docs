...
See xref:prov_conn_google.adoc[Creating a a provider connection for Google Cloud Platform] for more information.
...
If you do not have one configured, or want to configure a new one, select *Add connection*. See xref:prov_conn_google.adoc[Creating a provider connection for Google Cloud Platform] for more information about creating a provider connection.
