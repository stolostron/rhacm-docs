...
See link:prov_conn_aws.adoc[Creating a provider connection for Amazon Web Services] for more information.
...
If you have an existing cluster that you want to import, see link:import.adoc[Importing a target managed cluster to the hub cluster] for those steps.
...
If you do not have one configured, or want to configure a new one, select *Add connection*. See link:prov_conn_aws.adoc[Creating a provider connection for Amazon Web Services] for more information about creating a provider connection.
