...
You can create a cluster that uses this provider connection by completing the steps in xref:create_bare.md.adoc#creating-a-cluster-on-bare-metal[Creating a cluster on bare metal].
