...
see xref:prov_conn_bare.md.adoc#creating-a-provider-connection-for-bare-metal[Creating a provider connection for a bare metal environment] for more information
...
If you do not have one configured, or want to configure a new one, see xref:prov_conn_bare.md.adoc#creating-a-provider-connection-for-bare-metal[Creating a provider connection for a bare metal environment].
