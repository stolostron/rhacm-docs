...
+
*Note:* This value is used when creating the Image Content Source Policy in the `install-config.yaml` file that is similar to the following example: 
+
----
imageContentSources:
- mirrors:
  - xx2-77-777-777-77.us-west-1.compute.amazonaws.com:5000/ocp4
