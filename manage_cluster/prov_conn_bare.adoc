...
see https://access.redhat.com/documentation/en-us/openshift_container_platform/latest/html/installing_on_bare_metal/installing-on-bare-metal#ssh-agent-using_installing-bare-metal[Generating an SSH private key and adding it to the agent]
