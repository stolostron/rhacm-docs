...
* A temporary external KVM host that runs a bootstrap virtual machine, which is used to create a Hive cluster. See xref:../manage_cluster/prov_conn_bare.adoc#bare-set-up-provisioner[Preparing a provisioner host] for more information. 
