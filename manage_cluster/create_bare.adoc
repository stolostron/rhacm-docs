...
You can use the {product-title} console to create a Red Hat OpenShift Container Platform cluster in a bare metal environment.
...
When you remove a Red Hat OpenShift Container Platform cluster from management that was created with {product-title}, you can either _detach_ it or _destroy_ it.
