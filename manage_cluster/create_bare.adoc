...
see link:prov_conn_bare.adoc[Creating a provider connection for bare metal] for more information
...
If you do not have one configured, or want to configure a new one, select *Add provider*. See link:prov_conn_bare.adoc[Creating a provider connection for bare metal] for more information about creating a provider connection.
