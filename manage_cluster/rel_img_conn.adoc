...
. Add the `yaml` files for the images that you want available when you create a cluster by using the {product-title} console to the `./clusterImageSets/stable/` _or_ `./clusterImageSets/fast/` directory.
