...
{ocp} 4.3.18 or later, 4.4.4 or later, and 4.5.2 or later are supported for the hub cluster.
...
{ocp} 3.11.200 or later, 4.3.18 or later, 4.4.4 or later, and 4.5.2 or later are supported for the managed clusters.
