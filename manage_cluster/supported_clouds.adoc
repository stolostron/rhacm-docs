...
* See https://docs.microsoft.com/en-us/azure/openshift/[Azure on Red Hat OpenShift].
* See https://docs.openshift.com/dedicated/4/welcome/index.html[Red Hat OpenShift Dedicated]
* See https://docs.openstack.org/victoria/[Red Hat OpenShift OpenStack (version 16.1, or later)]
...
* See https://www.openshift.com/learn/partners/amazon-web-services[OpenShift on Amazon Web Services].
* See https://cloud.ibm.com/docs/openshift?topic=openshift-clusters[Red Hat OpenShift on IBM Cloud] (Kubernetes 1.17, and later).
...
* See https://docs.microsoft.com/en-us/azure/openshift/[Azure on Red Hat OpenShift].
* See https://docs.openshift.com/dedicated/4/welcome/index.html[Red Hat OpenShift Dedicated]
* See https://docs.openstack.org/victoria/[OpenStack (version 16.1, and later)]
* See https://cloud.ibm.com/docs/openshift?topic=openshift-openshift_versions [IBM Red Hat OpenShift Kubernetes Services 4.3.x (ROKS), and later]
