...
{ocp} 3.11.200 or later, 4.3.18 or later, 4.4.3 or later, 4.5.2 or later, 4.6.1 or later, and 4.7.0 or later, are supported for the managed clusters.
...
* See https://docs.openstack.org/victoria/[OpenStack (version 16.1, or later)]
