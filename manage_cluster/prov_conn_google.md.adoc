...
You can use this connection when you create a cluster by completing the steps in xref:create_google.md.adoc#creating-a-cluster-on-google-cloud-platform[Creating a cluster on Google Cloud Platform].
