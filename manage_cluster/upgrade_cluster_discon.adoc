...
. Run the script that you created to mirror the images, configure settings, and separate the release images from the release content.

*Tip:* You can use the information in this script when you create your `ImageContentSourcePolicy`.
