...
+
See https://docs.openshift.com/container-platform/4.5/registry/configuring-registry-operator.html#images-configuration-cas_configuring-registry-operator[Image Registry Operator in {ocp-short}] in the {ocp-short} documentation for more information.
