...
. Create a namespace for your {cincinnati} instance by entering the following command in the {ocp-short} CLI:
+
----
oc create ns <new_namespace>
----
+
Replace _new_namespace_ with the name of the namespace that you want to create.
