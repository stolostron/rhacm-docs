...
** xref:../siteconfig/siteconfig_ibbf_reinstall_cluster.adoc#ibbf-for-sno-hardware-replacement[Image-Based Break/Fix for single-node OpenShift hardware replacement (Technology Preview)]
