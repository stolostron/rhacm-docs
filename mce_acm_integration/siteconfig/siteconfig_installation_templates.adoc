...
* <<permissible-changes,Permissible changes after provisioning>>
...
For more information about the `ClusterInstance` API, use the _API Explorer_ in the console, or an `oc` command.
