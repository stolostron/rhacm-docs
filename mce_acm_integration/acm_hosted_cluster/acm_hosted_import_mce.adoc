...
[role="_abstract"]
You can start importing {mce-short} clusters after you configure {acm-short} add-ons to install in a different namespace than {mce-short} add-ons. To manually import an {mce-short} cluster from your {acm-short} cluster, complete the following procedure:
