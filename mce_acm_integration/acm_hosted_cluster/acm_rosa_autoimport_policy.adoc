...
[role="_abstract"]
Create an automatic import policy as an example of how to import all your discovered {rosa} clusters automatically. Log in to your hub cluster from the CLI to complete the following procedure:
