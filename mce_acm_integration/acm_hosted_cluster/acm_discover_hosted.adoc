...
After configuring {acm-short} add-ons to install in a different namespace than {mce-short} add-ons, you can start importing {mce-short} clusters. To manually import an {mce-short} cluster from your {acm-short} cluster, complete the following procedure:
