...
To learn about Search, see link:search.adoc[Search in the console]
...
Additionally, you can access the link:vwt_search.adoc[Visual Web Terminal] from the header.
