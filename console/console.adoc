...
Click *Welcome* for introductory information about each product function. Click *Overview* (Deprecated) to see updates, such as _Application_ status, or to access clickable _Cluster_ percentage values for policy violations and more.

From the _Overview_ page (Deprecated), you can view the following information:
