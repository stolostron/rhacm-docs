...
image::nav-2.7.png[Navigation on the side from the Welcome page, with Search, Infrastructure, Applications, Governance, and Credentials listed and clickable. The main window constains introductory modals for the Overview, and for Clusters, Applications, Governance, and Networking.]
