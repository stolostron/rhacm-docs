...
image::nav-2.7.png[Navigation on the side from the Welcome page, with Search, Infrastructure, Applications, Governance, and Credentials listed and clickable. The main window contains introductory modals for the Overview, Clusters, Applications, Governance, and Networking.]

*Note:* _Virtual machines_ is part of _Infrastructure_, but missing in the _Welcome_ page image.
...
To learn about Search, see xref:../search/search_console.adoc#search-console-intro[Search in the console].
