...
To learn about the search service, see link:../search/search_intro.adoc#acm-search[Search].
...
Create an application and edit a `.yaml` file. Access an overview or more advanced information about each application. For more information about application resources, see link:../applications/app_management_overview.adoc#managing-applications[Manage applications].
