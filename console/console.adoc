...
_Search_ is also available from the _Home_ tab. To learn about Search, see link:../observability/search_intro.adoc#search-in-the-console[Search in the console].
