...
Use the _Governance_ dashboard to create and manage policies and policy controllers. For more information, see link:../risk_compliance/grc_intro.adoc[Governance].
