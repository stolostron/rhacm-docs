...
. Optional: You can change your default namespace. Click `@default` in the status bar to run the command that displays your namespaces. View the output, then click on a row in the table to set a different namespace.
