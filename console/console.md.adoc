...
To learn about Search, see xref:search-in-the-console[Search in the console]
...
Additionally, you can access the xref:visual-web-terminal[Visual Web Terminal] from the header.
