...
. Access the terminal either from the console navigation where you can open in a new tab, or open from the console *Visual Web Terminal* icon in the header. From the header, choose to open in a new tab or open in a current tab.
...
. Optional: Run or select `getting started` to pull up the Visual Web Terminal overview.
