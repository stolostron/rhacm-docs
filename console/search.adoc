...
You might need to increase the memory limit for the `search-collector`. For more information, see link:../troubleshooting/trouble_search.adoc#troubleshooting-the-search-collector-pod[Troubleshooting the search collector pod].
