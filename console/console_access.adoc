...
If the cluster switcher is not present, the required console plug-ins might not be enabled. 

*Important:* For {ocp} versions later than version 4.19, select *Fleet Management* from the perspective selector.
...
+
*Important:* For {ocp} versions later than version 4.19, check if the *Fleet Management* option is available from the perspective selector.
