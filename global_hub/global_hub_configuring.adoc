...
There are three Grafana alerts that you can configure. These alerts are stored in configmap `multicluster-global-hub-default-alerting`. They watch suspicious policies, suspicious clusters compliance status change, and failed cron jobs.
