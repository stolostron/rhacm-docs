...
- link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.19/html-single/disconnected_environments/mirroring-in-disconnected-environments#creating-mirror-registry[Create a mirror registry]
...
- link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.19/html-single/operators/index#olm-mirror-catalog_olm-restricted-networks[Mirroring an Operator catalog]
