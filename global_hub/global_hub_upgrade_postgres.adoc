...
= Recovering data from the upgraded built-in Postgres (Deprecated)

In version 1.5 and later, {global-hub} automatically handles database upgrades, making it unnecessary for you to manually upgrade your data and databases with the Postgres database. 
