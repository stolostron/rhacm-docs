...
The Grafana data is exposed through the route. The authentication method of this URL is same as authenticating to the {ocp} console. 

You can run the following command to display the login URL and then learn about ways to use the Grafana dashboards:
