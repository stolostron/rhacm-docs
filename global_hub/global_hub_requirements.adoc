...
* <<gh-general-requirementsGlobal hub general requirements>>
* <<gh-requirements,Global hub networking requirements>>
* <<gh-supported-components,Supported components>>

[#gh-general-requirements]
== Global hub general requirements
...
* *Optional:* For middleware, {global-hub-cap} has built-in Kafka, PostgreSQL, and Grafana, but you can use your own configured Kafka, PostgreSQL, and Grafana. See xref:../global_hub/global_hub_components.adoc#global-hub-integrating-existing-components[Integrating existing components] for more details.

[#gh-install-supported-components]
...
+
{global-hub-cap} has the two following main components:
