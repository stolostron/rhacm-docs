...
//Set this where? 
//MWe normally give them a file or a sample to set this; 
//Normally: Go to (or create) x file, set the y spec to z. We don't tell the user where they are doing this.
