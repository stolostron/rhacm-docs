...
For more information about the Security Operator, see the _Container Security Operator_ from the link:https://github.com/quay/container-security-operator[{quay-short} repository].
