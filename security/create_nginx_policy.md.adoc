...
View a sample of a pod nginx policy, see _Pod nginx policy sample_ from the link:pod_nginx_policy.md.adoc#pod-nginx-policy-sample[Pod nginx policy] page.
