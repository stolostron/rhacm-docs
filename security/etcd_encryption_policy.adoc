...
For more information, see _ETCD Encryption_ in the https://docs.openshift.com/container-platform/4.5/security/encrypting-etcd.html[{ocp-short} documentation]. 
