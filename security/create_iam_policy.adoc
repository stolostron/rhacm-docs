...
View the _IAM policy sample_ from the xref:iam_policy_ctrl.adoc#iam-policy-sample[IAM policy controller] page.
See xref:create_policy.adoc[Managing security policies] for more topics.
