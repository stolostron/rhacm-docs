...
View the _IAM policy sample_ from the link:iam_policy_ctrl.adoc#iam-policy-sample[IAM policy controller] page.
See link:create_policy.adoc[Managing security policies] for more topics.
