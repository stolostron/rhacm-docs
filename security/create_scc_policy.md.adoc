...
To view a sample of an SCC policy, see the _Security context constraint policy sample_ section of link:scc_policy.md.adoc#security-context-constraint-policy-sample[Security Context Constraints policy].
