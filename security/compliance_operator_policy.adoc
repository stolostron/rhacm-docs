...
To learn about managing compliance operator policies, see xref:../security/create_compliance_operator.adoc#managing-compliance-operator-policy[Creating a compliance operator policy] for more details. Refer to xref:../security/config_policy_ctrl.adoc#kubernetes-configuration-policy-controller[Kubernetes configuration policy controller] for more topics about configuration policies.