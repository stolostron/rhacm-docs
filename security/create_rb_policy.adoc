...
View a sample of a rolebinding policy, see _Rolebinding policy sample_ on the xref:rolebinding_policy.adoc#rolebinding-policy-sample[Rolebinding policy] page.
