...
View a sample of a memory usage policy, see _Memory usage policy sample_ from the link:memory_policy.md.adoc#memory-usage-policy-sample[Memory usage policy] page.
