...
See link:certificates.adoc[Certificates] for more information about certificates that are created and managed by Red Hat Advanced Cluster Management for Kubernates.
Return to the link:security_intro.adoc[Security] page for more information on securing your cluster.
