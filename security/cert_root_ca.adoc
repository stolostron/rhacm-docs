...
// whats the original ca certificate? Is the self-signed CA?
...
See xref:../security/certificates.adoc#certificates[Certificates] for more information about certificates that are created and managed by {product-title-short}.
