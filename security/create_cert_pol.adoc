...
. Click *Create policy*.
. Specify the policy you want to create by selecting _CertificatePolicy_ for the specification parameter. Continue to enter or select the appropriate values for the following fields:
 ** Name
 ** Specifications
 ** Cluster selector
 ** Remediation action
