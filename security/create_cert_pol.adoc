...
View a sample of a certificate policy, see _Certificate policy sample_ on the xref:cert_policy_ctrl.adoc#certificate-policy-sample[Certificate policy controller] page.
For more information about other policy controllers, see xref:policy_controllers.adoc[Policy controllers].
