...
View a sample of a certificate policy, see _Certificate policy sample_ on the link:cert_policy_ctrl.adoc#certificate-policy-sample[Certificate policy controller] page.
