...
View a sample of a rolebinding policy, see _Rolebinding policy sample_ on the link:rolebinding_policy.md.adoc#rolebinding-policy-sample[Rolebinding policy] page.
