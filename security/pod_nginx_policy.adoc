...
Learn how to manage a pod nginx policy, see xref:create_nginx_policy.adoc[Managing pod nginx policies] for more details.
...
See xref:create_policy.adoc[Manage security policies] to manage other policies.
