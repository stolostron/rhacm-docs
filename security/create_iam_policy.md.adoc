...
View the _IAM policy sample_ from the link:iam_policy_controller.md.adoc#iam-policy-sample[IAM policy controller] page.
See link:create_policy.md.adoc[Managing security policies] for more topics.
