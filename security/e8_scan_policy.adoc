...
See a sample of the https://github.com/open-cluster-management/policy-collection/blob/main/stable/CM-Configuration-Management/policy-compliance-operator-e8-scan.yaml[`policy-compliance-operator-e8-scan.yaml`]. For more information on creating an E8 scan policy, see xref:../security/create_e8_scan_pol.adoc#managing-e8-scan-policies[Managing E8 scan policies].
