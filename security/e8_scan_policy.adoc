...
The E8 scan policy is created as a Kubernetes configuration policy in {product-title-short}. {ocp-short} 4.7 and 4.6, support the E8 scan policy. For more information, see https://docs.openshift.com/container-platform/4.7/security/compliance_operator/compliance-operator-understanding.html#compliance-operator-understanding[Understanding the Compliance Operator] in the {ocp-short} documentation for more details.
...
See a sample of the https://github.com/open-cluster-management/policy-collection/blob/main/stable/CM-Configuration-Management/policy-compliance-operator-e8-scan.yaml[`policy-compliance-operator-e8-scan.yaml`] file. For more information on creating an E8 scan policy, see xref:../security/create_e8_scan_pol.adoc#managing-e8-scan-policies[Managing E8 scan policies].
