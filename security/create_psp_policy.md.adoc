...
View a sample of a pod security policy, see _Pod security policy sample_ on the link:psp_policy.md.adoc#pod-security-policy-sample[Pod security policy] page.
