...
Alternatively, you can view a list of configuration policy samples, see xref:../security/policy_sample_intro.adoc#policy-samples[Policy samples]. For details to manage other policies, refer to xref:../security/create_policy.adoc#managing-security-policies[Managing security policies].
