...
+ 
You can create, view, and manage your security policies from the _Policies_ page. The following details are provided in the table list of violations: description, resources, severity, cluster, standards, controls, categories, and update time. 

+
You can customize your _Summary_ view by filtering the violations by categories or standards, collapse the summary to see less information, and you can search for policies. Filter the violation table view by policies or cluster violations. 
