...
a geographical region. Policy controllers that are included in your installation are the following: Kubernetes configuration, Certificate, and IAM.
...
violations. Violations are propagated to the hub cluster. You can create a custom policy controller.
