...
* The `spec.installNamespace` field is deprecated. See link:../../clusters/release_notes_mce/mce_deprecate_remove.adoc#mce-deprecation-removal[Product deprecations and removals] to learn more.
