...
* *Technology Preview:* If Open Virtual Network Internet Protocol Security is enabled, you need to enable `IPSecCertAuthMode` in the `SubmarinerConfig` resource.
+
*Notes:* 
+
