...
.. If your platform is not listed, navigate to the link:https://catalog.redhat.com/software/containers/rhacm2/subctl-rhel9/65bd43fc6a96e2c53f3159b5Red[Red Hat Ecosystem Catalog `subctl` page] and extract `subctl` from the relevant image. For example, you can extract the _macos-arm64_ binary from the _arm64_ `subctl` image.
