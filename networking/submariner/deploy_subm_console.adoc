...
To deploy Submariner on other providers, follow the instructions in xref:../networking/submariner/deploy_subm_manual.adoc#deploying-submariner-manually[Deploying Submariner manually].
