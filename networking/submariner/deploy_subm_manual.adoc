...
----
+
<1> The name of the `SubmarinerConfig` must be `submariner`, as shown in the example.
<2> Replace `<managed-cluster-namespace>` with the name of your managed cluster.
+
