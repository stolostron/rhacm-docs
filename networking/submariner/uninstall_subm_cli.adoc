...
If the version of Submariner that you are removing is earlier than version 0.12, continue with xref:../submariner/uninstall_subm_manual.adoc#uninstalling-submariner-manually[Uninstalling Submariner manually]. If the Submariner version is 0.12 or later, Submariner is removed. 
