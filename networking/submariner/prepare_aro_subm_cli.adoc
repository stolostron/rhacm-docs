...
. From the Azure CLI, run the following command to install the extension. Replace `path-to-extension` with the path to where you downloaded the `.whl` extension file:
...
* link:../../clusters/cluster_lifecycle/import_intro.adoc#import-intro[Cluster import introduction]