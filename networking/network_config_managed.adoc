...
| HTTPS 
| Sending of logs dynamically from Search console for the pods of the managed cluster, also uses the `klusterlet-addon-workmgr` service that is running on the managed cluster 
| 443 
| None
