...
*Note:* This information follows the upgrading procedure in xref:../install/upgrade_hub.adoc#upgrading-hub[Upgrading your hub cluster]. Review that procedure, then see the following information:
