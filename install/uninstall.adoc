...
+
*Note*: Be sure to review the commands in the clean-up script and remove commands that are specific to `cert-manager`, if `cert-manager` is installed in your cluster.
