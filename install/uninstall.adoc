...
----
+
Replace `_namespace_` in the script with the name of the namespace where {product-title-short} was installed. Ensure that you specify the correct namespace, as the namespace is cleaned out and deleted. 
...
. Remove the _{product-short}}_ operator by selecting the _Options_ menu and selecting *Uninstall operator*.
