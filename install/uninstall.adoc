...
*Important*: Before you remove the MultiClusterHub instance, you must disable the observability custom resource. See link:../observability/observability_install.adoc#disable-observability[Disable observability].
