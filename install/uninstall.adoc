...
//we should not use scripts but I recongize this was pasted by another team member and it was before peer reviews. I will check to make sure this is not in later versions.
