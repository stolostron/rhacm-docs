...
+
For more information about detaching clusters, see the _Removing a cluster from management_ section by selecting the information for your provider in link:../multicluster_engine/create_intro.adoc#creating-a-cluster[Creating a cluster]. 
