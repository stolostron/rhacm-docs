...
+
After the {product-title-short} hub cluster is created, the status for the operator is _Succeeded_ on the _Installed Operators_ page. You can now access the console for the {product-title-short} hub cluster. See the following steps:
