...
+
*Note:* Automatic upgrades do not span across major releases, for example, 2.1 to 2.2. To upgrade to the next major release, you must return to the _OperatorHub_ page and select a new channel for the more current release. 
