...
. Subscribe to the operator. REMEMBER: The value for _namespace_ might be referred to as _Project_ in the Red Hat OpenShift Container Platform environment.
