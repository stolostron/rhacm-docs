...
. Gain access to the console. See the _Access your console_ topic in _Additional resources_.
...
* link:../console/console_access.adoc#access-console[Access your console]
