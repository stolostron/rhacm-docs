...
+
After the {product-title-short} hub cluster is created, the MultiClusterHub resource status displays _Running_ under the MultiClusterHub tab of the {product-title-short} operator details. You can now access the console for the {product-title-short} hub cluster. See the following steps:
