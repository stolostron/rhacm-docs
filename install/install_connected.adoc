...
If you are reinstalling Red Hat Advanced Cluster Management and the pods do not start, see link:../troubleshoot_acm/trouble_reinstall.adoc#troubleshooting-reinstallation-failure[Troubleshooting reinstallation failure] for steps to work around this problem. 
...
If you are reinstalling Red Hat Advanced Cluster Management and the pods do not start, see link:../troubleshoot_acm/trouble_reinstall.adoc#trouble-reinstallation-failure[Troubleshooting reinstallation failure] for steps to work around this problem.
