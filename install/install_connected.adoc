...
* A StorageClass that is configured in Red Hat OpenShift Container Platform to create storage for Red Hat Advanced Cluster Management for Kubernetes.
...
Pull secret requirements for OpenShift Container Platform clusters are automatically resolved by OpenShift Container Platform and Red Hat Advanced Cluster Management.
...
. Create a pull secret that provides the entitlement to the downloads.
 .. Copy your OpenShift Container Platform pull secret from https://cloud.redhat.com/openshift/install/pull-secret[cloud.redhat.com] by selecting *Copy pull secret*.
