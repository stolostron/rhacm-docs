...
* Before you install {acm-short}, ensure that your cluster is prepared and meets the prerequisites. See xref:../install/prerequisites.adoc#prerequisites[Prerequisites for installation].
...
* Accessing your console: xref:../access_console.adoc#access-console[Accessing your console]
* MultiClusterHub advanced configuration: xref:../install/advanced_config_mch.adoc#advanced-config-mch[MultiClusterHub advanced configuration]
*
