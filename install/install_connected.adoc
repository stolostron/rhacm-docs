...
. Wait for 10 minutes before you view the status.

. Check the `MultiClusterHub` custom resource status under the _status.phase_ field:
+
----
...
. View the list of routes to find your route:
+
----
oc get routes
----
