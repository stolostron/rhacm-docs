...
* You need a supported version of {ocp-short} and the {ocp-short} command-line interface. See the link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html/installation_overview/index[Installation overview] in the {ocp-short} documentation.
