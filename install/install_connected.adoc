...
+
*Important:* These secrets are namespace-specific, be sure to create a secret in the namespace where you installed {product-title-short}.
+
...
Replace _namespace_ with your project namespace, as the secret is namespace-specific.
