...
- A namespace called `<your-local-cluster>` is reserved for the {acm-short} hub cluster when it is self-managed. This is the only `local-cluster` namespace that can exist in the product. 
