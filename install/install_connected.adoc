...
+
* The following example shows some sample data if you did not create an image pull secret:
+
[source,yaml]
----
...
* The following example shows some sample data if you created an image pull secret:
+
[source,yaml]
----
apiVersion: operator.open-cluster-management.io/v1
