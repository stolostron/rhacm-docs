...
vCPU reservations and limits establish vCPU capacity on a worker node to assign to a container. A vCPU is equal to a Kubernetes compute unit. For more information, see Kubernetes link:https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/#meaning-of-cpu[Meaning of CPU].
...
| 16 GB
| 120 GB
| See the following link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.14/html/installing/installing-on-vsphere[Installing on vSphere] in the {ocp-short} documentation for more details.
...
| 16 GB
| 120 GB
| See the following link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.14/html/installing/installing-on-bare-metal#installation-three-node-cluster_installing-bare-metal[Configuring a three-node cluster] in the {ocp-short} documentation for more details.
