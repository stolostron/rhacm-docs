...
| 16 GB
| 120 GB
| See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.17/html/disconnected_installation_mirroring/installing-mirroring-installation-images[Configuring a three-node cluster] in the {ocp-short} documentation for more details.
