...
| 16 GB
| 120 GB
| See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.20/html/installing_on_aws/index[Installing on AWS] in the {ocp-short} product documentation for more information.
...
| 16 GB
| 120 GB
| See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.20/html/installing_on_azure/installing-azure-account[Configuring an Azure account] in the {ocp-short} documentation for more details.
...
| 16 GB
| 120 GB
| See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.20/html/installing_on_vmware_vsphere/preparing-to-install-on-vsphere[Installing on VMware vSphere] in the {ocp-short} documentation for more details.
...
| 16 GB 
| 100 GB
| See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.20/html/installing_on_ibm_z_and_ibm_linuxone/index[Installing a cluster on IBM Z systems] in the {ocp-short} documentation for more information.
...
| 16 GB
| 120 GB
| See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.20/html/installing_on_ibm_power/index[Installing a cluster on Power systems] in the {ocp-short} documentation for more information.
...
| 16 GB
| 120 GB
| See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.20/html/installing_on_openstack/installing-openstack-three-node#installation-three-node-cluster_installing-openstack-three-node[Configuring a three-node cluster] in the {ocp-short} documentation for more details.
