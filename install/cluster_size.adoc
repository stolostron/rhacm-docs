...
[#single-node]
== Creating and managing {sno} clusters
...
_Availability zones_ isolate potential fault domains across the cluster. Typical clusters have an equal worker node capacity in three or more availability zones. 
