...
| 16 GB
| 120 GB
| See the following link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.14/html/installing_on_vsphere[Installing on vSphere] in the {ocp-short} documentation for more details.
...
| 16 GB
| 120 GB
| See the following link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.14/html/disconnected_installation_mirroring/installing-mirroring-installation-images[Configuring a three-node cluster] in the {ocp-short} documentation for more details.
