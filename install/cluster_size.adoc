...
In addition to {product-title-short}, the {ocp-short} cluster runs additional services to support cluster features. The recommended node size is 3 nodes.
...
| {ocp-short} on Bare metal assets (deprecated)
| 3
| 3
|
| 4
