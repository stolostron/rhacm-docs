...
| 16 GB
| 120 GB
| See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.17/html/installing_on_vsphere[Installing on vSphere] in the {ocp-short} documentation for more details.
