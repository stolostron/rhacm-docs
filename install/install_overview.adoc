...
*Deprecated:* The 2.7 and earlier versions of {product-title} are no longer supported. The documentation might remain available, but without any Errata or other updates available.
