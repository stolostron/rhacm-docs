...
Installing {acm} sets up a multi-node cluster production environment. You can install {acm} in either standard or high-availability configurations.
...
You must have a supported version of {ocp-short}. For example, you can use Red Hat OpenShift Service on AWS, or Red Hat OpenShift Dedicated. You must install the {mce}.
...
For full support information, see the link:https://access.redhat.com/articles/7055998[Support matrix] and the link:https://access.redhat.com/support/policy/updates/advanced-cluster-management[Lifecycle and update policies for {acm}].

View the following documentation for more information about the installation procedure:
