...
To see recent information about hub cluster and managed cluster platforms, refer to the https://access.redhat.com/articles/6978968[{product-title-short} {product-version} Support matrix].
