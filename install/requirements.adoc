...
To see recent information about hub cluster and managed cluster platforms, refer to the link:https://access.redhat.com/articles/7006295[{product-title-short} {product-version} support matrix].
