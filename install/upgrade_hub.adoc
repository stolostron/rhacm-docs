...
For more information about upgrading your operator, see link:https://docs.redhat.com/documentation/en-us/openshift_container_platform/4.15/html/operators/index[Operators] in the {ocp-short} documentation.
