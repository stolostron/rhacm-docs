...
* Do not attempt to upgrade {mce-short} separately from {acm-short} upgrade because this action can cause issues with your cluster.
...
For more information about upgrading your operator, see link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/operators/index[Operators] in the {ocp-short} documentation.
