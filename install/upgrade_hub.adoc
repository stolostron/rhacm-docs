...
You control your {acm} upgrades by using the operator subscription settings in the {ocp} console. The {olm} `operatorcondition` helps control how versions are upgraded. When you initially deploy {acm-short} by using the operator, you make the following selections:
...
For more information about upgrading your operator, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.12/html/operators/index[Operators] in the {ocp-short} documentation.
