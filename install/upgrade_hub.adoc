...
. Select the channel for the next available feature release. To import, you must use the `stable-2.0` channel of the klusterlet operator for {product-version:}. You cannot skip channels when upgrading. You cannot skip versions 2.2.z through 2.4.
