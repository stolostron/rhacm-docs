...
* Before you upgrade, see xref:../upgrade_considerations.adoc#upgrading-considerations[Upgrade considerations for your hub cluster] to understand the upgrade requirements, limitations, and the potential impacts of an upgrade.
