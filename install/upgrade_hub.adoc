...
For more information about upgrading your operator, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html/operators/index[Operators] in the {ocp-short} documentation.
