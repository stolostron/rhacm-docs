...
If you are link:../clusters/cluster_pool_manage.adocclusters/cluster_pool_manage.adoc[Managing cluster pools (Technology preview)], you need further configuration to stop automatic management of these cluster pools after upgrade.
