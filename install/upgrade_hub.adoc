...
* When you upgrade {acm-short}, {mce-short} automatically upgrades to the required version. Do not attempt to upgrade {mce-short} separately from {acm-short} because this action can cause issues with your cluster.
