...
* Before you upgrade {ocp-short} on your {acm-short} hub cluster, ensure that you choose the {ocp-short} version that is supported by your current {acm-short} version. See the Support Matrix in link:https://access.redhat.com/articles/7142376[{acm-short} Support Matrix] for more information about the required {ocp-short} versions for each {acm-short} version.
