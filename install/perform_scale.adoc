...
For more information on how you can change the amount of memory used for the search component, see link:../observability/search_intro.adoc#options-increase-memory[Options to increase the redisgraph memory]. 
