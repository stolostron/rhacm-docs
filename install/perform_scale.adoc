...
For more information on role access, see https://docs.openshift.com/container-platform/4.10/authentication/using-rbac.html[Using RBAC to define and apply permissions] in the {ocp-short} documentation.
