...
For more information on how you can change the amount of memory used for the search component, see link:../observability/manage_search.adoc#increasing-redisgraph-memory[Increasing the RedisGraph memory].
