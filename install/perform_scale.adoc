...
For more information about infrastructure nodes, see link:https://docs.openshift.com/container-platform/4.11/machine_management/creating-infrastructure-machinesets.html[Installing the Red Hat Advanced Cluster Management hub cluster on infrastructure nodes].

//Instead of pointing the user to the OpenShift doc
