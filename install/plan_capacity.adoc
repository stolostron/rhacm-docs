...
** Memory: 16 GB
** Storage size: 120 GB 		
** vCPU: IBM Power systems reprovide simultaneous multithreading (SMT) levels of 1, 2, 4, or 8 for each core. These levels correspond to the number of recommended vCPUs in the following table: 
+
|===
| SMT level | SMT=1 | SMT=2 | SMT=4 | SMT=8 |
| Recommended vCPUs | 1 | 1 | 2 | 4 |
|===
