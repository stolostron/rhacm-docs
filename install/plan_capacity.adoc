...
See https://docs.openshift.com/container-platform/4.7/installing/installing_ibm_power/installing-ibm-power.html[Installing a cluster on Power Systems] in the OpenShift Container Platform documentation for more information.
