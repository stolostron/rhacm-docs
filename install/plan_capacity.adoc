...
+
*** 2 cores running on SMT-8 provides the required 16 vCPUs. This is the default configuration for systems that are running IBM PowerVM.
*** 4 cores running on SMT-4 provides the required 16 vCPUs. This is the default configuration for systems that are not running IBM PowerVM. 
+
