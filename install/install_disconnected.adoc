...
+ 
Additional mirrors for disconnected image registries are needed if the following Governance policies need to be used:
...
+
Example mirrors list for all three operators:
