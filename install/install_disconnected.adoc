...
. Edit your `ImageContentSourcePolicy` resource to specify additional mirrors for disconnected image registries if you need to use following governance policies:
