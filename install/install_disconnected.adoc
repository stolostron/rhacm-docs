...
//this was poorly designed, very poorly written, and will take a lot of work with the engineers to even make sense of this. I plan to open an issue and ask for help from the engineers to rewrite this topic.
...
* Review xref:../install/cluster_size.adoc#cluster-sizing[Sizing your cluster] to learn about setting up capacity for your hub cluster.
