...
//it will take a lot of work with the engineers to even make sense of this--there are paragraphs after steps that are not clear. I plan to open an issue and ask for help from the engineers to rewrite this topic.
