...
- If you previously installed {acm-short}, then uninstalled, you need to follow the clean up instructions to remove artifacts. See xref:../install/cleanup_reinstall.adoc #cleanup-reinstall[Cleaning up artifacts before reinstalling] and follow the procedure.
