...
As described in the procedures in the {ocp} documentation, you need to add a `CatalogSource` resource to your disconnected cluster. Take note of the value of the `metadata.name` field, which you need later.
