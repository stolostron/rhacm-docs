...
* <<disconnect-confirm-ocp-install,Confirming your {ocp-short} installation>>
* <<disconnect-config-olm,Configuring {olm}>> 
* <<disconnect-config-icsp,Configuring image content source policies>>
...
* A supported {ocp} version must be deployed in your environment, and you must be logged in with the command-line interface. See the {ocp-short} documentation, link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html/installation_overview/index[Installation overview]. See link:https://docs.redhat.com/documentation/en-us/openshift_container_platform/4.16/html/cli_tools/openshift-cli-oc#cli-getting-started[Getting started with the CLI] for information about installing and configuring `oc` commands with the {ocp} command-line interface.
...
[#disconnect-confirm-ocp-install]
...
[#disconnect-confirm-local]
== Confirming the availability of a local image registry
...
[#config-mirror]
==== Configuring to use your mirror registry
...
. link:https://docs.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/operators/index#olm-restricted-networks-operatorhub_olm-restricted-networks[Disabling the default OperatorHub sources]
. link:https://docs.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/operators/index#olm-mirror-catalog_olm-restricted-networks[Mirroring the Operator catalog]
. link:https://docs.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/operators/index#olm-creating-catalog-from-index_olm-restricted-networks[Adding a catalog source for your mirrored catalog]
