...
+
See the https://docs.openshift.com/container-platform/4.7/welcome/index.html[{ocp-short} version 4.7 documentation],  https://docs.openshift.com/container-platform/4.6/welcome/index.html[{ocp-short} version 4.6 documentation].
