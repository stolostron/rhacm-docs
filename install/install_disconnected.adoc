...
[#prereqs-install-acm-disconnected]
== Prerequisites
...
+
After you have configured {olm} and {ocp-short} as previously described, you can install {acm-short} by using either the {ocp-catalog} console or a command-line interface. Follow the same guidance described in the xref:../install/install_connected.adoc#installing-while-connected-online[Installing while connected online] topic.
