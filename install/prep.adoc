...
* You must have a supported {ocp} version or a supported version of Red Hat OpenShift Dedicated, including the registry and storage services, installed and working in your cluster.
For more information about installing {ocp-short} and Red Hat OpenShift Dedicated, see the {ocp-short} documentation.
* For {ocp-short} version 4.5, see https://docs.openshift.com/container-platform/4.5/welcome/index.html[{ocp-short} 4.5 Documentation].
