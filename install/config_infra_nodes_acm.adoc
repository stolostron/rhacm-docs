...
. Update any add-ons to include the following node selectors and tolerations. See link:../../add-ons/configure_nodeselector_tolerations_addons.adoc#[Configuring nodeSelectors and tolerations for klusterlet add-ons].
