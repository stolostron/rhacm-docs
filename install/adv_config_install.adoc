...
| Name                       | Enabled
| app-lifecycle              | true
| cluster-backup             | false
| cluster-lifecycle          | true
| cluster-permission         | true
| console                    | true
| grc                        | true
| insights                   | true
| multicluster-observability | true
| search                     | true
| submariner-addon           | true
| volsync                    | true
|===
...
**Note** The component is forced to stay off if the component is disabled.
