...
To define a set of node selectors for the {mce-short} cluster, see link:../clusters/get_started_mce/adv_config_install.adoc#advanced-config-mce[Advanced configuration {mce-short}] in the {mce-short} documentation.
...
To define a list of tolerations for the {mce-short} hub cluster, see link:../clusters/get_started_mce/adv_config_install.adoc#advanced-config-mce[Advanced configuration {mce-short}] in the {mce-short} documentation.
