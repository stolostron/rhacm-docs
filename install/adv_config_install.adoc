...
To define a list of toleration for the {mce-short} hub cluster, see link:../clusters/install_upgrade/adv_config_install.adoc#tolerations[tolreations] in the {mce-short} documentation.
