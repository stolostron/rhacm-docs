...
See the following instructions in link:../clusters/release_images/release_image_connected.adoc#release-images-connected[Maintain a custom list of release images when connected] to manage your available release images and to set the `spec.disableUpdateClusterImageSets` attribute, which stops the custom image list from being overwritten.
