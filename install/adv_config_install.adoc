...
ClusterProxyAddon has been migrated to MultiClusterEngine and will be installed there. See link:../multicluster_engine/install_upgrade/adv_config_install.adoc#cluster-proxy-addon[MCE Documentation] to learn more.
