...
| cnv-mtv-integrations-preview| Provide related resources for virtual machine live migration. | False
...
| edge-manager-preview | Enables a service for declarative, GitOps-driven management of edge device fleets | False
| fine-grained-rbac-preview | Enables fine grained role based access control for virtual machine resources across clusters | False
...
To define a set of node selectors for the {mce-short} hub cluster, see link:../clusters/install_upgrade/adv_config_install.adoc#node-selector[nodeSelector] in the {mce-short} documentation.
...
To define a list of tolerations for the {mce-short} hub cluster, see link:../clusters/install_upgrade/adv_config_install.adoc#tolerations[tolerations] in the {mce-short} documentation.
