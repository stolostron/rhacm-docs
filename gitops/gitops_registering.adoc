...
. You need to install the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.13/html/cicd/gitops[Red Hat OpenShift GitOps operator] on your {acm}.
