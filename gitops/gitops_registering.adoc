...
. You need to install the link:https://docs.redhat.com/en/documentation/red_hat_openshift_gitops/1.12/html/understanding_openshift_gitops/[Red Hat OpenShift GitOps operator] on your {acm}.
...
- Refer to xref:../applications/gitops_config.adoc#tolerations-config[Configuring placement tolerations for {acm-short} and OpenShift GitOps] for more details.
