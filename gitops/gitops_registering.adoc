...
.. For more general information about creating a `ManagedClusterSetBinding`, go to the _Additional resources_ section and see _Creating a ManagedClusterSetBinding resource_ . 
.. For placement information, see link:../clusters/cluster_lifecycle/placement_filter.adoc[Selecting `ManagedClusters` from `ManagedClusterSets`].
