...
* <<verify-argocd-installation, Verifying the _ArgoCD_ installation>>
* <<addon-with-argocd-additional-resources, Additional resources>> 
...
[#addon-with-argocd-additional-resources]
