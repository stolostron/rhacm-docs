...
= Register managed clusters to the {gitops} operator
...
If you do not want the default service account, see _Create a customized service account for Argo CD Push model_.
