...
If you create a `ClusterPermission` resource to reference different subjects, you can simultaneously work with different subjects instead of only working on one subject at a time. 
