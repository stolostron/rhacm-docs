...
. Create the `ApplicationSet` resource with the pull-model annotations and labels. The following annotations and labels are required for the `ManifestWork`-based pull model:
