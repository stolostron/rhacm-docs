...
- See the open source community, link:https://github.com/open-cluster-management-io/policy-collection[`policy-collection`].
- See link:https://nvd.nist.gov/800-53/Rev4[NIST Special Publication 800-53] for standards. 
- See link:https://docs.redhat.com/documentation/en-us/openshift_container_platform/4.15/html/cli_tools/openshift-cli-oc#cli-getting-started#cli-using-cli_cli-developer-commands[Using the OpenShift CLI] for more information.
