...
* URL: The URL to the repository that you forked from the main `policy-collection` repository. 
...
- See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.19/html/cli_tools/openshift-cli-oc#cli-getting-started#cli-using-cli_cli-developer-commands[Using the OpenShift CLI] for more information.
- See link:../applications/subscribe_git_overwrite.adoc#resource-overwrite-example[Application Lifecycle] for more details about the _Resource overwrite example_.
