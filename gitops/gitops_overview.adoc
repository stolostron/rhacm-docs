...
* xref:../gitops/gitops_applicationset_rollout_strategy.adoc#gitops_applicationset_rollout_strategy[Implementing the _ApplicationSet_ progressive rollout strategy (Technology Preview)]
