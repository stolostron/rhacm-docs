...
* xref:../gitops/gitops_manage_argocd_applicationset.adoc#mangage-gitops-argocd-applicationset[Managing the _ArgoCD_ _ApplicationSet_ in any namespace for _ArgoCD_ pull model (Technology Preview)]
