...
* xref:../gitops/gitops_manage_argocd_appset.adoc#manage-gitops-argocd-appset[Managing the Argo CD _ApplicationSet_ resource in any namespace for pull model (Technology Preview)]
* xref:../gitops/gitops_deploy_appset.adoc#deploy-gitops-appset[Deploying the _ApplicationSet_ resource {Technology Preview}]
