...
* xref:../gitops/gitops_openshift_deploy_argocd.adoc#gitops-openshift-deploy-argocd[Deploying the {gitops} instances (Technology Preview)]
* xref:../gitops/gitops_applicationset_rollout_strategy.adoc#gitops_applicationset_rollout_strategy[Implementing the progressive rollout strategy by using the _ApplicationSet_ resource (Technology Preview) ]
