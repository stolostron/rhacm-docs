...
* xref:../gitops/gitops_openshift_deploy_argocd.adoc#gitops-openshift-deploy-argocd[Deploying the {gitops} instances on OpenShift and Non-OpenShift managed clusters for Argo CD pull model (Technology Preview)]
