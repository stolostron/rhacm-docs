...
* xref:../gitops/gitops_manage_argocd_appset.adoc#manage-gitops-argocd-appset[Managing the Argo CD _ApplicationSet_ resource in any namespace for Argo CD pull model (Technology Preview)]
