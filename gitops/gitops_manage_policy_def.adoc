...
* Read link:../governance/policy_gen_install_operator.adoc#using-policy-dependencies-with-operatorgroups[Using policy dependencies with _OperatorGroups_].
* Refer to link:https://argoproj.github.io/argo-cd/[ArgoCD] documentation.
* Return to link:../governance/policy_gen_install_operator.adoc#policy-gen-install-operator[Generating a policy to install an Operator].
