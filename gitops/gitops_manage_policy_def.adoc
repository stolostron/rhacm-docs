...
* See the link:https://docs.redhat.com/en/documentation/red_hat_openshift_gitops/1.14/html/understanding_openshift_gitops/index[Understanding {gitops-short}] documentation.
