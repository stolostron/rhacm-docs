...
*Deprecated:* The `MulticlusterApplicationSetReport` API `apps.open-cluster-management.io/v1alpha1` his deprecated. See link:../release_notes/acm_deprecate_remove.adoc#kube-deprecations-acm[Kubernetes API deprecations and removals] for more details.
