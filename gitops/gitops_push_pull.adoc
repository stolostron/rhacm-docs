...
- The required managed clusters {ocp-short} GitOps operator must be the same version as the hub cluster. You must only meet this requirement when you install the managed clusters and hub cluster. After you install, you do not need to have the same versions. 
