...
== Additional resources
 ...
 - See link:https://access.redhat.com/documentation/en-us/red_hat_openshift_gitops/1.10/html/declarative_cluster_configuration/configuring-an-openshift-cluster-by-deploying-an-application-with-cluster-configurations[Configuring an OpenShift cluster by deploying an application with cluster configurations] in the {gitops} documentation.


- See link:https://access.redhat.com/documentation/en-us/red_hat_openshift_gitops/1.10/html/argo_cd_instance/setting-up-argocd-instance[Setting up an Argo CD instance] in the {gitops} documentation.
