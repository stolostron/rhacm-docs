...
- The application manager service account uses a large set of permissions because the application subscription add-on uses the application manager service to deploy applications on the managed cluster. Do not use the application manager service account if you want a limited set of permissions. 
