...
{acm-short} uses `Placement` resources to select managed clusters for {gitops-short} workflows. There are two distinct `Placement` resources used with {gitops-short}:
