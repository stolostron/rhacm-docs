...
If you want to enable the {gitops-short} add-on with the `ArgoCD` agent, use the `Agent` mode. See xref:../gitops/gitops_enable_addon_argocd.adoc#gitops-enable-addon-argocd[Enabling {gitops} add-on with _ArgoCD_ agent] 
