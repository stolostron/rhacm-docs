...
Find the documentation here: https://access.redhat.com/documentation/en-us/red_hat_advanced_cluster_management_for_kubernetes/2.8[Product Documentation for Red Hat Advanced Cluster Management for Kubernetes].
