...
For more information, see link:managing_channels.md.adoc[Creating and managing channels].

. Create your deployables.

For more information, see link:managing_deployables.md.adoc[Creating and managing deployable resources].

. If your target cluster or clusters are not subscribed to the channel, create the subscription.
For more information, see link:managing_subscriptions.md.adoc[Creating and managing subscriptions].

. Define the placement rule for the deployables that are to be deployed from the channel.
For more information, see link:managing_placement_rules.md.adoc[Creating and managing placement rules].
...
For more information, see link:managing_deployables.md.adoc[Managing deployables with a rolling update].
