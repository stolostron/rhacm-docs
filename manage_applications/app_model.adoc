...
Subscriptions can be applied locally to the hub cluster so that the hub cluster is self managed. You can then view the `local-cluster` subscription in the topology. Subscriptions can also be applied to other managed clusters. 
