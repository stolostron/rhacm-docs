...
You can assign a placement rule to a subscription. To assign a placement rule, you need to update the spec for the subscription to reference the placement rule.
