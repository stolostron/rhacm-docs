...
Samples for all resources, including subscriptions, are located in the link:app_resource_samples.adoc[Application resource samples] documentation.

Learn more about subscriptions, then see the following tasks:

* link:creating_subscriptions.adoc[Creating a subscription]
* link:matching_subscriptions.adoc[Matching a subscription to an application]
* link:updating_subscriptions.adoc[Updating a subscription]
* link:package_overrides.adoc[Configuring package overrides]
* link:deleting_subscriptions.adoc[Deleting a subscription]
