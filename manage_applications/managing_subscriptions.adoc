...
* xref:../manage_applications/subscribe_git_resources.adoc.adoc#subscribing-git-resources[Subscribing Git resources]
* xref:../manage_applications/updating_subscriptions.adoc#updating-a-subscription[Updating a subscription]
* xref:../manage_applications/scheduling_deployment#scheduling-a-deployment.adoc[Scheduling a deployment]
