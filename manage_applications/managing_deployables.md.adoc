...
See the API documentation at :../apis/api.md.adoc[APIs].
...
For more information about updating an application, see link:app_resources.md.adoc[Creating and managing application resources].
