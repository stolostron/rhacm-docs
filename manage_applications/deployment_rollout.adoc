...
+
For more information about how to define a subscription, see link:managing_subscriptions.adoc[Creating and managing subscriptions].
+
For more information about how to define a placement rule, see link:managing_placement_rules.adoc[Creating and managing placement rules].
...
See subscription samples in link:app_sample.adoc[Application resource samples].
