...
Samples for all resources are located in the xref:app_sample.adoc[Application resource samples] documentation.
...
For more information, see xref:app_resources.adoc[Application resources].
...
For more information about using search, see link:../console/search.adoc[Search in the console].
...
For more information about using the topology page, see link:../console/console.adoc[Observability in the console
].
