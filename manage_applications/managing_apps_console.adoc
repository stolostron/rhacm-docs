...
For more information about using search, see xref:../console/search.adoc[Search in the console].
...
For more information about using the topology page, see xref:../console/console.adoc[Observability in the console
].
