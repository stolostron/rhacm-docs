...
From the main _Applications_ dashboard, you can view information about all applications and select a specific application to view about that specific application.
...
* Access the resource pipeline from the _Resource_ tab.
...
The application topology includes a visualization application cards that display application status. The topology view for each application includes any deployables, services, deployments, charts, and pods for that application.
