...
Samples for all resources, including subscriptions, are located in the link:app_resource_samples.md.adoc[Application resource samples] documentation.

Learn more about subscriptions, then see the following tasks:

* link:creating_subscriptions.md.adoc[Creating a subscription]
* link:matching_subscriptions.md.adoc[Matching a subscription to an application]
* link:updating_subscriptions.md.adoc[Updating a subscription]
* link:package_overrides.md.adoc[Configuring package overrides]
* link:deleting_subscriptions.md.adoc[Deleting a subscription]
