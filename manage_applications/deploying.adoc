...
For more information, see xref:managing_deployables.adoc[Creating and managing deployable resources].
...
For more information, see xref:managing_deployables.adoc[Managing deployables with a rolling update].
