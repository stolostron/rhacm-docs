...
| Optional. Defines the clusters where the subscription is to be placed.
...
* If you include more than one placement setting, one setting is used and others are ignored. The following priority is used to determine which setting the operator uses:
