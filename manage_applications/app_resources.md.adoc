...
For more information about creating and managing channels, see link:managing_channels.md.adoc[Creating and managing channels].
See link:app_sample.md.adoc[Application resource samples] for sample YAML files.
...
See link:managing_secrets.md.adoc[Managing secrets].
See link:secret_samples.md.adoc[Secret samples] for sample YAML files.
...
For information about creating and managing subscriptions, see link:managing_subscriptions.md.adoc[Creating and managing subscriptions].
See link:app_sample.md.adoc[Application resource samples] for sample YAML files.
...
For more information about creating and managing placement rules, see link:managing_placement_rules.md.adoc[Creating and managing placement rules].
See link:placement_sample.md.adoc[Placement rule samples] for sample YAML files.
