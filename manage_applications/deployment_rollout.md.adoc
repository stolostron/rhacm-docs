...
+
For more information about how to define a subscription, see link:managing_subscriptions.md.adoc[Creating and managing subscriptions].
+
For more information about how to define a placement rule, see link:managing_placement_rules.md.adoc[Creating and managing placement rules].
...
See subscription samples in xref:application-resource-samples[Application resource samples].
