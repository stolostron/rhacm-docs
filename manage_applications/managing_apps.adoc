...
Samples for all resources are located in the xref:app_resource_samples.adoc[Application resource samples] documentation.
...
For more information about the resource definition for an application, see xref:app_resources.adoc[Creating and managing application resources].
