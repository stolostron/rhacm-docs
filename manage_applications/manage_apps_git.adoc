...
(MAIN branch) rhacm-hub-cluster/
  ...
  common-managed-config/
    ...
    subscription.yaml    # Points to the `common-managed-config/configs` parent directory
  ...
  ## This is the subscription that delivers all the above content to the hub cluster
