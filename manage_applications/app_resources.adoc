...
For more information about creating and managing channels, see xref:managing_channels.adoc[Creating and managing channels].
See xref:app_sample.adoc[Application resource samples] for sample YAML files.
...
See xref:managing_secrets.adoc[Managing secrets].
See xref:secret_samples.adoc[Secret samples] for sample YAML files.
...
For information about creating and managing subscriptions, see xref:managing_subscriptions.adoc[Creating and managing subscriptions].
See xref:app_sample.adoc[Application resource samples] for sample YAML files.
...
For more information about creating and managing placement rules, see xref:managing_placement_rules.adoc[Creating and managing placement rules].
See xref:placement_sample.adoc[Placement rule samples] for sample YAML files.
