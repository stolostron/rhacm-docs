...
* Create and edit applications, and subscribe resources. For instance, you can choose to deploy resources to the local cluster, which is how you manage your hub cluster. 
