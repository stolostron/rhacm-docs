...
When you select a resource, a YAML editor opens for you to use to define that resource. Default sample YAML content is included as templates to indicate the required fields to help you edit any of these resource types.
