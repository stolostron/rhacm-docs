...
Click the `YAML` tab to form or edit your `.yaml` file.
...
Click the *Advanced configuration* to view terminology and a table of resources for all applications. You can find resources and you can filter subscriptions, placement rules, and channels. If you have access, you can also click the multiple **Actions** to edit or delete channels.
