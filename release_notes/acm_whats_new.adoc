...
Access the link:https://access.redhat.com/articles/7086905[Support matrix] to learn about hub cluster and managed cluster requirements and support for each component.
