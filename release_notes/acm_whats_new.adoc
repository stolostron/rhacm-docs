...
* You can now view the `deprecationPresent` condition in the Operator policy YAML table. See the link:../governance/operator_pol_ctrl.adoc#operator-policy-yaml-table[Operator policy YAML table].
