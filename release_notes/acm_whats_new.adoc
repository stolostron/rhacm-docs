...
* You can now use templating for managed clusters in `ConfigurationPolicy` to support `.ObjectName` and `.ObjectNamespace` variables. For more information, see the link:../governance/template_support_intro.adoc#template-comparison-table[Comparison of hub cluster and managed cluster templates].
