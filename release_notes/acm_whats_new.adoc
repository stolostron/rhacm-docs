...
* You can migrate managed clusters from one {acm-short} hub cluster to another. For more information, see link:../global_hub/global_hub_migrate.adoc#global-hub-migrating-managed-clusters[Migrating managed clusters (Technology Preview)]
