...
* With {acm-short} restore resources, you can set more velero restore spec options. See link:../business_continuity/backup_restore/backup_restore.adoc#more-restore-samples[Using other restore samples].
