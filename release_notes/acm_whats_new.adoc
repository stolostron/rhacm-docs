...
* You can now install VolSync as a deployment on the `volsync-system` namespace on the managed cluster. In earlier versions, you needed to install VolSync as an {olm} operator. By installing VolSync as a deployment on the `volsync-system` namespace, you have support for non-OpenShift managed clusters. 
