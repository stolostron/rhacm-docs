...
{acm-short} version 2.14 is released with the {mce-short} version 2.9 for Cluster lifecyle management. See the link:../clusters/release_notes/mce_release_notes.adoc#mce-release-notes[Release notes for Cluster lifecycle with {mce-short}].
...
- You can now configure resource requests and limits on all add-ons now. To learn more, see link:../add-ons/configure_klusterlet_addons.adoc#configure-klusterlet-addons[Configuring klusterlet add-ons].
