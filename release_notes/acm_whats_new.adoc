...
* With the GitOps addon, you can manage the lifecycle of the {gitops-short} instances on all kinds of OpenShift and Non-OpenShift managed clusters for the `ArgoCD` pull model, see: link:../gitops/gitops_openshift_deploy_argocd.adoc#gitops-openshift-deploy-argocd[Deploying the {gitops} instances on OpenShift and Non-OpenShift managed clusters for _ArgoCD_ pull model (Technology Preview)]
