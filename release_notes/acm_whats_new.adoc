...
* `ValidatingAdmissionPolicyBindings` policy now appears in the `Discovered` policies tab in the Governance console. Additionally, you can also see other policy types that are in your managed clusters. Use the `ValidatingAdmissionPolicyBindings` policy to see details of the resources on your manged cluster, including resources that you can use to configure the behaviors of policies. 
