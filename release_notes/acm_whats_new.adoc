...
* See more release notes, such as _Known Issues and Limitations_ in the {acm-short} xref:../release_notes/release_notes.adoc#acm-release-notes[Release notes for {acm-short}].
