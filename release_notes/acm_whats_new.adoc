...
- You can now use the `fromYaml` and `toYaml` Go template functions in `ConfigurationPolicy` to organize YAML strings. You also have more Sprig functions in the list of available functions.
