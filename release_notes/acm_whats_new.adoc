...
* As you directly apply {acm-short} policies and Gatekeeper constraints on your managed clusters, you can now view the deployment of the policies in the _Discovered policies_ tab from the console. See link:../governance/deploy_pol_ext_tools.adoc#deploy-external-tools[Deploy policies with external tools].

* You can now deploy your policies with external tools. To learn more, see link:../governance/pol_deploy_ext_tools.adoc#pol-deploy-ext-tools[Policy deployment by using external tools].
