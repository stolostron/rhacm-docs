...
* You now can use the {acm-short} backup and restore component to install {acm-short} policies to backup and restore the {ocp-virt-short} resources. For more information, see link:../business_continuity//backup_restore/backup_config_policy-virt.adoc#backup-config-policy-virt[Configuring backup and restore for {ocp-virt} using {acm-short} policies]. 
