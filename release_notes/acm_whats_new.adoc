...
* You can now deploy your policies with external tools. To learn more, see link:../governance/pol_deploy_ext_tools.adoc#pol-deploy-ext-tools[Policy deployment with external tools].
