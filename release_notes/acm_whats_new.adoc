...
* When you use the Search feature from the console, you now receive results that match the exact strings that you enter and range-based search parameters. See link:../observability/search_console.adoc#search-console-intro[Search in the console].
