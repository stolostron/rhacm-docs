...
* The Operator policy includes more in its `status.conditions`, so now you can view the deprecation status condition, `deprecationPresent`. See the link:../governance/operator_pol_ctrl.adoc#operator-policy-yaml-table[Operator policy YAML table].
