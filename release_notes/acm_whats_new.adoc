...
* To give different operator versions in one entry of the `versions` list inside an `OperatorPolicy`, separate these versions with a comma. For more information, see link:../governance/operator_pol_ctrl.adoc#operator-policy-yaml-table[Operator policy YAML table]. 
