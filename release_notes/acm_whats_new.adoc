...
* You can now view related resources for your policies across different clusters in the `Discovered policies` section in the console from one table, instead of needing to go to the policy template for each cluster. This table works for all the policy types except for the {gate} resources.
