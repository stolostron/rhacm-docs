...
. Remove the `skip-reconcile` annotation from the local cluster Argo CD application. See the following annotation:
...
. Remove the `refresh` annotation from the Argo CD application. See the following annotation:
