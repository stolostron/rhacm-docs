...
When you install or upgrade to the latest product version, Errata updates are automatically applied. See link:../manage_cluster/upgrade_cluster.adoc#upgrading-your-cluster[Upgrading your cluster] for more information.
