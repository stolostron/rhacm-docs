...
{ocp} 4.7 is not supported with 2.0.x Errata.
...
View a summarized list of {product-title} Errata 2.0.11 updates:

*Important:* {ocp} 4.5 is not supported with 2.0.11. You must run {ocp} version 4.6 to upgrade to {product-title-short} version 2.0.11. If you cannot upgrade your {ocp} version to 4.6, you can continue to use {product-title-short} version 2.0.10.

. Updated Search code to use data from other fields as a result of Kubernetes `selfLink` removal, which impacted Search logic that depended on those fields. (GitHub 11904)

. Fixed an issue that caused unexpected policies to display in the _Policy listing_ page. (GitHub 11853)

. Removed obsolete translated console content. (GitHub 12640)

== Errata 2.0.10

View a summarized list of {product-title} Errata 2.0.10 updates:

. Fixed the _Clusters_ page to display the imported cluster distributor version. (GitHub 11776)

. Updated Red Hat OpenShift release `ClusterImageSets` that are available when you create a new cluster. (GitHub 10928)
