[#fix-pack-updates]
= Updates for Errata versions

*Note:* For reference, link:https://access.redhat.com/errata/#/[Errata] links and GitHub numbers are added to the content and might be used internally. Links require access that might not be available for the user.
