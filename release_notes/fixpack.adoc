...
*Important:* You must run {ocp} version 4.5, or later, to upgrade to {product-title-short} version 2.0.11. If you cannot upgrade your {ocp} version 4.4 to a later version, you can continue to use {product-title-short} version 2.0.10.

. Updated Search as a result of Kubernetes version deprecation, which caused errors in the console editor. (GitHub 11904)
