...
* Fixes an issue that caused VMware clusters to appear on the *Overview* page in the section labeled `Other`, rather than in the `VMware` section. (Bugzilla #2004188)
