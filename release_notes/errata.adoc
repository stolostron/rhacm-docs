...
* Ensures that the node type naming conventions align {acm} with {ocp} to maintain consistency and standards. (link:https://issues.redhat.com/browse/ACM-10166[ACM-10166])
