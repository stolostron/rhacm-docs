...
* Adds a YAML separator to separate the `Subscription` and `PlacementRule` YAML content, which caused the content to be incorrectly parsed. (link:https://issues.redhat.com/browse/ACM-12133[ACM-12133])
