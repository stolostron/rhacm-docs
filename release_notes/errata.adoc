...
* Quickens the propagation of the application subscriptions so that the application subscriptions gets created on the managed cluster around the same time that the placement of the application subscription gets changed. (link:https://issues.redhat.com/browse/ACM-18885[ACM-18885])
