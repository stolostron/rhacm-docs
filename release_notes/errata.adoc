...
* Fixes an issue with updates to the `ManagedCluster` object that prevented the hub template results from bring found with a search. (link:https://issues.redhat.com/browse/ACM-13370[ACM-13370])
