...
* Fixes the *Edit time window* link in the console to open the wrong edit page. (https://issues.redhat.com/browse/ACM-2647[ACM-2647])

* Fixes an issue that causes topology nodes to appear in the applications UI when creating an application. (https://issues.redhat.com/browse/ACM-3340[ACM-3340])
