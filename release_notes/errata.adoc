...
* Quickens the propagation of the managed cluster so that the manifested managed cluster gets created around the same time that the placement of the managed cluster gets changed. (link:https://issues.redhat.com/browse/ACM-18885[ACM-18885])
