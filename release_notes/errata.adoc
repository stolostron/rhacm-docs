...
* Fixes issue with `placementrule` and `placementbinding` not deleted when a disabled policy in the console is deleted. (GitHub 12689)

* Fixes role and role binding that was created in the wrong namespace secrets. (GitHub 12319)

* Adds support for Red Hat OpenShift on IBM Cloud in Observability (GitHub 11125)

* Hive entry (GitHub 12013)

* Observability entry (GitHub 13071)
