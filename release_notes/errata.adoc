...
* Fixes a bug that caused ClusterRoleBindings for the `open-cluster-management-agent` to be continuously recreated. (https://bugzilla.redhat.com/show_bug.cgi?id=2134796[Bugzilla #2134796])
