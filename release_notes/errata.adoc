...
* Fixes an issue with slow propagation of the application subscriptions. Now the application subscriptions gets created on the managed cluster quicker and about the same time that the placement of the application subscription gets changed. (link:https://issues.redhat.com/browse/ACM-18885[ACM-18885])
