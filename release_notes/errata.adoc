...
* Fixed and issue that caused the hub cluster to deny renewal requests for a registration agent certificate, which resulted in some registration agents going offline after 1 month. (GitHub 5628) 

* Fixed an issue that caused a conflict between some cluster image sets during upgrading. (GitHub 7527)
