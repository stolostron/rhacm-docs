...
* Removes the {ocp-short} version 4.5 image from the list of available cluster image sets, as it is not supported. (Bugzilla 2030859)

* Fixes an issue that caused an upgraded managed cluster to show a `degraded` status after an upgrade when it was running the observability add-on. (Bugzilla 19636) 
