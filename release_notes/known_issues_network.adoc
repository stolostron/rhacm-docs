...
Submariner version .15, which was released with {product-title-short} version 2.8, is not supported with {ocp-short} version 4.14, or later. You must either upgrade your Submariner version to .16 when using {ocp-short} version 4.14, or later, or continue using {ocp-short} version 4.13 with Submariner version .15 and {product-title-short} version 2.8.
