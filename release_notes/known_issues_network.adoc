...
IPsec tunnels created by IPsec-enabled OVN-Kubernetes deployments can conflict with IPsec tunnels created by Submariner. OVN-Kubernetes should not be used in IPsec mode with Submariner.
