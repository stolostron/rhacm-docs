...
[#external-link-console-wrong-page]
== External links in certain versions of the integrated console lead to incorrect pages

If your {ocp} version is 4.18.29 or older, 4.19.20 or older, or 4.20.7 or older, completing one of the following actions causes part of the URL to be lost:
...
As a result, you see the wrong console page. For example, a link to the *Governance Policies* tab might open the *Governance Overview* tab instead.
