...
// 2.8.6365
When you deploy `ApplicationSet` applications using the Argo CD pull model, the application will not display correctly from the _Topology_ page as they are not supported. 
