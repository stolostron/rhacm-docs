...
[#follow-external-link-wrong-page]
== Following an external link opens the wrong page

If you follow an external link that leads to the console, open a link in a new tab, enter a URL manually, or refresh a page, part of the URL might be lost. As a result, you see the wrong console page. For example, a link to the *Governance Policies* tab might open the *Governance Overview* tab instead.

To resolve the issue, upgrade to {ocp} version 4.18.30, 4.19.21, or 4.20.8 or later.

Alternatively, you might be able to access the correct page if you reload the page. You can also navigate to the correct page from the console by following the appropriate links in the navigation menu, or by using the search function.

link:https://issues.redhat.com/browse/ACM-24689[ACM-24689]
