...
[#compliance-state-gatekeeper]
== Compliance state of Gatekeeper resources does not appear in _PolicyReport_
//2.8:ACM-6366

The compliance state of policies that use the Gatekeeper integration does not appear in the `PolicyReport` resource. As a result, you do not receive alerts for these policies. 
