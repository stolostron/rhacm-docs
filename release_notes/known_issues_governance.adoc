...
Creating a policy that contains two instances of the same policy template name leads to inconsistent results. To resolve this issue, do not use duplicate names for policy templates.
