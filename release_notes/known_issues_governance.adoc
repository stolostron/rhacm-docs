...
Because of this issue, if you try to apply the `ImageManifestVuln` policy, you receive the following violation message: "violation - couldn't find mapping resource with kind Subscription, please check if you have CRD deployed". 
