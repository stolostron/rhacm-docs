...
* {acm-short} policy for the Quay Container Security Operator
* {acm-short} policy for the Compliance Operator 

link:https://github.com/stolostron/backlog/issues/19061[ACM-19061]
...
link:https://issues.redhat.com/browse/ACM-10611[ACM-10611]
...
link:https://issues.redhat.com/browse/ACM-5632[ACM-5632]
