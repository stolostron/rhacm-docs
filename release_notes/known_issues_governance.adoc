...
The compliance state of policies that use the Gatekeeper integration does not appear in the `PolicyReport`. As a result, you do not receive alerts for these policies.
