...
== The console menu of the Application table can be hard to click 
//2.13:ACM-18543

When Application resources get updated in the hub cluster, the Application page table also gets updated. If you have the menu of the Application table opened, then it gets closed with every update to the Application page table. Because the menu can close often, it can be hard for you to click the menu. 
