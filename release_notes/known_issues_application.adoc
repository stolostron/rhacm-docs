...
== Application console does not support Argo CD 
// 2.8.6365
The _Topology_  and _Console_ for _Application_ does not support displaying Argo CD applications deployed by the `Application Set` pull model.
