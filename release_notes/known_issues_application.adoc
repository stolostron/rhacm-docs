...
When you deploy the subscription application, it will display a warning message for the subscription node. If you check the subscription node details, it incorrectly shows the local-cluster is offline. 
