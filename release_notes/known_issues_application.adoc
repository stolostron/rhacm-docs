...
Additionally, if you manually refresh the pull model Argo CD application in the console, the refresh is not processed and the refresh button in the console is disabled.
