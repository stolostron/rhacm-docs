...
For your {ocp} cluster, see link:https://docs.redhat.com/documentation/en-us/openshift_container_platform/4.15/html/release_notes/ocp-4-12-release-notes#ocp-4-15-known-issues) [{ocp-short} known issues]. 
