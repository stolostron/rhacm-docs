...
When application resources get updated in the hub cluster, the application page table also gets updated. If you have the menu of the application page table opened, then it gets closed with every update to the application page table. Because the menu can close often, it can be hard for you to click the menu. 
