...
* You can view the update risks that are present for your managed clusters by enabling the _Fleet_ switch. See, link:../observability/insights_intro.adoc#update-risks[Viewing update risk predictions]. 
