...
* You can now add or include template functions in configuration policies. See link:../risk_compliance/custom_template.adoc#customizing-templates-for-config-policies[Customizing templates for configuration policies].
