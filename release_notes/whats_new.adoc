...
* With the migration of multicluster-observability and submariner-addon out of the {product-title-short} installation, the _MultiClusterObservability_, _SubmarinerConfig_, and _SubmarinerDiagnoseConfig_ tabs are now removed from the Installed Operators page for {product-title-short} and moved to the {ocp-short} console page.
