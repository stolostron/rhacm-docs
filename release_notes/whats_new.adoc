...
* Grafana is updated to version 11.1.5 to make arbitrary and adhoc metric queries from the Grafana _Explore_ page. See link:../observability/design_grafana.adoc#using-grafana-dashboards[Using Grafana dashboards].
