...
* A new custom resource definition is added to the search feature, named `searches.search.open-cluster-management.io`. Further customize search, see link:../observability/search_intro.adoc#search-customization[Search customization and configurations] for more details.

* Optimize search by editing the PostGres database storage and configuration. See, link:../observability/search_intro.adoc#search-customization[Search customization and configurations].
