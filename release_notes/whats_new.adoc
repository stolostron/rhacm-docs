...
* You can now install gatekeeper with the Red Hat Advanced Cluster Management gatekeeper operator policy. See link:../security/gatekeeper_policy.adoc#gatekeeper-policy[Integrating gatekeeper operator policy].
