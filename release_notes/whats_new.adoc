...
//clearing what's new for 2.8 | MJ | 03/12/2023
//2.8 ACM-3011 | MJ | 03/12/2023
* You can now configure the Policy Generator to add a copy of meta data to replicas of your policies and policy sets, along with generate placement manifests for your policies and policy sets. See link:../governance/policy_generator.adoc#policy-gen-yaml-table[Policy Generator configuration reference table] for more details.
