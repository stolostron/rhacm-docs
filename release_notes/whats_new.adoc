...
* ClusterCurator now supports specifying an Ansible inventory to use for all jobs, and this should be available to {mce-short} users in the console as well.
