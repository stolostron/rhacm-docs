...
You can specify the secondary channel when you create an application, or afterwards. When you create the secondary channel, the application will use the secondary when the primary fails.
