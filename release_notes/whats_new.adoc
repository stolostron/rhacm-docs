...
* You can create and view _OpenShift_, _Flux_, and _Argo CD_ application types. An `ApplicationSet` represents Argo applications that are generated from the controller. See see link:../applications/app_console.adoc#console-overview[Console overview].
