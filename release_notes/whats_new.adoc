...
You can use {global-hub} with {product-title-short} backup and restore features. These features give you access to recovery solutions and basic resources. For more information, see link:../global_hub/global_hub_backup.adoc#global-hub-backup[Backup for {global-hub} (Technology Preview)].
