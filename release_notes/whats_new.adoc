...
* You can enable the _Fleet_ switch to view the update risks that are present for your managed clusters. See, link:../observability/insights_intro.adoc#update-risks[Viewing update risk predictions]. 
