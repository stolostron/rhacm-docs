...
* If you want to have your managed hub clusters to have `local-cluster` enabled, import that managed hub cluster in the hosted mode. See link:../global_hub/global_hub_import_hub_hosted.adoc#global-hub-importing-in-hosted-mode[Importing a managed hub cluster in the hosted mode (Technology Preview)]. 
