...
* As you directly apply policies on your managed clusters, you can now view the deployment of the policies from the _Discovered policies_ tab from the console. See link:../governance/deploy_pol_ext_tools.adoc#deploy-external-tools[Deploy policies with external tools].
