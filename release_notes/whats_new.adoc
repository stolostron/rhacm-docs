...
* Creates a default `ManagedClusterSet` for any managed clusters that are not specifically assigned to a `ManagedClusterSet`. See link:../clusters/managedclustersets.adoc#managedclustersets[Creating and managing ManagedClusterSets] for more information.
