...
* Use the `copyConfigMapData` and `copySecretData` functions to copy the data contents of a specific ConfigMap or secret. Read link:../governance/custom_template_functions.adoc#template-functions[Template functions] for more details.
