...
=== Observability
// what doc should the user be referenced to? Should we reference the Designing your Grafana dashboard section? 
* {product-title-short} supports {ocp-short} version 3.11 Grafana dashboards. See, link:../.../[] for more details.
