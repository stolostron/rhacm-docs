...
* You can now view the {ocp-virt} dashboard to see comprehensive insights for each cluster with the {ocp-virt-short} operator installed. See, link:../observability/use_observability.adocviewing-ocpvirt-dashboards[Viewing the {ocp-virt-short} dashboard].
