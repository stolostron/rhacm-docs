...
* You can now add or include custom template functions in configuration policies. See link:../risk_compliance/custom_template.adoc#support-custom-templates-in-config-policies[Support for custom templates in configuration policies] for more information.
