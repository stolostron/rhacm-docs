...
* You can add workers to single node {ocp-short} clusters. See link:../multicluster_engine/cluster_lifecycle/single_node_ocp.adoc#sno_add_worker[Add workers to a single node OpenShift cluster] for more details.
