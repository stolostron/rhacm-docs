...
* Create a managed cluster from the new {product-title-short} console on the Red Hat OpenStack Platform. See link:../clusters/create_openstack.adoc#creating-a-cluster-on-openstack[Creating a cluster on Red Hat OpenStack Platform] for more information.  
