...
* You can now add or include text templates in configuration policies. See link:../risk_compliance/custom_template.adoc#using-templates-in-config-policies[Using text templates in configuration policies].
