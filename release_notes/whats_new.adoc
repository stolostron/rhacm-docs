...
* You can use the `protect` function to secure sensitive data that is on your hub cluster policy template. See link:../governance/custom_template.adoc##protect-function[protect function] section for more information
