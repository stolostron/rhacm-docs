...
* You now receive the status flow for events from the _History_ column. For more information, see link:../governance/manage_policy_intro.adoc#grc-view[Governance page].
