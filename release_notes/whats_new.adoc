...
== Web console
//clearing what's new section for 2.8 | MJ | 03/13
...
Cluster lifecycle documentation is part of the {mce-short}, which is a software operator that enhances cluster fleet management. 
