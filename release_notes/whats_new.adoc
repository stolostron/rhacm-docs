...
Get an overview of Red Hat Advanced Cluster Management for Kubernetes from xref:../about/welcome.adoc[Welcome to Red Hat Advanced Cluster Management for Kubernetes].
See the xref:../about/architecture.adoc[Multicluster architecture] topic to learn more about major components of the product.

To learn about the Red Hat Advanced Cluster Management for Kubernetes console capabilities, see xref:../console/console.adoc[Observability in the console].
...
See xref:../install/install_connected.adoc[Installing while connected online] for more information.
...
For more information, see xref:../manage_applications/app_management_overview.adoc[Managing applications].
...
* xref:../security/cert_policy_ctrl.adoc[Certificate policy controller]
* xref:../security/config_policy_ctrl.adoc[Kubernetes configuration policy controller]
* xref:../security/iam_policy_ctrl.adoc[IAM policy controller]

See xref:../security/compliance_intro.adoc[Governance and risk] to learn more about the dashboard and the policy framework.

As you create policies, use the policy element, `templates` to describe how your resource is defined.
For more information about the policy elements, see xref:../security/policy_example.adoc[Policy overview].
