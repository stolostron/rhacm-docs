...
* The search API is now named `search-v2-operator`. See link:../observability/search_intro.adoc#search-in-the-console-intro[Search in the console introduction]
