...
//2.9:6449
* You can import multiple hub clusters and manage them with a single hub cluster. See link:../global_hub/global_hub_overview.adoc#multicluster-global-hub[Multicluster global hub] for more information. 
