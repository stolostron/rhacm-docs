...
* You can now receive information about potential problems in your clusters with Red Hat Insights. For more information, see link:../observability/insights_observability.adoc#integrate-rh-insights[Integrating observability with Red Hat insights].
