...
//2.9:6921(bug not a feature)
* You can view the timestamp for policy violations. For more details, see link:../governance/policy_ctrl_adv_config.adoc


//original request
//PolicyReports created by ACM for policy violations now use the timestamp from the NonCompliant policy in the PolicyReport results.

//should this entry be in the observability section? should the PolicyReports file be moved to Governance? 
