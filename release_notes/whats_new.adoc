...
You can receive policy violation details from your automation. See link:../governance/manage_policy.adoc#grc-automation-configuration[Governance automation configuration]
