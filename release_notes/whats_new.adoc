...
* Grafana component version is upgraded from version 8.1.3 to 8.5.20. Refer to link:../observability/verifying_observability.adoc#verifying-observability-version[Verifying observability version].
