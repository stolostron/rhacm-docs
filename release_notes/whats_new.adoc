...
* Use the search configurable collection to manage which Kubernetes resources you want to be collected by your hub cluster and managed clusters. For more details, see link:../observability/manage_search.adoc#search-configurable-collection[Search configurable collection].
