...
* Certificates for observability are now automatically renewed before expiration is met. For more information, see link:../observability/observe_environments_intro.adoc#observability-certificates[Observability certificates].
