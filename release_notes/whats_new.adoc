...
* The `search-v2-api` and `search_indexer` now expose metrics. Read link:../observability/search_intro.adoc#searching-in-the-console-intro[Searching in the console introduction]. 

For other topics for observability from the web console, see link:../observability/search_intro.adoc#[]
