...
You can optionally configure the Helm channel type to watch namespace-scoped resources so that any manual changes to those resources are reverted. See link:../applications/config_helm_watch.adoc[Configuring Helm to watch namespace resources].
