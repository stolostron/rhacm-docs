...
* You can now create, edit, and display descriptions for your policies using the `policy.open-cluster-management.io/description` annotation. Read link:../governance/create_policy.adoc#viewing-your-security-policy-from-the-console[Viewing your security policy from the console].
