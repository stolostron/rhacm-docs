...
* Creating and managing clusters in a bare metal environment with {product-title-short} is now supported as a generally available feature. See link:../manage_cluster/create_bare.adoc#creating-a-cluster-on-bare-metal[Creating a cluster on bare metal] for more information.
