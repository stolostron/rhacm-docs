...
* You can now enable the multicluster observability service (`multicluster-observability-operator`) to view the health and optimization of your managed clusters. You can explore the collected metric data and logs from your managed clusters. For more information see, link:../observability/observe_intro.adoc#observing-environments[Observing environments].
