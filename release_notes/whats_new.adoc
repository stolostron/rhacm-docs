...
* Create a policy set to group policies together. See link:../governance/policy_set.adoc#policy-set[Policy sets].

* Policy set generation is now supported for the policy generator. See link:../governance/policy_generator.adoc#policy-generator[]
