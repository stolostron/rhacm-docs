...
* You can now view the metadata of a root policy by using the `.PolicyMetadata` hub template variable. See the link:../governance/template_support_intro.adoc#template-coomparison-table[Comparison of hub cluster and managed cluster templates].
