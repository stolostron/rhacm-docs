...
* *Technology Preview:* Enable global search to find resources for your hub and managed clusters. See, link:../observability/manage_search.adoc#customizing-search-console[Customizing the search console].
