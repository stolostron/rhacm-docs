...
* The policy framework now supports activiating policy or policy templates using dependencies. See link../governance/policy_dependencies.adoc#policy-dependencies[Policy dependencies].
