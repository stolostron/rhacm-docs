...
* You can now add custom metrics to the observability service to be collected from managed clusters. For more information, see link:../observability/customize_observe.adoc#adding-custom-metrics[Customizing observability].
