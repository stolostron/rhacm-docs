...
With {prod-short} version 2.10 or later, {mce-short} installs the cluster backup and restore operator Helm chart and the `cluster-backup-chart`, allowing you to view more information about issues with your backup and restore components.
