...
After you select the *Create resource* button on the _Welcome_ page, you might receive an error message about an error that occurred when the resource was created.
