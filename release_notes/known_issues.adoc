...
When you upgrade a managed cluster on the *Cluster details* page, it might take up to 10 minutes after the upgrade process completes for the updated version number to display on the *Cluster details* page.
