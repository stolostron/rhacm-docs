...
Create or update a cluster role (`ClusterRole`) to add rules for the `cluster-manager-admin` role, in the `Ansible` resource. Your YAML might resemeble the following file: 
