...
=== Deprecated resources remain after upgrade to Errata versions
//2.6X: 26987

After you upgrade from 2.4.x to 2.5.x, and then to 2.6.x, the following deprecated resources in the managed cluster namespace might be left over. You need to manually delete these deprecated resources if version 2.6.x was upgraded from 2.4.x.
...
**Best practice:** Wait 30 minutes or more before you upgrade from version 2.5.x to version 2.6.x.
