...
Update the `BackupSchedule`, `veleroSchedule`, or `veleroTTL` values to start a new set of schedules. Then use the resulted backup for a restore, which is defined to lael the latest resources for the backup.
