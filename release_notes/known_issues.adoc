...
The observability add-on is not deployed to the managed cluster if the size of the manifest exceeds 50 thousand bytes. Only the local cluster appears in grafana after you deploy observability.
