...
Wait until the namespace automatically gets removed, which takes 5-10 minutes after you detach the cluster. Or, if the namespace is stuck in a terminating state, you will have to manually delete the namespace. Return to the page to see if the error resolved.
