...
// 2.6:25156
 ...
 When you create a HyperShift cluster with a cluster-wide proxy configuration on {ocp-short} 4.10.z, the `nodeip-configuration.service` service does not start on worker nodes.
