...
When booting a node (such as a virtual machine when using libvirt), you might receive the following error message in the console:

`no bootable devices`

To work around the issue, apply an infrastructure environment custom resource definition when using an assistsed installation to expose the `bootArtifacts`, which might resemble the following file:
...
status:
  ...
  bootArtifacts:
    initrd: https://assisted-image-service-multicluster-engine.apps.qe1.kni.lab.eng.bos.redhat.com/images/73450317-b378-4f77-a3d0-e6fd98e5aefb/pxe-initrd?api_key=eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCJ9.eyJpbmZyYV9lbnZfaWQiOiI3MzQ1MDMxNy1iMzc4LTRmNzctYTNkMC1lNmZkOThlNWFlZmIifQ.fLDph1ueGjXWQYyjWg9lPQ60mYvgQZN5KtFjRGUGdTCTEUbsWnu9A6FcnCMYVq3la3r7_ByZvWGyAvTK_M2g-g&arch=x86_64&version=4.11
    ipxeScript: https://assisted-service-multicluster-engine.apps.qe1.kni.lab.eng.bos.redhat.com/api/assisted-install/v2/infra-envs/73450317-b378-4f77-a3d0-e6fd98e5aefb/downloads/files?api_key=eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCJ9.eyJpbmZyYV9lbnZfaWQiOiI3MzQ1MDMxNy1iMzc4LTRmNzctYTNkMC1lNmZkOThlNWFlZmIifQ.O88mwk_WnztkmYSYmOIXwZ3fmNv_WeVmlWJm6_lZuoUaRymweFKv1TNdCurzG6pT5wtgBg7_UzV_-7d6LcyxuQ&file_name=ipxe-script
    kernel: https://assisted-image-service-multicluster-engine.apps.qe1.kni.lab.eng.bos.redhat.com/boot-artifacts/kernel?arch=x86_64&version=4.11
    rootfs: https://assisted-image-service-multicluster-engine.apps.qe1.kni.lab.eng.bos.redhat.com/boot-artifacts/rootfs?arch=x86_64&version=4.11
----

Copy the `ipxeScript` URL into your `libvirt.xml` file.
