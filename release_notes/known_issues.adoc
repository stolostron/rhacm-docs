...
=== Ansible Automation Platform early access version 2.0.0 job fail

When the Ansible Automation Platform (early access) operator 2.0.0 is installed, `AnsibleJobs` fails to execute. If you want to submit pre and post `AnsibleJobs` through {product-title-short}, use the Ansible Automation Platform Resource Operator 0.1.1.
