...
=== Ansible Automation Platform (early access) 2.0.0 and later job fail

When the Ansible Automation Platform (early access) 2.0.0 is installed, `AnsibleJobs` fails to run. If you want to submit prehook and posthook `AnsibleJobs` through {product-title-short}, use the Ansible Automation Platform (early access) 2.0.1+0.1635279521.
