...
After you upgrade from 2.3.1 to 2.3.2, some clusters might became degraded because the Observability add-on is not ready, or the image manifest ConfigMap is not read correctly during upgrade. which leads to an incorrect image.
