...
Wait until the namespace automatically gets removed, which takes about 5-10 minutes after you detach the cluster. Or to resolve, you can manually delete the namespace. Return to the page to see if the error resolved.
