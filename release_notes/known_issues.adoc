...
. Update the other components with this certificate, by downloading and running this script.
https://gist.github.com/cdoan1/79451b3d75a2f3f1b74b3622029d6989

5. Verify that all of the secrets from `oc get certificates.certmanager.k8s.io` have the ready state `True` by running the https://gist.github.com/cdoan1/79451b3d75a2f3f1b74b3622029d6989[`generate-update-issuer-cert-manifest.sh` script]. 