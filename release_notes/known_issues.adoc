...
* The placement information is not shown when you view the details of the policy.
* The placement information is not removed when the policy is deleted.
* When you edit the policy, the placement details are not updated. 
