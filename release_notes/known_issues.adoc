...
The configuration policy resources are automatically removed from the cluster and the CRD exits its terminating state. If the addon has already been reinstalled, the CRD is recreated automatically without a deletion timestamp.
