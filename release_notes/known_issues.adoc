...
[#dark-mode-not-supported]
=== Dark mode is not supported on {mce} version 2.0.x
//2.5.2:25554

While {mce} version 2.0.2, and later 2.0.x versions are supported on {ocp} version 4.11, dark mode is not supported on {mce} 2.0.x. Either disable dark mode in the settings, or upgrade to {mce} version 2.1 to enable dark mode.
...
=== Restored Hive managed clusters might be able to connect with the new hub cluster
//2.6:23930
