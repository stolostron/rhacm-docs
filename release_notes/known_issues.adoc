...
- If you remove a configuration policy from your hub cluster, the configuration policy remains on your managed cluster. A status is not provided.

To resolve this, disable your configuration and reenable it. You can also delete the entire policy.
