...
=== Links in create a credential to the documentation are broken
// 2.3.1:14984

The links to the documentation from the _Add credentials_ pages in the console are broken. The following table shows the correct links:
...
| Red Hat OpenShift Cluster Manager | https://access.redhat.com/documentation/en-us/red_hat_advanced_cluster_management_for_kubernetes/2.3/html/credentials/credentials#creating-a-credential-for-openshift-cluster-manager[How do I get the OpenShift Cluster Manager API Token?]
|=======
