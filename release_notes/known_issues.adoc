...
Add the following annotations to the `search-collector` custom resource to change the memory request and limit. In the following example, the request is set to `512Mi` and limit is set to `1024Mi`:
