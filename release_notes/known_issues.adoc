...
Submariner with the VXLAN cable driver is not supported with NAT enabled. Submariner with the VXLAN cable driver is currently only supported in non-NAT deployments.
