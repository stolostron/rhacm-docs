...
[#access-app-without-permission]
=== Accessing applications without permission 
// 2.0.0:4602

If you do not have the correct permissions assigned, you cannot view an application in the console. If you can click on the search link to view the application, you might receive an infinite loop or error. Check to see if you have the correct permissions to view the application.
