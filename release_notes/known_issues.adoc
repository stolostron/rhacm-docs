...
To see the correct number of nodes for the selected infrastructure provider, click on the total number of nodes in the summary card and check the related node count in the search results.
