...
After you create and save a bare metal asset, you can select the bare metal asset in the table and apply selected actions. After selecting a new bare metal asset on the Microsoft Azure provider, you might not see the available actions. Refresh your browser window to restore the actions to the beginning of the table.  
