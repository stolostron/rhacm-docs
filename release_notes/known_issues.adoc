...
. Update the value of `TTLAfterFinished` to `false` to disable the job cleanup feature. This update resembles the following example:
+
[source,yaml]
----
