...
To avoid this error, upgrade your {ocp-short} to version 4.8.18 or later, or 4.11.7 or later.
...
When you install the gatekeeper operator on {ocp} version 4.11, the installation fails. Before you upgrade {ocp-short} to version 4.11.0., you must upgrade the gatekeeper operator to version 0.2.0. See link:../governance/create_gatekeeper.adoc#upgrading-gatekeeper-gatekeeper-operator[Upgrading gatekeeper and the gatekeeper operator] for more information.
