...
[#show-all-link-does-not-work-search]
=== _Show all_ link does not work from the _Search_ page

//2.0.10:11862

When you select to launch your application resource in _Search_, the _Show all_ link is not functional from the _Search_ page. To work around this issue, update your filter by selecting the following options: related channel, related subscriptions, and related placement rule. 
