...
[#ipxe-script-not-reachable]
=== Client cannot reach iPXE script

When using iPXE, you receive the following error message when booting the infrastructure environment:

`No bootable devices`

To work around the issue, add the following section to the network DHCP block:

----
<dhcp>
      <range start='192.168.128.50' end='192.168.128.150'>
        <lease expiry='60' unit='minutes'/>
      </range>
      <host mac='52:54:00:DE:EA:E8' name='spoke-master-0-0' ip='192.168.128.77'/>
      <host mac='52:54:00:96:78:07' name='spoke-master-0-1' ip='192.168.128.141'/>
      <host mac='52:54:00:56:D1:8F' name='spoke-master-0-2' ip='192.168.128.74'/>
      <host mac='52:54:00:9E:70:13' name='spoke-worker-0-0' ip='192.168.128.120'/>
      <host mac='52:54:00:92:35:87' name='spoke-worker-0-1' ip='192.168.128.119'/>
      <bootp file='[http://assisted-service-multicluster-engine.apps.ocp-edge-cluster-0.qe.lab.redhat.com/api/assisted-install/v2/infra-envs/748e75bf-7610-4667-b4b7-f8e4d9f61305/downloads/files?api_key=eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCJ9.eyJpbmZyYV9lbnZfaWQiOiI3NDhlNzViZi03NjEwLTQ2NjctYjRiNy1mOGU0ZDlmNjEzMDUifQ.yzEeJnT06F8uWtltNes1DpYVOPfusjol_-_NjN4GiilbNLHCNIK5lwQvdRmdbDLjeQsB6sq0mudb9cEb4SLScg&amp;file_name=ipxe-script'/](http://assisted-service-multicluster-engine.apps.ocp-edge-cluster-0.qe.lab.redhat.com/api/assisted-install/v2/infra-envs/748e75bf-7610-4667-b4b7-f8e4d9f61305/downloads/files?api_key=eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCJ9.eyJpbmZyYV9lbnZfaWQiOiI3NDhlNzViZi03NjEwLTQ2NjctYjRiNy1mOGU0ZDlmNjEzMDUifQ.yzEeJnT06F8uWtltNes1DpYVOPfusjol_-_NjN4GiilbNLHCNIK5lwQvdRmdbDLjeQsB6sq0mudb9cEb4SLScg&amp;file_name=ipxe-script%27/)>
    </dhcp>
----
