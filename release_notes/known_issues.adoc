...
The configuration policy resources are automatically removed from the cluster and the CRD will exit its terminating state. If the addon has already been re-installed, the CRD will be recreated automatically without a deletion timestamp.
