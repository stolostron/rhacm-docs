...
status:
  ...
  bootArtifacts:
    initrd: https://assisted-image-service-multicluster-engine.apps.qe1.kni.lab.eng.bos.redhat.com/images/000000/000?api_key=000&version=4.11
    ipxeScript: https://assisted-service-multicluster-engine.apps.qe1.kni.lab.eng.bos.redhat.com/api/assisted-install/v2/infra-envs/00000/downloads/files?api_key=0000&file_name=ipxe-script
    kernel: https://assisted-image-service-multicluster-engine.apps.redhat.com/boot-artifacts/kernel?arch=x86_64&version=4.11
    rootfs: https://assisted-image-service-multicluster-engine.apps.redhat.com/boot-artifacts/rootfs?arch=x86_64&version=4.11
----
