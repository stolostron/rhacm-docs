...
=== Error when using integrations with {aap} Operator
//2.7:27113

If you use integrations that depend on the {aap-short} Operator and you do not have permissions to view installed Operators on the {ocp} cluster, you might see an error message that resembles the following:
...
You can safely ignore the warning if you confirm with your system administrator that the Operator is installed.
