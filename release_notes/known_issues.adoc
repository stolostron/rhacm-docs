...
This occurs because a URL query parameter must be passed through the Thanos Query console, to perform additional queries for other downsampling levels when data is missing.
