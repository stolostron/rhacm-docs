...
When you use the Safari web browser, the YAML file is not displayed from the _Search_ page. See link:../install/requirements.adoc#supported-browser[Supported browsers] for other supported browsers.
