...
[#submariner-ovn-k8]
=== OVNKubernetes support limitations
//2.6:25275

Using the OVNKubernetes CNI network provider requires Red Hat OpenShift 4.11 or later. OVNKubernetes does not support Globalnet.