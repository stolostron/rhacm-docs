...
After you upgrade from 2.4.x to 2.5.x, and then to 2.6.x, the following deprecated resources in the managed cluster namespace might remain. You need to manually delete these deprecated resources if version 2.6.x was upgraded from 2.4.x:
