...
The length if cluster names for Microsoft Azure deployments must be 13 characters or fewer. The length of Microsoft Azure managed cluster set names must be 20 characters or fewer.
