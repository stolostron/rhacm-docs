...
[#upgrade-210-231-error]
=== Upgrade from version 2.1.x to 2.3.2 degraded due to the Observability add-on
// 2.1: 16250
...
[#mco-default-name]
=== Observability not working due to _MultiClusterObservability_ CR name
