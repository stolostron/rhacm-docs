...
* Fixes {acm-short} support for SiteConfig Operator `--http2-disable` parameter in the upstream `kube-rbac-proxy` image within the deployment manifest. (link:https://issues.redhat.com/browse/ACM-19035[ACM-19035])