...
== Upgrading an existing {acm-short} cluster with {ocp-short} 4.18 creates an error installing CRD
//2.12:19151

When you upgrade an existing {acm-short} 2.12 cluster with {ocp-short} 4.18, your upgrade fails with an error from installing the Observability component on your `MultiClusterHub` custom resource instance.

*Note:* This is only applicable for versions earlier than {acm-short} 2.12.2. If you upgrade directly to {acm-short} 2.12.2, you do not receive this error. If you install {acm-short} 2.12 with {ocp-short} 4.18 for the first time, you do not receive this error. 
