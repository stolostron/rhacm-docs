...
[#upgrade-stuck]
== Upgrading an existing {acm-short} cluster with {ocp-short} 4.18 creates an error stuck in `upgrading` status while installing the CRD 
//2.13:19151
...
To resolve this issue, upgrade directly to {acm-short} 2.13.2, even if you if you upgraded to 2.13.1 and receive this error.
