...
== Upgrading an existing {acm-short} with {ocp-short} 4.18 creates an error installing a CRD
//2.13:19151

If you upgrade an existing {acm-short} installation with {ocp-short} 4.18, your upgrade fails with an error from installing a CRD. If you install {acm-short) 2.13 with {ocp-short} 4.18 for the first time, you do not receive this error.
