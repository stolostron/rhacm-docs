...
[#upgrade-stuck]
== Upgrading an existing {acm-short} cluster with {ocp-short} 4.18 creates errors
//2.13:19151

When you upgrade to {acm-short} 2.13 with an {ocp-short} version 4.18 cluster, you receive errors and remain in a `stuck` status. 

Upgrade to 2.13.2 to resolve these issues.

[#observability-upgrade-issue]
== Upgrading an existing {acm-short} cluster with {ocp-short} 4.18 creates an error installing Observability CRD
//2.13:19151
...
- To resolve this error, upgrade directly to {acm-short} 2.13.2.

- If you upgraded to 2.13.1 and receive this error, upgrade to 2.13.2.

- If you install {acm-short} 2.13 with {ocp-short} 4.18 for the first time, you do not receive this error. 
...
----
//please confirm if we need this and all the content after.
...
oc get multiclusterhubs -n open-cluster-management -o yaml
----
//please confirm if we need this and the content after.
+
