...
If you upgrade an existing {acm-short} 2.12 cluster with {ocp-short} 4.18, your upgrade fails with an error from installing the Observability component on your `MultiClusterHub` custom resource instance.

*Note:* If you upgrade directly to 2.12.2, you don't receive this error. If you install {acm-short} 2.12 with {ocp-short} 4.18 for the first time, you do not receive this error. 
