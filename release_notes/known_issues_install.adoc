...
----
+
The following error message about a failed installation of `multiclusterobservabilities.observability.open-cluster-management.io` is displayed from your hub cluster:
