...
Learn about the current {acm-short} release. 
...
For full support information, see the link:https://access.redhat.com/articles/7027073[Support matrix] and the link:https://access.redhat.com/support/policy/updates/advanced-cluster-management[Lifecycle and update policies for {acm}].