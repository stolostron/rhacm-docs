...
*End of maintenance support:* {acm-short} 2.11 and {mce-short} 2.6 are no longer in full or maintenance support. The documentation might remain available, but without any updates.

*Deprecated:* {acm-short} 2.10 and earlier versions are no longer supported. The documentation might remain available, but without any Errata or other updates.
