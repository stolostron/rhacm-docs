...
*Deprecated:* The 2.7 and earlier versions of {product-title-short} are no longer supported. Documentation for versions 2.7 and earlier are not updated. The documentation might remain available, but without any Errata or other updates available.
