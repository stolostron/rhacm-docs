...
The 2.5 and earlier versions of {product-title-short} are _removed_ and no longer supported. The documentation might remain available, but is deprecated without any Errata or other updates available. 
