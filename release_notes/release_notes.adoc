...
The 2.2 and earlier version of {product-title-short} is _removed_ and no longer supported. Documentation for versions 2.2 are not updated. The documentation might remain available, but is deprecated without any Errata or other updates available. 
