...
*Important:* 
  ...
  - The 2.4 and earlier versions of {product-title-short} are _removed_ and no longer supported. The documentation might remain available, but is deprecated without any Errata or other updates available.
