...
| Placements
| The `v1alpha1` API is upgraded from `v1alpha1` to `v1beta1` because `v1alpha1` is deprecated. 
| 2.5 
| Use `v1beta1`. 
...
| PlacementDecisions
| The `v1alpha1` API is upgraded from `v1alpha1` to `v1beta1`, `v1alpha1` is deprecated. 
| 2.5 
| Use `v1beta1`. 
| None
