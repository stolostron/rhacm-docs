...
| Gatekeeper operator
| 2.8
| Install Gatekeeper by using the gatekeeper image with Helm.
| See link:../governance/create_gatekeeper.adoc#gatekeeper-policy-with-helm[Installing Gatekeeper by using Helm]
