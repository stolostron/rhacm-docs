...
| 2.7
| Integrity shield can continue to be used as a community-provided signing solution. For more details, see the Kyverno documentation, link:https://kyverno.io/policies/other/verify_manifest_integrity/verify-manifest-integrity/[Verify Manifest Integrity]
|===
