...
*Deprecated:* Documentation for {acm-short} 2.12 and earlier versions is no longer supported. The documentation might remain available, but without any Errata or other updates.
