...
. Specify a fixed cluster set in the placement rule. See the following example:
...
. Delete the remaining `appliedmanifestwork` manually by running the following command:
