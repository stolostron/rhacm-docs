...
| The support for the deprecated custom resource definition `v1beta1` APIs is removed. The `v1beta1` APIs were only needed for {ocp-short} 3.11. The import command for {ocp-short} 3.11 is no longer displayed.
