...
| 2.17
| Migrate to the {gitops} add-on with the advanced pull model (Argo CD Agent).
| See xref:../gitops/gitops_addon_with_argocd.adoc#enable-gitops-addon-with-argocd[Enabling {gitops} add-on with Argo CD Agent (Technology Preview)].
|===
