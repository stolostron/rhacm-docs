...
| 2.14
| Upgrade to a supported version of {ocp-short}. See the link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.15[{ocp-short} documentation].
