...
| 2.15
| On {ocp} version 4.20, install OpenShift Virtualization 4.20 to work with virtual machines across your fleet from the Fleet Virtualization perspective. Alternatively, use Search to find and take actions on VMs.
| None
