...
For more information, see the link:../business_continuity/backup_restore/backup_restore_cleanup.adoc#clean-hub-restore[Cleaning the hub cluster after restore] topic. 
