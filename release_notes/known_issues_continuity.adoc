...
For more information, see the link:../business_continuity/backup_restore/backup_restore_reference.adoc#clean-hub-restore[Cleaning the hub cluster after restore] topic. 
