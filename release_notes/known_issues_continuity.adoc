...
To learn more about using this backup label to back up generic resources, see xref:../business_continuity/backup_restore/backup_arch.adoc#backed-up-resources[Resources that are backed up]. 
