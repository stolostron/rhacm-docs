...
[#limited-support-ocp]
=== Backup and restore in {acm-short} 2.10.4 has limited support with {ocp-short} 4.13
//2.10:ACM-13028

{acm-short} 2.10.4 uses OpenShift APIs for Data Protection (OADP) 1.4, which has limited support for {ocp-short} 4.13. To use the supported backup and restore function, move to {ocp-short} 4.14 or later when you use {acm} 2.10.4.  
