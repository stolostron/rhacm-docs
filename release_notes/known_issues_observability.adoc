...
+
Check the role permissions and update appropriately. See link:../secure_clusters/rbac.adoc#role-based-access-control[Role-based access control] for more information. 

link:https://issues.redhat.com/browse/ACM-5625[ACM-5625]
//double check this one? Could also be something that was in GH (https://github.com/stolostron/backlog/issues/5625) -bcs 11/18/25
...
//there is a comment (very old) on this GH issue that says this is fixed in 2.4.1?? -bcs 11/18/25--please check
...
Re-create the instance with the following command:

----
./setup-grafana-dev.sh --deploy
----

link:https://github.com/stolostron/backlog/issues/25815[ACM-25815]
//this is very old - is it still valid? -bcs 11/18/25
...
link:https://issues.redhat.com/browse/ACM-4942[ACM-4942]
...
link:https://issues.redhat.com/browse/ACM-4806[ACM-4806]
...
link:https://issues.redhat.com/browse/ACM-8488[ACM-8488]
