...
For {product-title-short} 2.11, the down sampling levels has a default retention of 365 days (365d). This 365d default retention means there is now a 1 hour resolution retention, but earlier, the resolution retention was set to 0, meaning it was indefinite. If you did not set an explicit value for the resolution retention in your `MultiClusterObservability` `spec.advanced.retentionConfig`, then this new default retention applies to you.
