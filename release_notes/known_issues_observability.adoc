...
When you use the FQDN and or protocol for the `endpoint` parameter, your observability pods are not enabled. The following error message is displayed:
...
Your `endpoint` value must resemble the following URL for your secrets:
