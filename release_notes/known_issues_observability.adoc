...
Metrics from an {ocp-short} 3.11 managed cluster (deprecated) are not displayed from the hub cluster because the metrics are not collected from your {product-title-short} hub cluster.
