...
Starting with {product-title-short} 2.9, you must use a label in your defined {product-title-short} hub cluster namespace. The label, `openshift.io/cluster-monitoring: "true"` causes the Cluster Monitoring Operator to remove your hub cluster namespace.
