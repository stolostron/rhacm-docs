...
- For more details about architectures that are supported by {ocp-short}, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.12/html-single/release_notes/index[{cop-short} 4.12 release notes].