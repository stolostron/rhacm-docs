...
You must deploy your managed clusters from a FIPS-ready hub cluster. You must set the `fips:` parameter to `true` in your {ocp-short} managed cluster. 
//is the created part important? 
