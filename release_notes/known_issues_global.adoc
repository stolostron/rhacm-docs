...
When you upgrade {global-hub} 1.3.x to 1.4.x, the kafka and zookeeper related PVC still remains. After the upgrade, you can manually delete the PVCs of the {global-hub} 1.3.x version. The PVCs of the {global-hub} 1.4.x version should resemble the following: 
