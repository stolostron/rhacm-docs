...
[#global-search-known-issues]
== The Global Search known issues

If your {mce-short} installed into the customized namespace, the global search can not be enabled due to the search operator failed to add the globalSearchFeatureFlag.