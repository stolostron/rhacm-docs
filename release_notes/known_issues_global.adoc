...
If you installed your {mce-short} into a customized namespace, then you cannot enable the {global-hub} search, because in this case, the search operator failed to add the `globalSearchFeatureFlag`. 
