...
If your original {global-hub} cluster crashes, and you create a new one, you might have the following issues:
...
* If hte cron job does not run, then you must manually execute the cron job. 
