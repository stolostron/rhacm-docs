...
Review the known issues for the {global-hub} Operator. The following list contains known issues for this release, or known issues that continued from the previous release. For your {ocp-short} cluster, see link:https://docs.redhat.com/documentation/en-us/openshift_container_platform/4.16/html/release_notes/#ocp-4-15-known-issues[{ocp-short} known issues].


[#kafa-zookeeper-PVC-remains]
== The kafka and zookeeper related persistent volume claim (PVC) remains even after upgrading {global-hub} 
//2.13:16545

When you upgrade {global-hub} 1.3.x to 1.4.x, the kafka and zookeeper related PVC still remains. After the upgrade, you can manually delete the PVCs of the {global-hub} 1.3.x version. The PVCs of the {global-hub} 1.4.x version might resemble the following: 
