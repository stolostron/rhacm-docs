...
* xref:../search/customize_search_service.adoc#custom-search-console[Customizing the Search service]
* xref:../search/customize_console_search.adoc#custom-search-console[Customizing the console for Search]
