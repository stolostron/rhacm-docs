...
* xref:../search/search_mcp_intro.adoc#search-mcp-intro[{mcp-short} overview (Technology Preview)]
* xref:../search/install_search_mcp.adoc#install-search-mcp[Installing the {mcp-short} (Technology Preview)]
* xref:../search/enable_search_mcp_lightspeed.adoc#enable-search-mcp-lightspeed[Enabling the {mcp-short} with {lightspeed-short} (Technology Preview)]
* xref:../search/enable_search_mcp_claude.adoc#enable-search-mcp-claude[Enabling the {mcp-short} with Claude Code (Technology Preview)]
