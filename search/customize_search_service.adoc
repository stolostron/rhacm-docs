...
For help to configure persistent storage, see link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.19/html/monitoring/configuring-core-platform-monitoring#configuring-persistent-storage_storing-and-recording-data[Configuring persistent storage] in the {ocp-short} documentation