...
There are advanced restore options defined by the `velero.io.restore` specification. You can use these advanced restore options to filter out resources you want to restore. 
