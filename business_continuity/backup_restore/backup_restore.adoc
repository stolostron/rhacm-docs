...
In a disaster recovery scenario, when you restore the backup to the passive hub cluster, you want a hub cluster identical with the one that went down in the disaster. You do not want any other user resources, such as: applications, policies, and extra managed clusters. 
