...
Backup collisions might occur in the following situations:

* If the hub cluster changes status from a passive to primary hub cluster, or from a primary to passive hub cluster.
* If different hub clusters back up data at the same storage location.
