...
- If you restored the passive resources as a one time operation, or did not restore any resources yet, restore all resources as specified in xref:../backup_restore/backup_restore_all.adoc[Restoring all resources].
