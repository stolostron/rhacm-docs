...
+
For a definition of the `BackupCollision`, see xref:../backup_restore/backup_schedule_prevent_collisions.adoc#prevent-backup-collision[Preventing backup collisions].
