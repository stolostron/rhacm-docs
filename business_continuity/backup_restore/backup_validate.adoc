...
+
For a definition of the `BackupCollision`, see xref:../backup_restore/backup_schedule_prevent_collisions.adoc[Preventing backup collisions].
...
* xref:../backup_restore/backup_validate_encryption.adoc[Protecting data using server-side encryption]
