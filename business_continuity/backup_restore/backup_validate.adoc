...
= Backup and restore configuration validation
...
+
For a definition of the `BackupCollision`, see _Preventing backup collisions_.
...
* xref:../backup_restore/backup_validate_encryption.adoc#protecting-data-using-server-side-encryption[Server-side encryption protection]
