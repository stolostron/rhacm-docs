...
+
For a definition of the `BackupCollision`, see _Prevent backup collisions_.
...
* xref:../backup_restore/backup_validate_encryption.adoc[Server-side encryption protection]
