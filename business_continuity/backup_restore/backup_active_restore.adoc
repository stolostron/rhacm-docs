...
* <<keep-hub-active-restore-observability,Preparing the observability component>>
...
[#keep-hub-active-restore-observability]
== Preparing the observability component

If you have the observability component enabled on your primary hub cluster, you must disable the component before you run the restore operation. You cannot simultaneously have the primary hub cluster and the restore operation taking data from the observability component. 

To disable the observability component, go to your primary hub cluster and delete the observability custom resource. 
