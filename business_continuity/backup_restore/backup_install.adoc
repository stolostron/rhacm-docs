...
For a list of supported storage providers for Velero, see link:https://github.com/vmware-tanzu/velero/blob/main/site/content/docs/main/supported-providers.md[S3-Compatible object store providers].
