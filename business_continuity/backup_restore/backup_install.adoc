...
[role="_abstract"]
The cluster backup and restore operator is not installed automatically. Install and enable the operator, by completing the following sections:
...
== Creating a _DataProtectionApplication_ resource 
