...
To learn more about installing the OADP operator with the STS option, see link:https://docs.redhat.com/en/documentation/red_hat_openshift_service_on_aws/4/html-single/backup_and_restore/index#installing-oadp-rosa-sts_oadp-rosa-backing-up-applications[Installing the OADP Operator and providing the IAM role]. 
