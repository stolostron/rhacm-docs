...
* xref:../backup_restore/backup_restore_operations.adoc[Restoring passive resources while checking for backups]

* xref:../backup_restore/backup_restore_operations.adoc[Restoring passive resources]

* xref:../backup_restore/backup_restore_operations.adoc#restore-backup-all[Restoring all resources]
