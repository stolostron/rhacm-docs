...
[role="_abstract"]
Configure an active-passive hub cluster configuration, where the initial hub cluster backs up data and the passive hub clusters control the managed clusters when the active cluster becomes unavailable. 
...
* xref:../backup_restore/backup_restore_passive.adoc#restore-passive-resources[Restoring passive resources]
* xref:../backup_restore/backup_restore_activation.adoc#restore-all-resources[Restoring all resources]
