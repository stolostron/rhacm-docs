...
*Note:* To backup the primary hub data, you do not need an `active-passive` configuration. You can simply backup and store the hub data. This way, if there is an issue or failure, you can deploy a new hub and restore your primary hub data on this new hub. To reduce the time to recover the primary hub data, you can use an `active passive` configuration; however, it is not a necessity.                                                        
