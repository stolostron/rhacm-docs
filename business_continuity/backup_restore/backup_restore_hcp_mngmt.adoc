...
. Verify discovery and auto-import policies are restored. See link:../../mce_acm_integration/acm_hosted_cluster/acm_discover_hosted.adoc#discover-hosted-acm[Discover {mce-short} hosted clusters in {acm-short}]
