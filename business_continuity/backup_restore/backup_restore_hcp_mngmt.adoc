...
Follow link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.19/html/hosted_control_planes/high-availability-for-hosted-control-planes#hcp-disaster-recovery-oadp[OpenShift Hosted Control Plane Disaster Recovery documentation].
...
. Verify discovery and auto-import policies are restored. See link:../../mce_acm_integration/acm_hosted_cluster/acm_discover_hosted_prep.adoc#discover-hosted-acm[Prepare to discover {mce-short} hosted clusters in {acm-short}]
