...
. Recover your hosted cluster. Hosted clusters require a separate recovery by using individual backup procedures. The {acm-short} hub cluster automatically rediscovers clusters after the APIs become available. See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.19/html/hosted_control_planes/high-availability-for-hosted-control-planes[OpenShift Hosted Control Plane Disaster Recovery documentation].
