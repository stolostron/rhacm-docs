...
Follow link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.20/html/hosted_control_planes/high-availability-for-hosted-control-planes#hcp-disaster-recovery-oadp[OpenShift Hosted Control Plane Disaster Recovery documentation].
...
. Verify discovery and auto-import policies are restored. See link:../../mce_acm_integration/discover_hosted/acm_discover_hosted.adoc#discover-hosted-acm[Discovering {mce-short} hosted clusters in {acm-short}]
...
For more information about {hcp}, see link:../about/mce_hcp_overview.adoc#mce-hcp-overview[About hosted control planes with {mce-short}].