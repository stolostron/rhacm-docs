...
- Refer to the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.13/html/backup_and_restore/application-backup-and-restore#default-velero-cloud-provider-plugins[Default Velero cloud provider links] topic in the {ocp} documentation to learn more about the `DataProtectionApplication` parameters.
