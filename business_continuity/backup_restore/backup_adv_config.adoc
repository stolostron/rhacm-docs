...
- Refer to the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.13/html/backup_and_restore/application-backup-and-restore#oadp-setting-resource-limits-and-requests_installing-oadp-aws[Setting Velero CPU and memory resource allocations] topic in the {ocp} documentation to find out more about the `DataProtectionApplication` parameters.
