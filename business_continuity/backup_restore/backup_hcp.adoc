...
* Hosted cluster backup
    ...
    - Implementation: Follow link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.20/html/hosted_control_planes/high-availability-for-hosted-control-planes[OpenShift Hosted Control Plane Disaster Recovery documentation].
...
Continue to the xref:../backup_restore/backup_restore_hcp_mngmt.adoc[Restoring {hcp} management configuration] for detailed steps on restoring hosted clusters managed by {acm-short}.
