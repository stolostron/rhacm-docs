...
Continue to the xref:../backup_restore/backup_restore_hcp_mngmt.adoc#restore-hcp[Restoring {hcp} management configuration] for detailed steps on restoring hosted clusters managed by {acm-short}.
