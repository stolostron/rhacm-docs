...
To prepare the primary hub cluster to stay active during the restore process, complete the following task, xref:../backup_restore/backup_active_restore.adoc[Running the restore operation while the primary hub cluster is active]. 
