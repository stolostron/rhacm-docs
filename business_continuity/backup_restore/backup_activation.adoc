...
- See xref:../business_continuity/backup_restore/backup_schedule.adoc#using-backup-restore[Scheduling and restoring backups].

- See xref:../business_continuity/backup_restore/backup_restore.adoc#primary-cluster-shut-down[Shutting down the primary cluster].
