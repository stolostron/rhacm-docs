[#backup-restore-obs]
= Backing up and restoring the observability service
...
* Ensure that you can run a restore operation for backup types by completing the xref:../backup_restore/backup_restore_types.adoc#restoring-backup-restore-operation[Restore operation for backup types] process.
