...
- Ensure that you can run a restore operation for backup types by completing the xref:../backup_restore/backup_restore_types.adoc#restoring-backup-restore-operation[Using the restore operation for backup types] process.
