...
[#backup-restore-obs]
= Back up and restore the observability service
...
* Ensure that you can run a restore operation for backup types by completing the xref:../backup_restore/backup_restore_types.adoc[Restore operation for backup types] process.
