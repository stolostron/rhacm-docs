...
- Ensure that you can run a restore operation for backup types by reviewing xref:../backup_restore/backup_restore_types.adoc[Restore operation and backup types].
