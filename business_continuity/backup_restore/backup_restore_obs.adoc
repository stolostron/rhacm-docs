...
[#backup-restore-obs]
= Back up and restoring observability service
...
* Ensure that you can run a restore operation for backup types by completing the xref:../backup_restore/backup_restore_types.adoc[Using the restore operation for backup types] process.
