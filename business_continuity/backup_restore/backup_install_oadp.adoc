...
- For a list of supported storage providers for Velero, see About installing OADP from the _Additional resources_ section.

.Additional resources

* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.19/html/backup_and_restore/oadp-application-backup-and-restore#about-installing-oadp[About installing OADP]
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.19/html/backup_and_restore/oadp-application-backup-and-restore#oadp-rosa-backing-up-and-cleaning[Backing up workload on OADP ROSA, with an optional backup]
