...
[role="_abstract"]
If the OADP operator is not automatically installed after you enable the backup and restore operator, manually install the OADP operator. To learn how to install OADP, see _Installing the OADP Operator_ in the {ocp-short} documentation.
