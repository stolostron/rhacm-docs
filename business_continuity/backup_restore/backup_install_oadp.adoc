...
[role="_abstract"]
If the OADP operator is not automatically installed after you enable the backup and restore operator, manually install the OADP operator. To learn how to install OADP, see https://docs.redhat.com/en/documentation/openshift_container_platform/4.20/html/backup_and_restore/oadp-application-backup-and-restore#installing-operator-oadp_installing-oadp-operator[Installing the OADP Operator] in the {ocp-short} documentation.
