...
* For more details about the `backup-restore-enabled` policy templates, see _Backup and restore configuration validation_ in the _Additional resources_ section.

.Additional resources

* xref:../backup_restore/backup_validate.adoc[Backup and restore configuration validation]
* xref:../backup_restore/backup_restore_passive.adoc[Restore passive resources while checking for backups]
* xref:../backup_restore/backup_restore_passive.adoc#restore-passive-resources-check-backups[Restore passive resources]
* xref:../backup_restore/backup_restore_activation.adoc#restore-activation-resources[Restore all resources]