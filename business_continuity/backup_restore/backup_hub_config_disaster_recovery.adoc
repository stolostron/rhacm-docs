...
* For more details about the `backup-restore-enabled` policy templates, see _Validating your backup or restore configurations_ in the _Additional resources_ section.
