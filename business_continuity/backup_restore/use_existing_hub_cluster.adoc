...
If you use an existing hub cluster as a restore hub cluster with resources that you created before the restore operation, review the following constraints:
