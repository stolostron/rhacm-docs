...
The `backupschedule.cluster.open-cluster-management.io` resource creates a set of 4 `schedule.velero.io` resources. These `schedule.velero.io` resources generate the backup files. 
