...
- Resources with a backup by the `acm-resources-generic-schedule` are restored when the passive resources are restored. For more information on restoring passive resource, see link:https://access.redhat.com/documentation/en-us/red_hat_advanced_cluster_management_for_kubernetes/2.8/html/business_continuity/business-cont-overview#restore-passive-resources-check-backups[restoring passive resources]. 