...
To reconnect imported clusters on the new hub cluster during a restore operation, enable the automatic import feature on the `BackupSchedule`. For more information, see xref:../backup_restore/backup_msa_enable.adoc[Enable automatic import].
