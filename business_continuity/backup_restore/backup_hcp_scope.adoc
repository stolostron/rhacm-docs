...
* {acm-short} hub cluster backup
    ...
    - Scope: {acm-short} resources, policies, applications, and add-on configurations
...
* Hosted cluster backup
    ...
    - Implementation: See the _OpenShift Hosted Control Plane Disaster Recovery documentation_ from the _Additional resources_ section.

* {mce-short} hosting cluster backup
