...
You can install VolSync as a deployment on the `volsync-system` namespace on the managed cluster. Doing this provides support for non-OpenShift managed clusters. 
