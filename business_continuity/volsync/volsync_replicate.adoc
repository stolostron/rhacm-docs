...
Depending on what version of {product-title-short} you use, you might need to update your VolySync version. To update VolSync `ManagedClusterAddOn` resource, complete the following steps: 
