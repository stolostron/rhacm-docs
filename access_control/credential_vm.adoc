...
You can create a cluster that uses this credential by completing the steps in xref:../clusters/create_vm.adoc#creating-a-cluster-on-vmware-vsphere[Creating a cluster on VMware vSphere].
