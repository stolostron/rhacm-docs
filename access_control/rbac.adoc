...
//To create and administer all applications:
//* Create a namespace role binding to the cluster role open-cluster-management:app-manager-admin by entering the following command: oc create clusterrolebinding <role-binding-name> --clusterrole=open-cluster-management:app-manager-admin
// This role is a super user, which has access to all application resources and actions
...
//To view policies in a specific namespace run the following command:
