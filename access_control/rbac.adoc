...
To view the observability metrics for a managed cluster, you must have `view` access to that managed cluster on the hubb cluster. View the following list of observability features:
