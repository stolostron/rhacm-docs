...
| manageclusters.view.open-cluster-management.io
| read
| read
| read

| managedclusters.clusterview.open-cluster-management.io
| read, list
| read, list
| read, list

| manageclusters.register.open-cluster-management.io/accept
| update
| update
| 
...
| manageclustersets.view.open-cluster-management.io
| read
| read
| read
