...
If your pods do not start after you install the {mce}, it is likely that {mce} was previously installed, and not all of the pieces were removed before you attempted this installation. 
