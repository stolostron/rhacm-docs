...
If you have an existing cluster that you want to import, see xref:../multicluster_engine/import.adoc#importing-a-target-managed-cluster-to-the-hub-cluster[Importing a target managed cluster to the hub cluster] for those steps.
