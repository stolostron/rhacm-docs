...
----
+
**Deprecated:** Set the following parameter in the `HypershiftDeployment` custom resource when creating a cluster:
+
[source,yaml]
----
spec:
...
== Deploying a hosted cluster (Deprecated)
...
== Deploying a customized hosted cluster (Deprecated)
...
- **Deprecated:** `kubeconfig` secret: `<hypershiftDeployment.Spec.hostingNamespace>-<hypershiftDeployment.Name>-admin-kubeconfig` (clusters-hypershift-demo-admin-kubeconfig)
- **Deprecated:** `kubeadmin` password secret: `<hypershiftDeployment.Spec.hostingNamespace>-<hypershiftDeployment.Name>-kubeadmin-password` (clusters-hypershift-demo-kubeadmin-password)
