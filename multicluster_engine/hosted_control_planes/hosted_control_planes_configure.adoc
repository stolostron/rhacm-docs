...
. Create a namespace and an operator group by entering this command:
+
[source,yaml]
----
apiVersion: v1
...
. Create a subscription to the SR-IOV Operator by entering this command:
+
[source,yaml]
----
...
. To verify that the SR-IOV Operator is ready, enter this command:
+
[source,yaml]
----
...
. To verify that the SR-IOV pods are showing up, enter this command:
+
[source,yaml]
----
