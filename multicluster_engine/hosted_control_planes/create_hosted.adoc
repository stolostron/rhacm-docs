...
Maybe say you need to follow configure topic first

[#create-hosted]
== Creating a hosted control plane cluster with the console
...
After setting up the HyperShift binary and enabling your chosen cluster as the hosting cluster, you can deploy a hosted cluster on AWS by completing the following steps:
