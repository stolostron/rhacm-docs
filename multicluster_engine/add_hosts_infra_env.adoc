...
. If you select *With BMC form* option, complete the following steps:
+
...
. If you select *By uploading a YAML* option, complete the following steps:
+
*Note:* The YAML option allows you to upload multiople hosts at once.
