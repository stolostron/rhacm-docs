...
|**spec** +
__required__|The specification of the `ManagedServiceAccount`. |<<_mce-docs_apis_managedserviceaccount_jsonmanagedserviceaccount_spec,spec>>
|===

[[_mce-docs_apis_managedserviceaccount_jsonmanagedserviceaccount_spec]]
**spec**
