...
See xref:../api/placement.json.adoc[Placements API] to know more details about the API.
...
See xref:../api/placementdecision.json.adoc[PlacementDecisions API] to know more details about the API.
