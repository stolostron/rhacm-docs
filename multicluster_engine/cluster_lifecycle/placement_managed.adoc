...
See xref:../apis/placement.json.adoc[Placements API] to know more details about the API.
...
See xref:../apis/placementdecision.json.adoc[PlacementDecisions API] to know more details about the API.
