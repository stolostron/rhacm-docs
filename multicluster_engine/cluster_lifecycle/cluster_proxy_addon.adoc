...
. Enable the cluster proxy add-on on {mce} hub cluster. See link:../install_upgrade/adv_config_install.adoc#cluster-proxy-addon[Advanced configuration] to learn more.
