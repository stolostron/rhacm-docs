...
. Enable the cluster proxy add-on on {product-title} hub cluster. See link:../multicluster_engine/install_upgrade/adv_config_install.adoc#cluster-proxy-addon[Advanced configuration] to learn more.
