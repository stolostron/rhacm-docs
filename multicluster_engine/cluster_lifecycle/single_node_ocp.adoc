...
. Install a single node OpenShift cluster using the Central Infrastructure Management service. See link:../cluster_lifecycle/create_infra_env.adoc#creating-an-infrastructure-environment[Creating an infrastructure environment] for more details.
