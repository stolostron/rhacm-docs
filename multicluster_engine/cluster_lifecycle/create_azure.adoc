...
You can use the {mce} console to deploy a {ocp} cluster on Microsoft Azure or on Microsoft Azure Government.
...
* You need Internet access for your {mce} hub cluster so it can create the Kubernetes cluster on Azure or Azure Government
