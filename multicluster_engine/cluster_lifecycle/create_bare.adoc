...
* You need a configured bare metal asset, if you are are enabling certificate verification. See xref:../multicluster_engine/bare_assets.adoc#creating-and-modifying-bare-metal-assets[Creating and modifying bare metal assets] for more information.
