...
** <<importing-hosted-cluster-ui,Importing a hosted control plane cluster>>
...
You can import a hosted control plane cluster by navigating to *Infrastructure* > *Clusters* and selecting the hosted cluster you want to import. Then, click *Import hosted cluster*.
