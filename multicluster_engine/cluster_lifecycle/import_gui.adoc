...
* Install the `kubectl` command line interface. To install `kubectl`, see _Install and Set Up kubectl_ in the https://kubernetes.io/docs/tasks/tools/install-kubectl/[Kubernetes documentation].
...
+ For more information about the Ansible Automation Platform, see link:../../applications/ansible_config.adoc[Setting up Ansible Tower Tasks].
