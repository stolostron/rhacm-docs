...
. Select the *Cluster set admin* or *Cluster set view* role to give to the selected user or user group. See xref:../about/mce_rbac.adoc#overview-of-roles[Overview of roles] for more information about the role permissions.
...
For more information about role-based actions, see xref:../about/mce_rbac.adoc#mce-role-based-access-control[Role-based access control].
