...
. Apply the new `IngressController` by using the following commands:
+
----
...
assisted-image-service-0 1/1 Running 0 115s
assisted-service-6647dbfdc4-p5nqh 2/2 Running 0 116s
----
