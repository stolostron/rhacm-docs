...
* Your Red Hat OpenShift Container Platform cluster must have access to the {mce} in the OperatorHub catalog from the OpenShift Container Platform console. 
...
* If you plan to create managed clusters by using the Assisted Installer, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.12/html/installing/installing-on-premise-with-assisted-installer#preparing-to-install-with-ai[Preparing to install with the Assisted Installer] topic in the {ocp} documentation for the requirements. 
