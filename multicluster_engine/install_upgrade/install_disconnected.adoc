...
+
The Gatekeeper Operator is deprecated to align with Gatekeeper community efforts and releases. Install Gatekeeper on managed clusters by using the Helm add-on.
+
