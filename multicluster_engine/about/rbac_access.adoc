...
[#cluster-pools-rbac-cluster]
===== RBAC table for cluster lifecycle
|===
...
[#managed-cluster]
===== RBAC table for managed clusters
|===
| API | Admin | Edit | View
| managedclusters.cluster.open-cluster-management.io, you can use `mcl` (singular) or `mcls` (plural) in commands for this API._
| create, read, update, delete
| read, update
| read

| managedclusters.view.open-cluster-management.io, you can use `mcv` (singular) or `mcvs` (plural) in commands for this API._
| read
| read
| read
...
| managedclusterset.cluster.open-cluster-management.io, you can use `mclset` (singular) or `mclsets` (plural) in commands for this API._
| create, read, update, delete
| read, update
| read
