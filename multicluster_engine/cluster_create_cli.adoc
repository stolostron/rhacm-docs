...
When creating a cluster, you must add your release images to the https://github.com/stolostron/acm-hive-openshift-releases/tree/release-2.5/clusterImageSets[clusterImageSets] folder in the Git repository. After that, you can select the {ocp} release images when you create a cluster.
