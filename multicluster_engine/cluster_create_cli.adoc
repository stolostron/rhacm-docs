...
Before creating a cluster, you must clone the repository and apply it to your hub cluster. See the following steps:

the https://github.com/stolostron/acm-hive-openshift-releases/tree/release-2.5/clusterImageSets/fast[clusterImageSets] repository and apply it to your hub cluster. You can then select the {ocp} release images when you create a cluster.
...
2. Run the following to apply it to your hub cluster:
+
----
