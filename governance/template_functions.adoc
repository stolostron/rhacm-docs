...
//can consider adding the impirtant note here since we mention the toLiteral function
...
//Alternatively, we can add it here since `toRawJson` is mentioned here. can discuss during live review
