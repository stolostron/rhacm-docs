...
Continue reading to view the descriptions and examples for the custom template functions that are supported:

* xref:template_function_from_secret.adoc#from-secret[fromSecret]
* xref:template_function_from_configmap.adoc#from-configmap[fromConfigmap]
* xref:template_function_from_cluster_claim.adoc#from-cluster-claim[fromClusterClaim]
* xref:template_function_lookup_cluster_claim.adoc#lookup-cluster-claim[lookupClusterClaim]
* xref:template_function_lookup.adoc#lookup[lookup]
* xref:template_function_base64enc.adoc#base64enc[base64enc]
* xref:template_function_base64dec.adoc#base64dec[base64dec]
* xref:template_function_indent.adoc#indent[indent]
