...
{acm-short} supports all template functions from the `sprig` open source project, except for `env` and `expandenv`. This includes the following template functions:
