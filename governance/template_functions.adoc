...
----
<1> When you use this function with hub cluster templates, the output is automatically encrypted using the xref:../governance/template_functions.adoc#protect[protect] function.
