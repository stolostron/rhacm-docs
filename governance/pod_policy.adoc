...
A pod must exist in your cluster.
...
Learn how to manage a pod policy, see xref:../governance/create_pod_policy.adoc#managing-pod-policies[Managing pod policies] for more details.
