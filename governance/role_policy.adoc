...
Apply a role policy to set rules and permissions for specific roles in your cluster. For more information on roles, see link:../secure_clusters/rbac.adoc#role-based-access-control[Role-based access control]. 

To learn how to manage role policies, refer to xref:../governance/create_config_pol.adoc#create-configuration-policies[Creating configuration policies] for more information. See the xref:../governance/config_policy_ctrl.adoc#kubernetes-config-policy-controller[Kubernetes configuration policy controller] to view other configuration policies that are monitored the controller.
