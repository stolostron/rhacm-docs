...
- Install {acm}.
- Install the Policy Generator Kustomize plugin. See the xref:../governance/policy_generator.adoc#policy-generator-a[Policy Generator] documentation for more information.
