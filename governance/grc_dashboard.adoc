...
* link:../governance/gatekeeper_operator/manage_gk.adoc#managing-gk-policies[Managing the {gate} installation policies]
* link:../governance/grc_automation_config.adoc#grc-automation-config[Governance automation configuration]
* link:../governance/ansible_grc.adoc#ansible-integration-grc[Integrating {aap-short} with governance]
