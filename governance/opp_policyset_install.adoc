...
----
. Install the Policy Generator kustomize plugin. Use Kustomize v4.5 or newer. See link:../gitops/policy_gen_install_operator.adoc#policy-gen-install-operator[Generating a policy to install an Operator].
