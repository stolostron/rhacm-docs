...
For more information, see https://docs.openshift.com/container-platform/4.10/security/encrypting-etcd.html[Encrypting etcd data] in the {ocp-short} documentation. *Note*: The ETCD encryption policy only supports {ocp} 4 and later.
...
| Optional.
Used to list any other Kubernetes object that must be evaluated or applied to the managed clusters. See https://docs.openshift.com/container-platform/4.10/security/encrypting-etcd.html[Encrypting etcd data] in the {ocp-short} documentation.
|===
