...
For more information, see link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.19/html-single/etcd/index#enabling-etcd-encryption_etcd-encrypt[Enabling etcd encryption] in the {ocp-short} documentation. *Note:* The ETCD encryption policy only supports {ocp} 4 and later.
