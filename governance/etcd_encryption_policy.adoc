...
For more information, see https://docs.openshift.com/container-platform/4.8/security/encrypting-etcd.html[Encrypting etcd data] in the {ocp-short} documentation. *Note*: The ETCD encryption policy only supports {ocp} 4 and later.
