...
For more information, see link:https://docs.openshift.com/container-platform/{ocp-version}/security/encrypting-etcd.html[Encrypting etcd data] in the {ocp-short} documentation. *Note:* The ETCD encryption policy only supports {ocp} 4 and later.
