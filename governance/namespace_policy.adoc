...
* <<namespace-policy-yaml-table,Namespace policy description>>
...
== Namespace policy YAML description

FFor a full description of the policy YAML structure and additional fields, see the:
