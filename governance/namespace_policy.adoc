...
* The `ConfigurationPolicy` template enforces `Namespace` resources on managed clusters.
* The `object-templates` section defines the namespace rules to enforce.
