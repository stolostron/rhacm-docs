...
* <<hub-template-config-policies,Using hub templates to define configuration policies>>
...
[#hub-template-config-policies]
== Using hub templates to define configuration policies

Use the `governance-standalone-hub-templating` addon in the `ManagedClusterAddOn` to define `ConfigurationPolicies` on your managed clusters. 
