...
You can define configuration policies directly on the managed clusters, for example with {gitops-short}. To resolve hub templates on the managed cluster in that situation, you can enable the `governance-standalone-hub-templating` addon. 
