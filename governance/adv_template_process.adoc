...
//Multiline is not clear to me. The YAML is using multiple lines in general. Or do we mean multiple functions are supported for object template processing . Object templates support processing multiple functions
