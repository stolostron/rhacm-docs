...
*  See xref:../business_continuity/backup_restore/backup_arch.adoc#backed-up-resources[Resources that are backed up] for more details on backing up and restoring resources. 
