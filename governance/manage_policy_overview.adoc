...
- _Details_: Select the _Details_ tab to view policy details and placement information. You can configure automation from the _Policy details_ section, select the **Configure** link. You can also select the **local-cluster** link to view the violated cluster.
- _Clusters_: Select the _Clusters_ tab to view a table list of violated clusters. Click the **View details** link to view the template details and YAML. You can also view related resources. To view the compliance status of your policy, click the **View history** link. A list of violation messages are displayed in the table. Also, the _History_ page displays the local cluster name and name of the related template.
- _Templates_: Select the _Templates_ tab to view the cluster that is related to the template.
