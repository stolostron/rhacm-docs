...
| `spec.labelSelector`
| Optional
| Specify identifying attributes of objects. See the link:https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/[Kubernetes labels and selectors] documentation.
