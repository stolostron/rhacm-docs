...
//do we still need to send users to the certificates intro? Is this relevant or beneficial?
- See link:../securing_cluster/cert_intro.adoc#cert-intro[Certificates introduction].
