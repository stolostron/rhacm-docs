...
The {ocp-short} monitoring component collects the `cluster_policy_governance_info` metric. If you enable observability, the component collects some total data.
...
Use these labels and values to enable detailed queries on many things happening in the cluster that might be difficult to track.
