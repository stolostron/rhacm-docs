...
- Return to the xref:../governance/grc_intro.adoc#governance[Governance] topic.
//is there a link to the latest ocp doc?
- See link:https://docs.openshift.com/container-platform/3.11/scaling_performance/host_practices.html[Recommended Host Practices].
