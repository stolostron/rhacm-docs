...
The `policy_governance_info` is collected by the {ocp-short} monitoring feature, and some aggregate data is collected by {acm-short} observability, if it is enabled.
