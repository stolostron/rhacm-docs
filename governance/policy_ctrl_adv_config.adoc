...
You can configure the policy controllers on your managed clusters. Update advanced configurations for the policy controllers on managed clusters using the `ManagedClusterAddOn` custom resource. 
...
View the following custom reosurce 
