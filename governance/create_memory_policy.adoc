...
View a sample of a memory usage policy, see _Memory usage policy sample_ from the xref:../governance/memory_policy.adoc#memory-usage-policy-sample[Memory usage policy] page.
