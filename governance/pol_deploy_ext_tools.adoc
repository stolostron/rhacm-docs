...
* link:../gitops/gitops_manage_policy_def.adoc#config-gitops-healthcheck[Configuring policy health checks in {gitops-short}]
* link:../gitops/gitops_manage_policy_def.adoc#create-clusterrole-gitops[Creating a ClusterRole resource for {gitops}]
* link:../governance/adv_template_process.adoc#resolve-hub-templates[Resolving hub templates after defining configuration policies]
