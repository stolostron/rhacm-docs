...
* xref:../gitops/gitops_manage_policy_def.adoc#config-gitops-healthcheck[Configuring policy health checks in {gitops-short}]
* xref:../gitops/gitops_manage_policy_def.adoc#create-clusterrole-gitops[Creating a ClusterRole resource for {gitops}]
* xref:../governance/adv_template_process.adoc#resolve-hub-templates[Resolving hub templates after defining configuration policies]
