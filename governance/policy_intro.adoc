...
Each {product-title} policy can have at least one or more templates. For more details about the policy elements, view the link:#policy-yaml-table[Policy YAML table] section on this page.
