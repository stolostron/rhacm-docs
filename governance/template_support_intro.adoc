...
[#additional-resources-temp-support]
...
- xref:../governance/hub_cluster_templates.adoc#template-comparison-table[Comparison of hub cluster and managed cluster templates]
