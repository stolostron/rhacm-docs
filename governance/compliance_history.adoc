...
Enable the compliance history API on all managed clusters to receive compliance events from your managed clusters. Complete the following steps:
...
Enable the compliance history API on a single managed cluster to receive compliance events from the managed cluster. Complete the following steps:
