...
*Note:* You can also add `cluster_policy_governance_info` metric to the observability `allowlist` as a custom metric. For more details, see link:../observability/obs_metrics.adoc#adding-custom-metrics[Adding custom metrics].
