...
Install the {gate} from the {olm} catalog to install Gatekeeper on your cluster. With {acm-short} you can use a policy to install the {gate} by using the governance framework.

[#configure-gk-operator-prerequisites]
== Prerequisites

* *Required access*: Cluster administrator. 
* See _Adding Operators to a cluster_ in the {ocp-short} documentation and complete the _Additional resources_ section.
* After you install the {gate}, configure the {gate} custom resource to install Gatekeeper.
