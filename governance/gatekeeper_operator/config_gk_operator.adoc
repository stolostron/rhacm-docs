...
- Understand how to use the Operator Lifecycle Manager and the {ocp-catalog} by completing _Adding Operators to a cluster_ and the _Additional resources_ section in the {ocp-short} _Operators_ documentation.
...
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.20/html/operators/administrator-tasks#olm-adding-operators-to-a-cluster[Adding Operators to a cluster]
