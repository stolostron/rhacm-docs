...
[role="_abstract"]
Red Hat supports only the Gatekeeper Operator and does not support individual Gatekeeper policies. Support ensures that the operator is functioning. To receive support, you need a {acm} or {ocp} Plus subscription.
...
To view the release notes for the {gate}, see _gatekeeper-operator-bundle_.

.Additional resources

* link:https://catalog.redhat.com/software/containers/gatekeeper/gatekeeper-operator-bundle/64ba9da52b6048f1d6695232[gatekeeper-operator-bundle]
