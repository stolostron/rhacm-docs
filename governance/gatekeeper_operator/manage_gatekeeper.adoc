...
- <<viewing-disabling-gatekeeper-operator-policy,Viewing and disabling {gate} policy>>
...
[#viewing-disabling-gatekeeper-operator-policy]
== Viewing and disabling {gate} policy
...
To disable your `policy-gatekeeper-operator` policy, complete the following steps:
