...
The {gate} custom resource tells the {gate} to start the Gatekeeper installation on the cluster. View the following YAML to install Gatekeeper, which has been filled in with sample and default values:
