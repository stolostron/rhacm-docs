...
To create Gatekeeper policies, use `ConstraintTemplates` resources and constraints. Add templates and constraints to the `policy-templates` of a `Policy` resource.
...
- link:https://www.openpolicyagent.org/docs/latest/kubernetes#what-is-opa-gatekeeper[What is OPA Gatekeeper?]
