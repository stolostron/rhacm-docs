...
//Would it be best to move this table to the Template functions file?
.Comparison table
|===
...
* xref:../governance/template_support_intro.adoc#support-templates-in-config-policies[Support for templates in configuration policies]
