...
The `copyConfigMapData` function copies all of the `data` contents of the specified secret. View the following sample of the function:
...
* Read xref:../governance/hub_cluster_templates.adoc#hub-templates[Support for hub cluster templates in configuration policies] for more details.
