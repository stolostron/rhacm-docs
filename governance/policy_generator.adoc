...
----
<1> Path to your file.
<2> Your content is used in the generated `ConfigurationPolicy` resource and added as an entry for the `policy-templates` of a policy. The `object-templates-raw` generated `ConfigurationPolicy` has the same name as a manifest generated from a `ConfigurationPolicy` that has no specified name.
