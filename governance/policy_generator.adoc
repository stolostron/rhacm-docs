...
* <<capabilities,Policy Generator capabilities>>
* <<generator-configuration,Policy Generator configuration structure>>
* <<configuration-ref-table,Policy Generator configuration reference table>>
