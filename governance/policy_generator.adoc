...
Note that all the fields in the `policyDefaults` section except for `namespace` can be overridden per policy, and all the fields in the `policySetDefaults` section can be overridded per policy set.
