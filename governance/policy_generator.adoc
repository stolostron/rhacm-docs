...
* xref:../gitops/gitops_overview.adoc#gitops-overview[GitOps overview]
...
+
*Note:* Application _subscription_ and all processes that use Application subscription are deprecated.
