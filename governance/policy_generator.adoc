...
| Optional
| Defines the label selector for objects defined in the `objectDefinition`. If there is an object name defined in the `objectDefinition`, the `objectSelector` is ignored.
