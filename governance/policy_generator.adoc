...
To pin to a specific version of the operator, you can set the `spec.startingCSV` value to `openshift-gitops-operator.v<version>`. *Best practice*: Use policy generator v1.2.3.
