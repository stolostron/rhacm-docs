...
*Best practice*: Use policy generator v1.9.0. Your `image` parameter might resemble the following syntax: `image: registry.redhat.io/rhacm2/multicluster-operators-subscription-rhel8:v1.9.0`
