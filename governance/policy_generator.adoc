...
| Optional
| Defines the label selector for objects that get defined in the `objectDefinition`. If there is an object name that gets defined in the `objectDefinition`, the `objectSelector` gets ignored.
