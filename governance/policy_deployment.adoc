...
| Policy dependencies
| Yes
| No. Alternatively, you can use the Argo CD sync waves to view the policy dependencies. 
...
You must complete extra configuration for Argo CD version later than 2.13.
| Yes
| Yes
