...
| You can use Kubernetes labels on the policy resources to logically group related policies and view the in the _Discovered policies_ table. Also use Argo CD `Application` objects for grouping and to get a high-level status.
