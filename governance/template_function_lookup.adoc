...
*Note:* Use the `default` template function, so the correct type is provided to later template functions. See xref:../governance/template_functions.adoc#sprig-open-source[Sprig open source].
