...
* When you use the `fromSecret` function with hub cluster templates, the output is automatically encrypted using the _protect_ function to protect the value in flight to the managed cluster.
...
* xref:../governance/template_functions.adoc#protect-function[protect]
