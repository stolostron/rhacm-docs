...
| Kyverno Generate Network Policies 
|
| x

| Kyverno Generate Quota
|
| x
...
* xref:../governance/policy_kyverno_add_network_policy.adoc#kyverno-add-network-policy[Kyverno add network policy]
* xref:../governance/policy_kyverno_add_quota_policy.adoc#kyverno-add-quota-policy[Kyverno add quota policy]
* xref:../governance/policy_kyverno_sync_secrets_policy.adoc#kyverno-sync-secrets-policy[Kyverno sync secrets policy]
