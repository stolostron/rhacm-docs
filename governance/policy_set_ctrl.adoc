...
status:
  ...
  results:
  - compliant: NonCompliant
    complianceClusterTotal: 1000
    message: Both compliant and non-compliant cluster lists are not displayed due to its large size
    nonCompliantClusterTotal: 2000
    policy: test-policy
----
