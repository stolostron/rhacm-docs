...
The support of pod security policies is removed from {ocp-short} 4.13 and later, and from Kubernetes v1.25 and later. If you apply a `PodSecurityPolicy` resource, you might receive the following non-compliant message:
