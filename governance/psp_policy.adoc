...
- To view the sample policy, review `policy-psp.yaml`. View xref:../governance/create_config_pol.adoc#create-configuration-policies[Creating configuration policies] for more information. 
