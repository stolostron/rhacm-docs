...
+
*Best practice*: Ensure that the {aap-short} job template is idempotent when it is run. If you do not have {aap-short}  Resource Operator, you can find it from the {ocp} _OperatorHub_ page. 
