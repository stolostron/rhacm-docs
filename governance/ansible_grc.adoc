...
* Install the Ansible Automation Platform Resource Operator from the Operator Lifecycle Manager. In the _Update Channel_ section, select *`stable-2.3-cluster-scoped`. Select the *All namespace on the cluster (default)* installation mode.
+
