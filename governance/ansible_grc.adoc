...
{acm} Governance can be integrated with {aap} to create policy violation automations. You can configure the automation from the {acm-short} console.
...
After you log in to your {acm-short} hub cluster, select *Governance* from the navigation menu, and then click on the _Policies_ tab to view the policy tables. 
