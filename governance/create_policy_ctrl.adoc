...
For more information on deployments, see https://docs.openshift.com/container-platform/4.11/applications/deployments/what-deployments-are.html#deployments-kube-deployments_what-deployments-are[{ocp-short} Deployments].
