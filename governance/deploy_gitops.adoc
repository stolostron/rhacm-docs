...
. Bind the `open-cluster-management:subscription-admin` ClusterRole to the user that will create the subscription.
. If you are using an allow list in the subscription, include the following entries:
