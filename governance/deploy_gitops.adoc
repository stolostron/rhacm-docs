...
. Locate the policies that you deployed in the table. Policies that are deployed using GitOps has a _Git_ label in the _Source_ column. Click the label to be directed to the source in the Git repository.
