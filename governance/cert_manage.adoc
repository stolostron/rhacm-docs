...
You can replace certificates for the `rbac-query-proxy` route. See xref:../governance/cert_byo.adoc#openssl-commands-ca[Generating CA certificates by using OpenSSL commands] to create certificates.
