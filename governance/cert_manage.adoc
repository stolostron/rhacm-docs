...
- link:https://docs.openshift.com/container-platform/{ocp-version}/security/certificates/service-serving-certificate.html[OpenShift Service Serving Certificates]
