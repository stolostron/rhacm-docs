...
- See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.15/html/security_and_compliance/configuring-certificates#add-service-serving[Securing service traffic using service serving certificate secrets].
- See xref:../governance/cert_intro.adoc#cert-intro[Certificates introduction].
