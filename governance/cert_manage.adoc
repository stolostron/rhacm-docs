...
You can replace certificates for the `rbac-query-proxy` route. See link:../access_control/cert_byo.adoc#certificates-byo[Bringing your own observability Certificate Authority (CA) certificates].
