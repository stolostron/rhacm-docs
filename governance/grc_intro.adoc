...
+
Use the `policy_governance_info` metric to view trends and analyze any policy failures. See xref:../governance/policy_ctrl_adv_config.adoc.adoc#gov-metric[Governance metric] for more details.
