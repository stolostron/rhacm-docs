...
You can also use templated values within the configuration policies. For more information, see xref:../governance/custom_template_functions.adoc#support-templates-in-config-policies[Support for templates in configuration policies].
...
Continue reading the following related topics:
