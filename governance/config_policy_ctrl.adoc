...
- Learn about cleaning up resources and other topics in the xref:../governance/create_policy.adoc[Cleaning up resources that are created by policies] documentation.
