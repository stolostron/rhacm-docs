...
| spec.namespace
| Required for namespaced objects or resources.
| The namespaces in the hub cluster that the policy is applied to.
...
| Required
| Specifies the remediation of your policy. Enter  `inform`.
