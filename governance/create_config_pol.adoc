...
If you have an existing Kubernetes manifest, the xref:../governance/policy_generator.adoc[policy generator] is also a useful tool to automatically wrap those manifests in a policy.
