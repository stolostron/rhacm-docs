...
** <<viewing-a-configuration-policy-from-the-console,Viewing a configuration policy from the console>>
...
As a reminder, the following resources are configuration policies:
