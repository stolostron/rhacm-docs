...
* xref:../governance/install_operator.adoc#install-operator-with-policy[Installing an operator by using the OperatorPolicy resource]
* xref:../governance/manage_operator.adoc#managing-operator-policies-disconnected[Managing operator policies in disconnected environments]
