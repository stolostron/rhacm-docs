...
- `config`: *Optional.* Specify extra configuration details for the operator subscription. The `name` field is the only required field. The other fields are populated based on the catalog information within the managed cluster.
+
