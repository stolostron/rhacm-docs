...
With the `policytools` command line interface (CLI), you can interact with policies locally to help with creating and debugging.  The `policytools` CLI is available for download from the hub cluster console. See link:../console/console.adoc#command-line-tools[Command line tools].
