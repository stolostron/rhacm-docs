...
View a sample of a namespace policy, see _Namespace policy sample_ on the xref:../governance/namespace_policy.adoc#namespace-policy-sample[Namespace policy] page.
