...
//this is not a requirements file. This is a procedure. A requirements file is a concept.
...
//this should not be one command. These are multiple steps in one. And we need to remove sudo.
