[#edge-images-special-considerations]
...
* <<usr-etc,Configuration in /usr over /etc>>
* <<drop-dir,Drop-in directories>>
* <<avoid-drift,Operating system images with scripts>>

[#edge-buildtime-runtime]
