...
The {rhem} Kubernetes authorization uses role-based access control (RBAC) to control authorization for {rhem} API endpoints. 
...
For more information, see link:../securing_cluster/rbac.adoc#rbac-rhacm[Role-based access control].
