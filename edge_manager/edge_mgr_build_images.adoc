...
To prepare your device to be managed by the {rhem}, build a `bootc` operating system image that contains the {rhem} agent. Then build an operating system disk image for your devices.
