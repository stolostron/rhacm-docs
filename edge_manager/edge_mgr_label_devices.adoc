...
You can organize your resources, including individual devices, fleets and any other resources, by assigning them labels, for example, to record their location, hardware type, or purpose.
