...
* Your device must run an operating system image with the `podman-compose` tool installed. See xref:../edge_manager/edge_mgr_build_images.adoc#build[Building a _bootc_ operating system image for use with the {rhem}]
