...
//* See xref:../edge_manager/edge_mgr_build_images.adoc#edge-mgr-build[Building bootc image and disk image with the {rhem}].--this seems to have been removed -- Brandi 3/17 will search back in PRs.
* See xref:../edge_manager/edge_mgr_images_special_considerations.adoc#build-images-consider[Special considerations for building images].