...
When building operating system images and disk images for {ocp-virt}, you can follow the _Building a _bootc_ operating system image for the {rhem}_ process with the following changes:
...
When building operating system images and disk images for VMware vSphere, you can follow the _Building a _bootc_ operating system image for the {rhem}_ process with the following changes:
