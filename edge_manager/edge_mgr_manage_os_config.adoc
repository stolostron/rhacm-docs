...
For more information about device lifecycle hooks and the default rules used by the {rhem} agent, see xref:../edge_mgr_device_lifecycle_hooks.adoc#device-lifecycle-hooks[Device lifecycle hooks].
