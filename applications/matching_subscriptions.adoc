...
For more information about the resource definition for an application, see xref:../applications/app_resources.adoc#application-resources[Creating and managing application resources].
