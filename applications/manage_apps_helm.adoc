...
= Manage apps with Helm repositories
...
* xref:../applications/helm_sample_yaml.adoc#sample-yaml-helm[Sample YAML]
* xref:../applications/helm_keep_resources.adoc#helm-keep-resource-after-sub-delete[Keep deployed resources after deleting subscription with Helm]
