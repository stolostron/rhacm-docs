...
*Note:* When the subscription reconcile rate is set to `low` or `off`, it can take up to one hour for the subscribed application resources to be reconciled. On the existing application action menu, click *Sync* to reconcile manually. 
