...
- You need to create managed cluster sets and add managed clusters to those managed cluster sets. See the xref:../clusters/managedclustersets.adoc[Creating and managing ManagedClusterSets (Technology Preview)]
