...
+
See the link:../clusters_mce/cluster_lifecycle/managedclustersets_intro.adoc#managedclustersets-intro[Creating and managing ManagedClusterSets] documentation for more information.
...
+
See the link:../clusters_mce/cluster_lifecycle/managedclustersetbinding_create.adoc#creating-a-managedclustersetbinding[Creating a ManagedClusterSetBinding resource] documentation for more information.
...
+
See link:../clusters_mce/cluster_lifecycle/placement_managed.adoc[Using ManagedClusterSets with Placement] for placement information. 
