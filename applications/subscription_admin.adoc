...
= Grant subscription administrator privilege
...
. Create one or more users. See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.19/html/postinstallation_configuration/post-install-preparing-for-users[Preparing for users] for information about creating users. You can also prepare groups or service accounts.
+
