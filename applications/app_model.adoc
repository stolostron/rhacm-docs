...
*Best practice:* Use the GitOps Operator or Argo CD integration instead of the Channel and Subscription model. Learn more from the link:../gitops/gitops_overview.adoc#gitops-overview[GitOps overview].
