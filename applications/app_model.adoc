...
**Note:** For more details on the prerequisites for deploying `ApplicationSet`, see xref:../gitops/gitops_config.adoc#gitops-register[Registering managed clusters to GitOps].
