...
**Note:** For more details on the prerequisites for deploying `ApplicationSet`, see xref:../gitops/gitops_config.adoc#register-gitops[Registering managed clusters to GitOps].
