...
[#applicationset]
== ApplicationSet
//this is not deprecated but is already covered in GitOps. This can be removed when all the app doc is removed. --BCS 2.13
...
*Note:* For more details on the prerequisites for deploying `ApplicationSet`, see link:../gitops/gitops_push_register.adoc#gitops-push-register[Register {ocp-short} managed clusters to the {gitops} operator].
...
=======
* xref:../applications/app_model_apps.adoc#applications_overview[Applications overview]
