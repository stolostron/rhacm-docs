...
*Note:* For more details on the prerequisites for deploying `ApplicationSet`, see link:../gitops/gitops_push_register.adoc#gitops-push-register[Register managed clusters to the {gitops} operator].
