...
**Note:** For more details on the prerequisites for deploying `ApplicationSet`, see xref:../applications/gitops_config.adoc#register-gitops[Registering managed clusters to GitOps].
