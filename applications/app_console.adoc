...
* *Note:* If you have no GitOps cluster resources and no GitOps operator installed, you will have no *Argo server* options in the console to create an `ApplicationSet`.
