...
*Important:* Available actions are based on your assigned role. Learn about access requirements from the link:../securing_cluster/rbac.adoc#role-based-access-control[Role-based access control] documentation.
...
You can also search by other fields, including name, namespace, cluster, label, and more. For more information about using search, see link:../console/search_console.adoc#search-console-intro[Search in the console].