...
You can also search by other fields, including name, namespace, cluster, label, and more. For more information about using search, see link:../search/search_console.adoc#search-service[Search in the console].