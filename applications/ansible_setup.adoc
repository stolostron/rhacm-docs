...
* You need to install {aap-short}. See https://docs.ansible.com/automation.html[Red Hat Ansible Automation Platform] documenation to install the latest supported version.
