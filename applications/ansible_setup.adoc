...
* Install {aap-short}. See link:https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.3[Red Hat Ansible Automation Platform] documentation to install the latest supported version.
