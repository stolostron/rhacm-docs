...
* xref:../applications/subscribe_git_create.adoc#creating-application-resources-git[Creating application resources in Git]
* xref:../applications/subscribe_git_elements.adoc#subscribing-specific-git[Subscribing specific Git elements]
