...
The new field, `.status.subscription`, indicates the overall subscription status. Previously, you only had the package status that indicated the status of an individual package. 
