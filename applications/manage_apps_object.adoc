...
[#gobject storage-keep-resource-after-sub-delete]
...
. Add the following annotation to the resource or resources you want to keep when deleting the subscription:
+
