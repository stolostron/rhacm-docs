...
* xref:../applications/allow_deny.adoc#creating-an-allow-and-deny-list-as-subscription administrator[Creating an allow and deny list as subscription administrator]
