...
| A user with cluster-wide binding to the `managed-cluster-<managed_cluster_name>` role has view access to `managedcluster-<managed_cluster_name>` resource.

| *open-cluster-management:managedclusterset:admin:managed-clusterset-<managed_clusterset_name>*
| A user with cluster binding to the `managed-clusterset-<managed_clusterset_name>` role has administrator access to `managedclusterset-<managed_clusterset_name>` resource. The user also has administrator access to `managedcluster.cluster.open-cluster-management.io/clusterclaim.hive.openshit.io/clusterdeployment.hive.openshit.io/clusterpool.hive.openshit.io` resources, which has the managed cluster set label: `cluster.open-cluster-management.io/clusterset=managed-clusterset-<managed_clusterset_name>`. 

| *open-cluster-management:managedclusterset:view:managed-clusterset-<managed_clusterset_name>*
| A user with cluster-wide binding to the `managed-clusterset-<managed_clusterset_name>` role has view access to `managedclusterset-<managed_clusterset_name>` resource. The user also has view access to `managedcluster.cluster.open-cluster-management.io/clusterclaim.hive.openshit.io/clusterdeployment.hive.openshit.io/clusterpool.hive.openshit.io` resources, which has the managed cluster set label: `cluster.open-cluster-management.io/clusterset=managed-clusterset-<managed_clusterset_name>`.
