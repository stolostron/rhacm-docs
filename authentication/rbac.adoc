...
| *open-cluster-management:admin:managed-cluster-x*
...
| *open-cluster-management:managedclusterset:admin:managed-clusterset-x*
| A user with cluster binding to the `managed-clusterset-x` role has administrator access to `managedclusterset “X”` resource. The user also has administrator access to managedcluster.cluster.open-cluster-management.io/clusterclaim.hive.openshit.io/clusterdeployment.hive.openshit.io/clusterpool.hive.openshit.io resources which has the managedcluster set label of "cluster.open-cluster-management.io/clusterset=managed-clusterset-x". 

| *open-cluster-management:managedclusterset:view:managed-clusterset-x*
| A user with cluster-wide binding to the `managed-clusterset-x` role has view access to `managedclusterset “X”` resource. The user also has view access to managedcluster.cluster.open-cluster-management.io/clusterclaim.hive.openshit.io/clusterdeployment.hive.openshit.io/clusterpool.hive.openshit.io resources which has the managedcluster set label of "cluster.open-cluster-management.io/clusterset=managed-clusterset-x".
