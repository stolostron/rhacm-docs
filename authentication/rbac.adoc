...
| A user with cluster binding to the `managed-clusterset-x` role has administrator access to `managedclusterset “X”` resource. This role also gives the user administrator access to all resources that are in the `managedclusterset “X”` resource.
