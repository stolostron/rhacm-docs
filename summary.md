 ...
 * [Support](support/support.md)
    * [Support types](support/support_types.md)
    * [Open source support](support/opensource_support.md)
 ...
 * [Console](console/console_intro.md)
   * [Observability from the {{site.data.keyword.gui}}](console/console.md)
 ...
 *  [Multitenancy](multitenancy.md) (DE confirmed to add)
 *  [Cloudctl](cloudctl_intro.md) (MC plugin somehow-- Josh to follow up)
