...
. Select the *Cluster set admin* or *Cluster set view* role to give to the selected user or user group. See _Overview of roles_ in xref:../about/mce_rbac.adoc#mce-rbac[Role-based access control] for more information.
