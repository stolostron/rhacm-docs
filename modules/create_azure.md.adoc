...
See link:cloud_conn_aks.html[Setting up a provider connection for Microsoft Azure] for more information.
...
If you do not have one configured, or want to configure a new one, see link:conn_cloud_aks.html[Creating a provider connection on Azure].
