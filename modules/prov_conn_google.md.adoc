...
You can use this connection when you create a cluster by completing the steps in xref:creating-a-cluster-with-red-hat-advanced-cluster-management-for-kubernetes-on-google-cloud-platform[Creating a cluster on Google Cloud Platform].
