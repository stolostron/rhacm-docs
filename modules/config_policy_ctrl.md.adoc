...
For more information, see link:../governance/policy_samples.html[Policy samples] to view policy samples that can be applied with the configuration policy controller.
