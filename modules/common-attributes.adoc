...
:mcp: MCP server for Red Hat Advanced Cluster Management
:mcp-short: MCP server
:rh-lightspeed: Red Hat OpenShift Lightspeed
:lightspeed-short: OpenShift Lightspeed
