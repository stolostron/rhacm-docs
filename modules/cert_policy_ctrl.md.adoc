...
See link:create_policy.md#yaml[Creating a YAML file for a Red Hat Advanced Cluster Management for Kubernetes policy] for more information on policy requirements.
+
...
See xref:policy_samples[Configuration policy samples] to view policy samples that can be applied to your certificate policies.
