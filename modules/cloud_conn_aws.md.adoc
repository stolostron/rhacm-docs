...
You can create a cluster that uses this provider connection by completing the steps in link:create_ocp_aws.html[Creating a cluster on Amazon Web Services].
