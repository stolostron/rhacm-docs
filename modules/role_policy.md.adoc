...
See xref:security_intro[Role-based access control (RBAC)] for more information on roles.
...
Apply a role policy to set rules and permissions for specific roles in your cluster.
For more information on roles, see xref:security_intro[Role-based access control (RBAC)].
