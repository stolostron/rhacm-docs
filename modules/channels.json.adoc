...
|**Body**|**body** +
__required__|Parameters describing the deployable to be created.|<<_ccutilchannel,Channel>>
|===
...
__required__|object
|**spec** +
__required__|<<_ccutilchannel_spec,spec>>
|===
...
|**configMapRef** +
__optional__|ObjectReference contains enough information to let you inspect or modify the referred object.|<<_ccutilchannel_configmapref,configMapRef>>
|**gates** +
__optional__|ChannelGate defines criteria for promote to channel|<<_ccutilchannel_gates,gates>>
|**pathname** +
__required__||string
|**secretRef** +
__optional__|ObjectReference contains enough information to let you inspect or modify the referred object.|<<_ccutilchannel_secretref,secretRef>>
|**sourceNamespaces** +
__optional__||< enum (Namespace, HelmRepo, ObjectBucket, GitHub, namespace, helmrepo, objectbucket, github) > array
|===

[[_ccutilchannel_configmapref]]
**configMapRef**
...
|Name|Description|Schema
|**annotations** +
__optional__|typical annotations of k8s|<<_ccutilchannel_gates_annotations,annotations>>
|**labelSelector** +
__optional__|A label selector is a label query over a set of resources. The result of matchLabels and matchExpressions are ANDed. An empty label selector matches all objects. A null label selector matches no objects.|<<_ccutilchannel_gates_labelselector,labelSelector>>
|**name** +
__optional__||string
|===

[[_ccutilchannel_gates_annotations]]
**annotations**
...
[[_ccutilchannel_gates_labelselector]]
**labelSelector**
...
|Name|Description|Schema
|**matchExpressions** +
__optional__|matchExpressions is a list of label selector requirements. The requirements are ANDed.|< <<_ccutilchannel_gates_labelselector_matchexpressions,matchExpressions>> > array
|**matchLabels** +
...
[[_ccutilchannel_gates_labelselector_matchexpressions]]
**matchExpressions**
