...
You can create a cluster that uses this provider connection by completing the steps in xref:creating-an-openshift-cluster-on-bare-metal[Creating a cluster on bare metal].
