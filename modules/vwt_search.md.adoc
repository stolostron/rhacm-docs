...
| `istioctl`
| Run supported `istioctl` commands.
*Tip:* See the https://istio.io/docs/reference/commands/istioctl/[Istioctl] topic in the Istio documentation for more information about the `istioctl` commands.
| `istioctl get policy`

| `kubectl`
| Run supported `kubectl` commands.
*Tip:* See the https://kubernetes.io/docs/reference/generated/kubectl/kubectl-commands[Kubectl reference] for more information about the `kubectl` commands.
| `kubectl get pods`
