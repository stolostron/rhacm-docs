...
You can use the Red Hat Advanced Cluster Management for Kubernetes console to import an existing cluster.
You need your terminal for authentication.
...
See link:../install/supported_clouds.html[Supported cloud providers] to learn how to configure your `kubectl`.
