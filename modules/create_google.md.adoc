...
See xref:prov_conn_google[Setting up a provider connection for Google Cloud Platform] for more information.
...
If you do not have one configured, or want to configure a new one, see xref:prov_cloud_google[Creating a provider connection on Google Cloud Platform].
