...
See xref:creating-a-provider-connection-for-google-cloud-platform[Setting up a provider connection for Google Cloud Platform] for more information.
...
If you do not have one configured, or want to configure a new one, see xref:creating-a-provider-connection-for-google-cloud-platform[Creating a provider connection on Google Cloud Platform].
