[#creating-and-creating-and-managing-deployables]
...
For more information about updating an application, see xref:creating-and-managing-applications[Creating and managing applications].
