...
Samples for all resources, including deployables, are located in the xref:app_resource_samples[Application resource samples] documentation.
 ...
 ** To use REST API, you need to use the link:../apis/mcm/deployables_app[deployable POST API].
 ...
 ** To use REST API, use the link:../apis/mcm/deployables_app[deployable PATCH API].
...
----
* To use REST API, use the link:../apis/mcm/deployables_app[deployable DELETE API].
...
For more information about updating an application, see xref:managing_apps[Creating and managing applications].
