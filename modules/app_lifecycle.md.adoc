...
For more information about these resources, see xref:app_resources.adoc[Application resources].
...
* xref:managing_apps.adoc[Creating and managing application resources]
* xref:managing_deployables.adoc[Creating and managing deployables]
...
For more information, see xref:deployment_app.adoc[Deploying an application resource].
...
For more information, see xref:managing_apps_console.adoc[Managing applications with the console].
