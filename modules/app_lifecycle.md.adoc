...
* <<dep-app-resources,Deploying application resources>>
* <<manage-apps-console,Managing applications with the console>>
...
For more information about these resources, see link:app_resources.html[Application resources].
...
* link:managing_apps.html[Creating and managing application resources]
* link:managing_deployables.html[Creating and managing deployables]
* link:managing_channels.html[Creating and managing channels]
* link:managing_subscriptions.html[Creating and managing subscriptions]
* link:managing_placement_rules.html[Creating and managing placement rules]
...
For more information, see link:deployment_app.html[Deploying an application resource].
...
For more information, see link:managing_apps_console.html[Managing applications with the console].
