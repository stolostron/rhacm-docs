...
* xref:../manage_applications/deploy_app.adoc[Creating a deployment]
* xref:../manage_applications/deploy_app_gpu.adoc[Creating a deployment with attached GPU resources]
