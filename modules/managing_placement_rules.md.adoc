...
Samples for all resources, including placement rules, are located in the xref:app_resource_samples[Application resource samples] documentation.
 ...
 ** To use REST API, you need to use the link:../apis/placementRules[placement rule POST API].
...
----
 ...
 .. Review the fields and values within the `status` section of the YAML content.
* To use REST API, you need to use the link:../apis/placementRules[placement rule GET API].
...
* To use REST API, you need to use the link:../apis/placementRules[placement rule PATCH API].
 ...
 ** link:../apis/placementRules[Placement rule APIs].
