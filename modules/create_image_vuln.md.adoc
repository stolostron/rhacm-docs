...
View a sample of an image vulnerability policy, see _Image vulnerability policy sample_ on the xref:red-hat-advanced-cluster-management-for-kubernetes-configuration-policy-samples[Policy samples page].
