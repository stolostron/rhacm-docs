...
* xref:rolling-update-samplessss[Rolling update sample]
...
For example definitions of resources that use a rolling update, see xref:rolling-update-samplessss[Rolling update sample].
