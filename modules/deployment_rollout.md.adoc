...
+
For more information about how to define a subscription, see xref:managing_subscriptions[Creating and managing subscriptions].
+
For more information about how to define a placement rule, see xref:managing_placement_rules[creating and managing placement rules].
...
For example definitions of resources that use a rolling update, see xref:roll_update_sample[Rolling update sample].
