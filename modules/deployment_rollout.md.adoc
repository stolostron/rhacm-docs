[#creating-and-managing-deployables-with-a-rolling-update]
...
For example definitions of resources that use a rolling update, see xref:rolling-update-sample[Rolling update sample].
