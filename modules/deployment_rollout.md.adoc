...
* xref:rolling-update-sampless[Rolling update sample]
...
For example definitions of resources that use a rolling update, see xref:rolling-update-sampless[Rolling update sample].
