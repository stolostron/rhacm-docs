...
* link:roll_update_sample.html[Rolling update sample]
...
For example definitions of resources that use a rolling update, see link:roll_update_sample.html[Rolling update sample].
