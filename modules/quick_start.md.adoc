...
Review the link:multicluster-architecture[Architecture] topic and the link:components[Components] topics to learn more about what is installed with Red Hat Advanced Cluster Management for Kubernetes.
