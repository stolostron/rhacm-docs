...
After you learn about the hub cluster and managed cluster architecture, learn more about the link:../install[Supported clouds], which lists the cloud provider cluster options.
...
See the xref:../security/policy_example[policy overview] for details about how to create a policy with a `.yaml` template.
