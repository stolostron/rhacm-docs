...
Samples for all resources, including subscriptions, are located in the xref:app_resource_samples[Application resource samples] documentation.
...
For more information about YAML structure and samples, see xref:app_resource_samples[Application resource samples] documentation.
 ...
 ** To use REST API, you need to use the link:../apis/mcm/subscriptions[subscription POST API].
...
For more information about the resource definition for an application, see xref:managing_apps[Creating and managing applications].
 ...
 ** To use REST API, use the link:../apis/mcm/subscriptions[subscription PATCH API].
...
----
* To use REST API, use the link:../apis/mcm/subscriptions[subscription DELETE API].
