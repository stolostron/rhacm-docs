...
* xref:replacing-the-root-ca-certificate-certificate-certificate-certificate-certificate-certificate-certificate-certificate-certificate-certificate-certificate[Replacing the root CA]
