...
View more descriptions of the policy YAML files in the xref:policy_example[Policy example].
...
View the xref:../manage_applications/managing_placement_rules[PlacementRule definition YAML structure].
...
To manage your policies, see xref:manage_policy_overview[Manage security policies] for more information.
You can also create custom policy controllers to enforce specific policies.
For more information, see xref:policy_controllers[Policy controllers].

See xref:compliance_intro[Governance and risk] for more information about policies.
