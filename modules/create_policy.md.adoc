...
View more descriptions of the policy YAML files in the link:policy_example.html[Policy example].
...
View the link:../manage_applications/managing_placement_rules.html[PlacementRule definition YAML structure].
...
To manage your policies, see link:manage_policy_overview.html[Manage security policies] for more information.
You can also create custom policy controllers to enforce specific policies.
For more information, see link:policy_controllers.html[Policy controllers].

See link:compliance_intro.html[Governance and risk] for more information about policies.
