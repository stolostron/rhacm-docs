...
View more descriptions of the policy YAML files in the xref:policy_example.adoc[Red Hat Advanced Cluster Management for Kubernetes policy example].
...
To manage your policies, see xref:../governance/manage_grc_policy.adoc[Managing a security policy] for more information.
You can also create custom policy controllers to enforce specific policies.
For more information, see xref:../governance/policy_controllers.adoc[Red Hat Advanced Cluster Management for Kubernetes policy controllers].

See xref:../governance/compliance_intro.adoc[Red Hat Advanced Cluster Management for Kubernetes Governance and risk] for more information about policies.
