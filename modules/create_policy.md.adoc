...
To manage your policies, see xref:../governance/manage_grc_policy[Managing a security policy] for more information.
You can also create custom policy controllers to enforce specific policies.
For more information, see xref:../governance/policy_controllers[Red Hat Advanced Cluster Management for Kubernetes policy controllers].
