...
|**Body**|**body** +
__required__|Parameters describing the deployable to be created.|<<_deployable,Deployable>>
|===
...
__required__|object
|**spec** +
__required__|<<_deployable_spec,spec>>
|===
...
|**dependencies** +
__optional__|< <<_deployable_dependencies,dependencies>> > array
|**overrides** +
__optional__|< <<_deployable_overrides,overrides>> > array
|**placement** +
__optional__|<<_deployable_placement,placement>>
|**template** +
__optional__|object
|===

[[_deployable_dependencies]]
**dependencies**
...
|Name|Schema
|**clusterSelector** +
__optional__|<<_deployable_placement_clusterselector,clusterSelector>>
|**clusters** +
__optional__|< <<_deployable_placement_clusters,clusters>> > array
|**local** +
__optional__|boolean
|**placementRef** +
__optional__|<<_deployable_placement_placementref,placementRef>>
|===

[[_deployable_placement_clusterselector]]
**clusterSelector**
...
|Name|Schema
|**matchExpressions** +
__optional__|< <<_deployable_placement_clusterselector_matchexpressions,matchExpressions>> > array
|**matchLabels** +
__optional__|object
|===

[[_deployable_placement_clusterselector_matchexpressions]]
**matchExpressions**
...
[[_deployable_placement_clusters]]
**clusters**
...
[[_deployable_placement_placementref]]
**placementRef**
