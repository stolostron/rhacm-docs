...
For more information, see xref:managing-your-clusters-with-red-hat-advanced-cluster-management-for-kubernetes[Managing your clusters with Red Hat Advanced Cluster Management for Kubernetes]
