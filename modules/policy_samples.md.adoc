...
For more information, see xref:../governance/policy_example[Red Hat Advanced Cluster Management for Kubernetes policy example].
...
For more information on roles, see xref:../governance/security[Role-based access control (RBAC)].
...
See xref:../governance/compliance_intro[Red Hat Advanced Cluster Management for Kubernetes Governance and risk] for more information about policies.
