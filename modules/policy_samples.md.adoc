...
For more information, see xref:policy_example[Red Hat Advanced Cluster Management for Kubernetes policy example].
...
For more information on roles, see xref:security[Role-based access control (RBAC)].
