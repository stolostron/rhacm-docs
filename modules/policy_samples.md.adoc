...
----
   ...
   metadata:
     ...
     namespace: default
     annotations:
       policy.open-cluster-management./standards: NIST-CSF
       policy.open-cluster-management./categories: DE.CM Security Continuous Monitoring
       policy.open-cluster-management./controls: DE.CM-8 Vulnerability scans
   spec:
     complianceType: musthave
     remediationAction: inform
     disabled: false
