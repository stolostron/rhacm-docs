...
For technical preview, all channels need an individual namespace, except GitHub channels, which can share a namespace with andother GitHub channel.
See the process for link:../manage_applications[Managing channels] for more information.
