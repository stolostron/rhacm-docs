...
For more information see, _500 Internal error during login to the console_ in the link:../release_notes/known_issues.md#security-known-issues[Security known issues].
...
See xref:certificates[Certificates] for more information about certificates that are created and managed by Red Hat Advanced Cluster Management for Kubernates.
Return to the xref:security[Security page] for more information on securing your cluster.
