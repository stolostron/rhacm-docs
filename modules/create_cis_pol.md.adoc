...
View a sample of the CIS policy, see _CIS policy sample_ from xref:cis_pol_ctrl[CIS policy controller].
...
View a sample of a CIS policy, see _CIS policy sample_ from the xref:policy_sample_intro[Configuration policy samples page].
