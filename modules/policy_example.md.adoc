...
For more details about the policy elements, see link:../governance/policy_overview.html[Red Hat Advanced Cluster Management for Kubernetes policy overview].
