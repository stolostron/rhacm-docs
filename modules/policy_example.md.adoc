...
For more details about the policy elements, view the <<policy-parameter-table,Policy YAML table>>.
...
See link:../governance/policy_controllers.html[Red Hat Advanced Cluster Management for Kubernetes policy controllers].
