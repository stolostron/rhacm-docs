...
See xref:creating-a-red-hat-advanced-cluster-management-for-kubernetes-security-policy[Creating a Red Hat Advanced Cluster Management for Kubernetes security policy] to create a policy.
You can also create custom policy controllers to validate the compliance of your policies.
See link:../security[Policy controllers].
