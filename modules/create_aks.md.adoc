...
See xref:cloud_conn_aks.adoc[Setting up a provider connection for Microsoft Azure] for more information.
...
If you do not have one configured, or want to configure a new one, see xref:conn_cloud_aks.adoc[Creating a provider connection on Azure].
