...
* xref:../security/config_policy_ctrl[Configuration policy controller]
* xref:../security/iam_policy_ctrl[IAM policy controller]

See xref:../security/compliance_intro[Governance and risk] to learn more about the dashboard and the policy framework.

As you create policies, use the policy element, `templates` to describe how your resource is defined.
For more information about the policy elements, see xref:../security/policy_overview[Policy overview].
