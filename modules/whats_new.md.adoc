...
See xref:../governance/compliance_intro[Red Hat Advanced Cluster Management for Kubernetes Governance and risk] to learn more about the dashboard and the policy framework.

As you create policies, use the policy element, `templates` to describe how your resource is defined.
For more information about the policy elements, see xref:../governance/policy_overview[Red Hat Advanced Cluster Management for Kubernetes policy overview].
