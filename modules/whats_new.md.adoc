...
Get an overview of Red Hat Advanced Cluster Management for Kubernetes from the link:../about/welcome.html[Product Welcome page].
See the link:../about/architecture.html[architecture page] to learn more about major components of the product.

To learn about the Red Hat Advanced Cluster Management for Kubernetes console capabilities, see link:../console/console_intro.html[Observability in the console].
...
See link:../install/install_connected.html[Installing Red Hat Advanced Cluster Management for Kubernetes when connected] for more information.
...
See link:../manage_cluster/create.html[Creating a cluster with Red Hat Advanced Cluster Management for Kubernetes] for more information.
...
See link:../manage_cluster/import.html[Importing a target managed cluster to the hub cluster] for more information.
...
For more information, see link:../manage_applications/app_management_overview.html[Managing applications].
...
See link:../governance/compliance_intro.html[Red Hat Advanced Cluster Management for Kubernetes Governance and risk] to learn more about the dashboard and the policy framework.

As you create policies, use the policy element, `templates` to describe how your resource is defined.
For more information about the policy elements, see link:../governance/policy_overview.html[Red Hat Advanced Cluster Management for Kubernetes policy overview].
