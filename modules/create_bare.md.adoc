...
see link:cloud_conn_bare.html[Creating a provider connection for a bare metal environment] for more information
...
See link:cloud_providers.html[Supported managed cloud providers] to learn more about other available cloud providers.
. Select your provider connection from the available connections on the list.
If you do not have one configured, or want to configure a new one, see link:cloud_conn_bare.html[Creating a provider connection for a bare metal environment].
