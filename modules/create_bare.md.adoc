...
If you have an existing cluster that you want to import, see xref:importing-a-target-managed-cluster-to-the-hub-cluster-to-the-hub-cluster[Importing a target managed cluster to the hub cluster] for those steps.
