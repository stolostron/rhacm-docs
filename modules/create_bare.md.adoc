...
see xref:creating-a-provider-connection-for-a-bare-metal-environment[Creating a provider connection for a bare metal environment] for more information
...
If you have an existing cluster that you want to import, see xref:importing-a-target-managed-cluster-to-the-hub-cluster-to-the-hub-cluster-to-the-hub-cluster[Importing a target managed cluster to the hub cluster] for those steps.
...
If you do not have one configured, or want to configure a new one, see xref:creating-a-provider-connection-for-a-bare-metal-environment[Creating a provider connection for a bare metal environment].
