...
For more information, see xref:../installer/3.2.2/config_yaml[Customizing the cluster].
...
For more information, see xref:../applications/managing_secrets[Managing Secrets].
