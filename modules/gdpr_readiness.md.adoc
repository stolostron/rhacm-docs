...
For more information, see link:../installer/3.2.2/config_yaml.html[Customizing the cluster].
...
For more information, see link:../applications/managing_secrets.html[Managing Secrets].
