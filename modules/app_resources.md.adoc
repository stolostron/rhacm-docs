...
For more information about creating and managing secrets, see xref:managing-applications[Managing applications].
See xref:application-samples[Application samples] for sample YAML files.
...
For more information about creating and managing channels, see xref:creating-and-managing-channels[Managing channels].
...
For information about creating and managing subscriptions, see xref:creating-and-managing-subscriptions[Managing subscriptions].
...
For more information about creating and managing placement rules, see xref:creating-and-managing-placement-rules[Managing placement rules].
