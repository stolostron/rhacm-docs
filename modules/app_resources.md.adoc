...
For more information about creating and managing applications, see xref:managing_apps.adoc[Creating and managing applications].
...
For more information about creating and managing deployables, see xref:managing_deployables.adoc[Managing deployables].
...
For more information about creating and managing secrets, see xref:managing_secrets.adoc[Managing secrets].
...
For more information about creating and managing channels, see xref:managing_channels.adoc[Managing channels].
...
For more information about creating and managing subscriptions, see xref:managing_subscriptions.adoc[Managing subscriptions].
...
For more information about creating and managing placement rules, see xref:managing_placement_rules.adoc[Managing placement rules].
