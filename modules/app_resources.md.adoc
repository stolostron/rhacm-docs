...
For more information about creating and managing channels, see xref:managing-channels[Managing channels].
...
For more information about creating and managing placement rules, see xref:managing-placement-rules[Managing placement rules].
