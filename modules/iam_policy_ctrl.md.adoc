...
| Required.
Maximum number of IAM rolebinding violations that are valid before a namespace is considered as non-compliant.
|===

Learn how to manage an IAM policy, see xref:managing-iam-policies[Managing IAM policies] for more details.
