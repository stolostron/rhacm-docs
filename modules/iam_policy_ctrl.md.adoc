...
For more information about RBAC in Red Hat Advanced Cluster Management for Kubernetes, see xref:../governance/security[Role-based access control (RBAC)].
...
See xref:../governance/policy_samples[Configuration policy samples] to view policy samples that can be applied to your IAM policies.
