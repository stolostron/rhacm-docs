...
For more information about RBAC in Red Hat Advanced Cluster Management for Kubernetes, see xref:security[Role-based access control (RBAC)].
...
See xref:policy_samples[Configuration policy samples] to view policy samples that can be applied to your IAM policies.
