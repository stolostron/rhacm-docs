...
For more information about RBAC in Red Hat Advanced Cluster Management for Kubernetes, see xref:../governance/security.adoc[Role-based access control (RBAC)].
