...
Samples for all resources are located in the xref:app_resource_samples[Application resource samples] documentation.
 ...
 ** To use REST API, use the link:../apis/mcm/applications[application POST API].
 ...
 ** To use REST API, use the link:../apis/mcm/applications[application PATCH API].
...
----
* To use REST API, use the link:../apis/mcm/applications[application DELETE API].
