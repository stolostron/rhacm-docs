...
View the _IAM policy sample_ on xref:iam_policy_ctrl[IAM policy comtroller page].
See xref:manage_policy_overview[Manage security policies] for more topics.
