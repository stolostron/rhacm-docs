...
. Click *Create policy*.
. Enter or select the apapropriate values for the following fields:
 ** Name
 ** Specifications
 ** Cluster selector
 ** Remediation action
...
Complete the following steps to disbale your IAM policy:
...
View the _IAM policy sample_ on link:iam_policy_ctrl.html[IAM policy comtroller page].
See link:manage_policy_overview.html[Manage security policies] for more topics.
