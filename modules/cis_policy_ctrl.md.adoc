...
For more information see, xref:../governance/cis_policy_rules[CIS rules specifications].
...
See xref:../governance/policy_samples[Configuration policy samples] to view policy samples that can be applied to your CIS policies.
