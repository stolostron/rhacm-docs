...
See, <<creating-a-cis-policy-from-red-hat-advanced-cluster-management-for-kubernetes-console,Creating a CIS policy from Red Hat Advanced Cluster Management for Kubernetes console>>.
