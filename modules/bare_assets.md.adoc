...
You can continue with link:prov_conn_bare.html[Creating a provider connection for bare metal] and then link:create_bare.html[Creating a cluster on bare metal].
