...
See xref:prov_conn_aws[Setting up a provider connection for AWS] for more information.
...
If you do not have one configured, or want to configure a new one, see xref:prov_conn_aws[Creating a provider connection on AWS].
