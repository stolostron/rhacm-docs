...
See xref:creating-a-provider-connection-for-amazon-web-services[Setting up a provider connection for AWS] for more information.
...
If you do not have one configured, or want to configure a new one, see xref:creating-a-provider-connection-for-amazon-web-services[Creating a provider connection on AWS].
