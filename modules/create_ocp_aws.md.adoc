...
See xref:cloud_conn_aws.adoc[Setting up a provider connection for AWS] for more information.
...
If you do not have one configured, or want to configure a new one, see xref:cloud_conn_aws.adoc[Creating a provider connection on AWS].
