...
| Grants administrator privileges for virtual machine migrations across clusters and for deleting a collection of resources. Grants prerequisite permissions to view virtual machines in the multicluster {ocp-virt} console from your hub cluster. 
