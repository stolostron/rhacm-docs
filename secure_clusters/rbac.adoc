...
| `kubevirt.io:edit`
| View and edit {ocp-virt} resources in your cluster.
...
| View, edit, and delete virtual machine related resources on your managed cluster.

| `kubevirt.io-acm-managed:view`
| Only view virtual machine resources on your managed cluster.
