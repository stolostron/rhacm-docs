...
View, edit, and delete resources on your hub cluster. Use the role to perform virtual machine migrations across clusters.

| `kubevirt.io-acm-hub:view`
| Only view virtual machine resources on your hub cluster.
|===
