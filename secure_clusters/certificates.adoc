...
* <<acm-hub-cluster-certs,{acm-short} hub cluster certificates>>
* <<acm-managed-certs,{acm-short} managed certificates>>

*Note:* Users are responsible for certificate rotations and updates.

[#acm-hub-cluster-certs]
...
* Use the certificate policy controller to create and manage certificate policies on managed clusters. See link:../governance/cert_policy_ctrl.adoc#certificate-policy-controller[Certificate policy controller] for more details.
...
* See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.19/html/security_and_compliance/configuring-certificates#add-service-serving[OpenShift Service Serving Certificates] for more details.

* The {ocp-short} default ingress is a hub cluster certificate. See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.19/html/security_and_compliance/configuring-certificates#replacing-default-ingress[Replacing the default ingress certificate] for more details.
