...
* <<cluster-mgmnt-RBAC,Cluster management RBAC>>
...
[source,bash]
----
oc notsure what the rest mght be if there is a command
----
+
...
----
+
This role is a superuser, which has access to all resources and actions. You can create the namespace for the application and all application resources in the namespace with this role.
