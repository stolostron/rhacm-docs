...
//hidden until i split this file|mj| 08/05
//Generate CA certifates by using OpenSSL commands. See, xref:../secure_clusters/cert_byo.adoc#customize-cert[Customizing your CA certificates for observability] to create certificates.  
