...
- For information about updating route certificates to access object stores, see link:../observability/obs_custom_cert.adoc#customizing-route-cert[Customizing route certification].
