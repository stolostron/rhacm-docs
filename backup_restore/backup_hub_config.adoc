...
- See xref:../backup_restore/manage_backup_restore.adoc#using-backup-restore[Scheduling and restoring backups].

- See xref:../backup_restore/manage_backup_restore.adoc#primary-cluster-shut-down[Shutting down the primary cluster].

- See link:../install/adv_config_install.adoc#disable-hub-self-management[disableHubSelfManagement].

- Return to <<dr4hub-config,Hub cluster configuration>>.