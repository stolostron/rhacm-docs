...
* xref:../backup_restore/backup_and_restore_enable.adoc#enable-backup-and-restore[Enabling the backup and restore operator]
* xref:../backup_restore/backup_and_restore_manage.adoc#manage-backup-restore[Managing backup and restore operator]
