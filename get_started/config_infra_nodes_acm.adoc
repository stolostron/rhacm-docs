...
After adding infrastructure nodes to your {ocp-short} cluster, follow the xref:../get_started/install_connected_cli.adoc#install-command-line-acm[Installing from the command-line interface] instructions and add configurations to the {olm} subscription and `MultiClusterHub` custom resource.
