...
IMPORTANT: **This contributing doc is for EXTERNAL USERS. **If you are a Red Hat associate, please use BugZilla or our _internal_ [GitHub process for issues](https://github.com/open-cluster-management/backlog/issues/new/choose).
