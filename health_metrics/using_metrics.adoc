...
If you do not see the metrics in the Grafana dashboard, Grafana Explorer, or in the {ocp-short} console, Prometheus might not have configured to scrape metrics. Continue with _Scrapping with Prometheus_ to expose your metrics.
