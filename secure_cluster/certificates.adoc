...
//the anchors and header titles should be similar.

*Note:* Users are responsible for certificate rotations and updates.

[#acm-certs]
== {acm-short} hub cluster certificates
//same here with anchors
...
=== Managed cluster certificates
//This should not be it's own header, but it is very confusing to me anyway because we now talk about managed cluster certs, but where are these? Are they above? That is titled managed certs. 
...
- See xref:../secure_cluster/cert_intro.adoc#cert-intro[Certificates] for topics.
