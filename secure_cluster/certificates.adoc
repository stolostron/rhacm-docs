...
Use these {acm-short} managed certificates to authenticate managed clusters within your hub cluster. These managed cluster certificates get refreshed automatically.
