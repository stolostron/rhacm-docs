...
* xref:../secure_cluster/fine_grain_rbac_cli.adoc#fine-grain-rbac-cli[Implementing fine-grained role-based access control in the terminal (Technology Preview)]
* xref:../secure_cluster/fine_grain_rbac_ui.adoc#fine-grain-rbac-ui[Implementing fine-grained role-based access control in the console (Technology Preview)]
