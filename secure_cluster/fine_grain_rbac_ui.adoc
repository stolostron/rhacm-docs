...
*Important:* As an administrator, you need to add either `roleBinding` or `ClusterRoleBinding` resources for a valid `ClusterPermission` resource. You can also choose to add both.
