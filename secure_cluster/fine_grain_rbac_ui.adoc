...
Actions are disabled in the console if the user-role access is not permitted. Slide the *YAML* option on to see the data that you enter populate in the YAML editor.
