...
. Create the following YAML file and name the file `<filename>.yml` for later steps in the procedure. You can use a different name. If you choose a different name, you need to use that same name later in the procedure.
