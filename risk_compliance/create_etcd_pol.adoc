...
View a sample of an encryption policy, see _ETCD encryption policy sample_ on the xref:../risk_compliance/etcd_encryption.adoc#etcd-encryption-policy-sample[ETCD encryption policy] page.
