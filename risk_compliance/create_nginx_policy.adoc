...
View a sample of a pod nginx policy, see _Pod nginx policy sample_ from the xref:../risk_compliance/pod_nginx_policy.adoc#pod-nginx-policy-sample[Pod nginx policy] page.
