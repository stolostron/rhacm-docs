...
You can also create and apply the E8 scan policy after you have installed the compliance operator. For more information, see xref:../risk_compliance/e8_scan_policy.adoc#e8-scan-policy[E8 scan policy].

To learn about managing compliance operator policies, see xref:../risk_compliance/create_compliance_operator.adoc#managing-compliance-operator-policies[Managing compliance operator policies] for more details. Refer to xref:../risk_compliance/config_policy_ctrl.adoc#kubernetes-configuration-policy-controller[Kubernetes configuration policy controller] for more topics about configuration policies.
