...
View a sample of a role binding policy, see _Role binding policy sample_ on the xref:../risk_compliance/rolebinding_policy.adoc#role-binding-policy-sample[Role binding policy] page.
