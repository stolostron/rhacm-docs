...
Learn how to manage a certificate policy, see xref:../risk_compliance/create_cert_pol.adoc#managing-certificate-policies[Managing certificate policies] for more details.
