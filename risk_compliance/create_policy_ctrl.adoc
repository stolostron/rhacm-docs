...
Use the policy controller framework that is in the https://github.com/open-cluster-management/governance-policy-framework[`governance-policy-framework`] repository. Complete the following steps to create a policy controller:
