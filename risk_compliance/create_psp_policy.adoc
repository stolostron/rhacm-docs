...
View a sample of a pod security policy, see _Pod security policy sample_ on the xref:../risk_compliance/psp_policy.adoc#pod-security-policy-sample[Pod security policy] page.
