...
<<<<<<< HEAD:risk_compliance/certificates.adoc
See the following topics to replace certificates:

* xref:../risk_compliance/cert_root_ca.adoc#replacing-the-root-ca-certificate[Replacing the root CA certificate]
...
=======
See the following topics to learn more about certificate management:
>>>>>>> 2.3_stage:security/certificates.adoc

* <<list-managed-certificates,List managed certificates>>
* <<refresh-a-managed-certificate,Refresh a managed certificate>>
* <<refresh-managed-certificates-ca,Refresh managed certificates for {product-title}>>
