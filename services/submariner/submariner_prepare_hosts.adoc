...
. Import your cluster to {product-title-short}, and follow the instructions in xref:../services/submariner/deploy_submariner#deploying-submariner-console[Deploying Submariner with the console].
...
. Import your cluster to {product-title-short}, and follow the instructions in xref:../services/submariner/deploy_submariner.adoc#deploying-submariner-console[Deploying Submariner with the console].