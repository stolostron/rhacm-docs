...
[#preparing-openstack]
== Preparing to deploy Submariner on Red Hat OpenStack Platform

To prepare Red Hat OpenStack Platform clusters for deploying Submariner, complete the following steps:
