...
** xref:../submariner/submariner_prepare_hosts.adoc#preparing-vm[Preparing to deploy Submariner on VMware vSphere]
** xref:../submariner/submariner_prepare_hosts.adoc#preparing-bare[Preparing to deploy Submariner on bare metal]
** xref:../submariner/submariner_prepare_hosts.adoc#preparing-openstack[Preparing to deploy Submariner on Red Hat OpenStack Platform]
