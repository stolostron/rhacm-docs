...
When uninstalling versions of Submariner that are earlier than version 0.12, you must complete the additional steps that are provided in the  https://submariner.io/operations/cleanup/[Uninstalling Submariner] topic in the Submariner documentation.  
