...
. Import your cluster to {product-title-short}, and follow the instructions in xref:../services/deploy_submariner.adoc#deploying-submariner[Deploying Submariner].
