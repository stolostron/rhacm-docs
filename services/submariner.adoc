...
* Non-overlaping Pod and Service Classless Inter-Domain Routing (CIDR) ranges for clusters. The upstream Globalent feature, which allows overlaping CIDRs, will be supported in future releases.
