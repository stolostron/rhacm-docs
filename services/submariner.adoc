...
* Firewall configuration open for 4500/UDP, 500/UDP, and any other ports that are used for IPSec traffic on the gateway nodes (configured automatically for AWS, Google Cloud Platform, VMware vSphere, and bare metal).
