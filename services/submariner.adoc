...
* Non-overlaping Pod and Service Classless Inter-Domain Routing (CIDR) ranges for clusters. The upstream https://submariner.io/getting-started/architecture/globalnet/[Globalent] feature, which allows overlaping CIDRs, is not currently supported.
